...
(()=>{var Yt="1.0.0",ai="Universal Card",ni="\u041F\u0440\u043E\u0434\u0432\u0438\u043D\u0443\u0442\u0430\u044F \u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0430 \u0441 7 \u0440\u0435\u0436\u0438\u043C\u0430\u043C\u0438 body, grid layout, lazy loading \u0438 \u0440\u0430\u0441\u0448\u0438\u0440\u0435\u043D\u043D\u043E\u0439 \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u043E\u0439",w=Object.freeze({EXPAND:"expand",MODAL:"modal",FULLSCREEN:"fullscreen",TABS:"tabs",CAROUSEL:"carousel",SUBVIEW:"subview",NONE:"none"}),Te=Object.values(w),T=Object.freeze({SOLID:"solid",GLASS:"glass",GLASSMORPHISM:"glassmorphism",NEUMORPHISM:"neumorphism",MINIMAL:"minimal",GRADIENT:"gradient",DARK:"dark",NEON:"neon",AURORA:"aurora"}),Pi=Object.freeze({NONE:"none",FADE:"fade",SLIDE:"slide",BOUNCE:"bounce",ELASTIC:"elastic",SMOOTH:"smooth",SHARP:"sharp",ZOOM:"zoom"}),Ui=Object.freeze({SKELETON:"skeleton",SPINNER:"spinner",DOTS:"dots",PROGRESS:"progress",SHIMMER:"shimmer",PULSE:"pulse"}),$=Object.freeze({STATE:"state",NUMERIC_STATE:"numeric_state",USER:"user",TIME:"time",SCREEN:"screen",AND:"and",OR:"or",NOT:"not"}),H=Object.freeze({NONE:"none",TOGGLE:"toggle",CALL_SERVICE:"call-service",NAVIGATE:"navigate",URL:"url",MORE_INFO:"more-info",FIRE_EVENT:"fire-dom-event",EXPAND:"expand",COLLAPSE:"collapse"}),be=Object.freeze({CARD_EXPANDED:"universal-card-expanded",CARD_COLLAPSED:"universal-card-collapsed",CARD_CONTROL:"universal-card-control",CONFIG_CHANGED:"config-changed",HASS_UPDATED:"hass-updated"}),ci=Object.freeze({PRIMARY:"--uc-primary-color",SECONDARY:"--uc-secondary-color",ACCENT:"--uc-accent-color",BACKGROUND:"--uc-background-color",SURFACE:"--uc-surface-color",TEXT:"--uc-text-color",TEXT_SECONDARY:"--uc-text-secondary-color",BORDER:"--uc-border-color",BORDER_RADIUS:"--uc-border-radius",PADDING:"--uc-padding",GAP:"--uc-gap",SHADOW:"--uc-shadow",SHADOW_HOVER:"--uc-shadow-hover",TRANSITION_DURATION:"--uc-transition-duration",TRANSITION_TIMING:"--uc-transition-timing"}),k=Object.freeze({body_mode:w.EXPAND,expanded:!1,animation:!0,theme:T.SOLID,border_radius:"var(--ha-card-border-radius, 12px)",padding:"16px",grid_columns:1,grid_gap:"16px",modal_width:"90%",modal_max_width:"600px",backdrop_color:"rgba(0, 0, 0, 0.6)",lazy_load:!0,remember_state:!1,show_expand_icon:!0,expand_icon:"mdi:chevron-down",haptic:!1,loading_type:Ui.SKELETON,skeleton_count:3,carousel_autoplay:!1,carousel_interval:5e3,animation_preset:Pi.SMOOTH,animation_duration:300}),N=Object.freeze({MAX_GRID_COLUMNS:12,MIN_GRID_COLUMNS:1,MAX_CARDS_PER_BODY:100,MAX_TABS:20,UPDATE_THROTTLE_MS:100,RESIZE_DEBOUNCE_MS:200,INTERSECTION_MARGIN:"100px",MAX_UNDO_HISTORY:50,MAX_LOG_ENTRIES:1e3});function Be(n="uc"){let e=Math.random().toString(36).substring(2,10);return`${n}-${e}`}function Y(n){return n!==null&&typeof n=="object"&&!Array.isArray(n)}function qt(n){return typeof n=="string"&&n.trim().length>0}function Wt(n){return typeof n=="number"&&!Number.isNaN(n)}function Xt(n,e){let t={...n};return Y(n)&&Y(e)&&Object.keys(e).forEach(i=>{Y(e[i])&&i in n?t[i]=Xt(n[i],e[i]):t[i]=e[i]}),t}function q(n){if(n===null||typeof n!="object")return n;if(Array.isArray(n))return n.map(t=>q(t));let e={};return Object.keys(n).forEach(t=>{e[t]=q(n[t])}),e}function li(n,e,t=void 0){if(!n||!e)return t;let i=e.split("."),r=n;for(let s of i){if(r==null)return t;r=r[s]}return r!==void 0?r:t}function di(n){return n==null?[]:Array.isArray(n)?n:[n]}function p(n,e,t={},i={}){let r=new CustomEvent(e,{bubbles:i.bubbles!==!1,cancelable:i.cancelable!==!1,composed:i.composed!==!1,detail:t});return n.dispatchEvent(r),r}function ui(){return new Promise(n=>{requestAnimationFrame(()=>{requestAnimationFrame(n)})})}function hi(n,e=2){return Wt(n)?n.toFixed(e):""}function pi(n,e={},t="ru-RU"){let i=n instanceof Date?n:new Date(n),r={year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"};return new Intl.DateTimeFormat(t,{...r,...e}).format(i)}function je(n){return qt(n)?/^[a-z_]+\.[a-z0-9_]+$/.test(n):!1}var v=class extends Error{constructor(e,t){super(t?`${t}: ${e}`:e),this.name="ConfigValidationError",this.path=t}},ye=class{static validate(e){var i,r,s;if(!Y(e))throw new v("Configuration must be an object");if(e.body_mode&&!Te.includes(e.body_mode))throw new v(`Invalid body_mode: "${e.body_mode}". Valid modes: ${Te.join(", ")}`,"body_mode");let t=Object.values(T);if(e.theme&&!t.includes(e.theme))throw new v(`Invalid theme: "${e.theme}". Valid themes: ${t.join(", ")}`,"theme");if(e.entity&&!je(e.entity))throw new v(`Invalid entity format: "${e.entity}"`,"entity");if((i=e.grid)!=null&&i.columns){let o=e.grid.columns;if(!Wt(o)||o<N.MIN_GRID_COLUMNS||o>N.MAX_GRID_COLUMNS)throw new v(`Grid columns must be between ${N.MIN_GRID_COLUMNS} and ${N.MAX_GRID_COLUMNS}`,"grid.columns")}if((r=e.body)!=null&&r.cards){if(!Array.isArray(e.body.cards))throw new v("body.cards must be an array","body.cards");if(e.body.cards.length>N.MAX_CARDS_PER_BODY)throw new v(`Maximum ${N.MAX_CARDS_PER_BODY} cards allowed in body`,"body.cards");e.body.cards.forEach((o,a)=>{this._validateCardConfig(o,`body.cards[${a}]`)})}if((s=e.header)!=null&&s.cards){if(!Array.isArray(e.header.cards))throw new v("header.cards must be an array","header.cards");e.header.cards.forEach((o,a)=>{this._validateCardConfig(o,`header.cards[${a}]`)})}return e.tabs&&this._validateTabs(e.tabs),e.visibility&&this._validateConditions(e.visibility,"visibility"),["tap_action","hold_action","double_tap_action"].forEach(o=>{e[o]&&this._validateAction(e[o],o)}),!0}static _validateCardConfig(e,t){if(!Y(e))throw new v("Card config must be an object",t);if(!e.type)throw new v("Card must have a type",t)}static _validateTabs(e){if(!Array.isArray(e))throw new v("tabs must be an array","tabs");if(e.length>N.MAX_TABS)throw new v(`Maximum ${N.MAX_TABS} tabs allowed`,"tabs");e.forEach((t,i)=>{if(!Y(t))throw new v("Tab config must be an object",`tabs[${i}]`);if(t.cards&&!Array.isArray(t.cards))throw new v("Tab cards must be an array",`tabs[${i}].cards`)})}static _validateConditions(e,t){if(!Array.isArray(e))throw new v("Visibility must be an array",t);let i=Object.values($);e.forEach((r,s)=>{let o=`${t}[${s}]`;if(!Y(r))throw new v("Condition must be an object",o);if(!r.condition)throw new v('Condition must have a "condition" type',o);if(!i.includes(r.condition))throw new v(`Invalid condition type: "${r.condition}"`,o)})}static _validateAction(e,t){if(!Y(e))throw new v("Action must be an object",t);let i=Object.values(H);if(e.action&&!i.includes(e.action))throw new v(`Invalid action: "${e.action}"`,t);if(e.action===H.CALL_SERVICE&&!e.service)throw new v('call-service action requires a "service" property',t);if(e.action===H.NAVIGATE&&!e.navigation_path)throw new v('navigate action requires a "navigation_path" property',t);if(e.action===H.URL&&!e.url_path)throw new v('url action requires a "url_path" property',t)}static normalize(e){this.validate(e);let t={...k,...e};return t.card_id||(t.card_id=Be("uc")),t.header=this._normalizeSection(e.header,"header"),t.body=this._normalizeSection(e.body,"body"),e.footer&&(t.footer=this._normalizeSection(e.footer,"footer")),e.tabs&&(t.tabs=e.tabs.map((i,r)=>({label:i.label||`Tab ${r+1}`,icon:i.icon||null,cards:i.cards||[],...i}))),t.grid=this._normalizeGrid(e.grid),t.tap_action=this._normalizeAction(e.tap_action,"toggle"),t.hold_action=this._normalizeAction(e.hold_action,"none"),t.double_tap_action=this._normalizeAction(e.double_tap_action,"none"),e.visibility&&(t.visibility=e.visibility.map(i=>this._normalizeCondition(i))),t}static _normalizeSection(e,t){return e?{cards:e.cards||[],...e}:{cards:[]}}static _normalizeGrid(e){return e?{columns:e.columns||k.grid_columns,gap:e.gap||k.grid_gap,responsive:e.responsive||null}:{columns:k.grid_columns,gap:k.grid_gap}}static _normalizeAction(e,t="none"){return e?{action:e.action||t,...e}:{action:t}}static _normalizeCondition(e){let t={condition:e.condition,...e};return e.condition===$.STATE&&e.state&&(t.state=Array.isArray(e.state)?e.state:[e.state]),t}static getTitle(e,t){var i;return e.title?e.title:e.entity&&((i=t==null?void 0:t.states)!=null&&i[e.entity])?t.states[e.entity].attributes.friendly_name||e.entity:""}static getSubtitle(e,t){var i;return e.subtitle?e.subtitle:e.entity&&((i=t==null?void 0:t.states)!=null&&i[e.entity])?t.states[e.entity].state:""}static hasChanged(e,t){return JSON.stringify(e)!==JSON.stringify(t)}static getSchema(){return{type:"object",properties:{title:{type:"string"},subtitle:{type:"string"},icon:{type:"string"},entity:{type:"string"},body_mode:{type:"string",enum:Te,default:w.EXPAND},theme:{type:"string",enum:Object.values(T),default:T.SOLID},expanded:{type:"boolean",default:!1},animation:{type:"boolean",default:!0},lazy_load:{type:"boolean",default:!0},show_expand_icon:{type:"boolean",default:!0},grid:{type:"object",properties:{columns:{type:"number",minimum:1,maximum:12},gap:{type:"string"}}}}}}};function J(n,e=100,t={}){let{leading:i=!1,trailing:r=!0}=t,s=null,o=null,a=null,c=null,l=null;function d(y){let V=o,ge=a;return o=null,a=null,l=y,c=n.apply(ge,V),c}function u(y){let V=l===null?e:y-l;return l===null||V>=e}function m(){let y=Date.now();if(u(y))return h(y);s=setTimeout(m,e-(y-l))}function h(y){return s=null,r&&o?d(y):(o=null,a=null,c)}function f(y){return l=y,s=setTimeout(m,e),i?d(y):c}function b(...y){let V=Date.now(),ge=u(V);return o=y,a=this,ge&&s===null?f(V):(s===null&&(s=setTimeout(m,e)),c)}return b.cancel=function(){s!==null&&clearTimeout(s),o=null,a=null,l=null,s=null},b.flush=function(){return s!==null?h(Date.now()):c},b.pending=function(){return s!==null},b}function $e(n,e=16,t={}){let{leading:i=!0,trailing:r=!0}=t,s=0,o=null,a=null,c=null;function l(){let u=a,m=c;return a=null,c=null,s=Date.now(),n.apply(m,u)}function d(...u){let h=Date.now()-s;if(a=u,c=this,h>=e&&(o!==null&&(clearTimeout(o),o=null),i))return l();if(o===null&&r){let f=e-h;o=setTimeout(()=>{o=null,l()},f>0?f:0)}}return d.cancel=function(){o!==null&&(clearTimeout(o),o=null),s=0,a=null,c=null},d}function mi(n){return requestAnimationFrame(n)}function fi(n){return new Promise(e=>{requestAnimationFrame(()=>{requestAnimationFrame(()=>{n(),e()})})})}function Kt(n){return new Promise(e=>{requestAnimationFrame(()=>{n.forEach(t=>{try{t()}catch(i){console.error("[UniversalCard] Batch update error:",i)}}),e()})})}function _i(){let n=[],e=!1;function t(){if(n.length===0)return;let r=[...n];n.length=0,e=!1,Kt(r)}function i(r){n.push(r),e||(e=!0,requestAnimationFrame(t))}return{add:i,flush:t}}function gi(n,e={}){let{timeout:t=1e3}=e;return"requestIdleCallback"in window?window.requestIdleCallback(n,{timeout:t}):setTimeout(n,1)}function bi(n,e){let t=performance.now(),i=e(),r=performance.now();return console.debug(`[UniversalCard] ${n}: ${(r-t).toFixed(2)}ms`),i}var Ge=null;async function Me(){return Ge||(Ge=new Promise(async n=>{if(window.loadCardHelpers){n(await window.loadCardHelpers());return}let e=setInterval(async()=>{window.loadCardHelpers&&(clearInterval(e),n(await window.loadCardHelpers()))},100);setTimeout(()=>{clearInterval(e),console.warn("[UniversalCard] Card helpers not available"),n(null)},1e4)}),Ge)}async function Jt(n){if(!n||!n.type)throw new Error("Card config must have a type");let e=await Me();if(e)try{return await e.createCardElement(n)}catch(t){throw new Error(`Failed to create card: ${t.message}`)}return Hi(n)}function Hi(n){let e=n.type,t=e;e.startsWith("custom:")?t=e.slice(7):t=`hui-${e}-card`;let i=document.createElement(t);return i.setConfig&&i.setConfig(n),i}async function se(n){return Array.isArray(n)?(await Promise.allSettled(n.map(t=>Jt(t)))).map((t,i)=>t.status==="fulfilled"?t.value:(console.error("[UniversalCard] Card creation failed:",t.reason),Zt(t.reason,n[i]))):[]}function Zt(n,e){let t=document.createElement("ha-card");return t.className="uc-error-card",t.innerHTML=`
  ...
  `,t._errorData={error:n,config:e,stack:n.stack},t}function Ve(n,e){return!(n!=null&&n.states)||!e?null:n.states[e]||null}function I(n,e,t="unavailable"){var r;let i=Ve(n,e);return(r=i==null?void 0:i.state)!=null?r:t}function Q(n,e,t,i){var s,o;let r=Ve(n,e);return(o=(s=r==null?void 0:r.attributes)==null?void 0:s[t])!=null?o:i}function yi(n,e,t){let i=I(n,e);return(Array.isArray(t)?t:[t]).includes(i)}async function W(n,e,t,i={}){if(!t||t.action==="none")return;let{action:r}=t;switch(r){case"toggle":await Fi(n,t);break;case"call-service":await Bi(n,t);break;case"navigate":ji(t);break;case"url":Gi(t);break;case"more-info":Vi(e,t);break;case"fire-dom-event":Yi(e,t);break;default:console.warn(`[UniversalCard] Unknown action: ${r}`)}}async function Fi(n,e){let t=e.entity;if(!t)return;let i=t.split(".")[0];await n.callService(i,"toggle",{entity_id:t})}async function Bi(n,e){let{service:t,service_data:i,target:r}=e;if(!t)return;let[s,o]=t.split(".");await n.callService(s,o,i||{},r)}function ji(n){let e=n.navigation_path;e&&(history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")))}function Gi(n){let e=n.url_path;if(!e)return;let t=n.url_target||"_blank";window.open(e,t)}function Vi(n,e){let t=e.entity;if(!t)return;let i=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}});n.dispatchEvent(i)}function Yi(n,e){let t=new CustomEvent("ll-custom",{bubbles:!0,composed:!0,detail:e});n.dispatchEvent(t)}function vi(n="light"){let e=new CustomEvent("haptic",{bubbles:!0,composed:!0,detail:n});window.dispatchEvent(e)}function xi(n){let e=getComputedStyle(n);return{primaryColor:e.getPropertyValue("--primary-color").trim(),accentColor:e.getPropertyValue("--accent-color").trim(),textColor:e.getPropertyValue("--primary-text-color").trim(),secondaryTextColor:e.getPropertyValue("--secondary-text-color").trim(),backgroundColor:e.getPropertyValue("--primary-background-color").trim(),cardBackgroundColor:e.getPropertyValue("--ha-card-background").trim()||e.getPropertyValue("--card-background-color").trim(),dividerColor:e.getPropertyValue("--divider-color").trim(),borderRadius:e.getPropertyValue("--ha-card-border-radius").trim()||"12px"}}function Ye(n){return(n==null?void 0:n.user)||null}function wi(n){var e;return((e=n==null?void 0:n.user)==null?void 0:e.is_admin)===!0}var Ae=class{constructor(e,t={}){this._config=e,this._options=t,this._element=null,this._leftCards=[],this._rightCards=[],this._contentCards=[],this._hass=null,this._expanded=!1,this._holdTimer=null,this._isHolding=!1,this._holdDuration=500,this._lastTapTime=0,this._doubleTapThreshold=300}set hass(e){this._hass=e,this._updateCards(e),this._updateDynamicContent()}set expanded(e){this._expanded=e,this._updateExpandedState()}render(){let e=this._config;return this._element=document.createElement("div"),this._element.className=this._getHeaderClasses(),this._element.setAttribute("role","button"),this._element.setAttribute("tabindex","0"),this._element.setAttribute("aria-expanded",String(this._expanded)),this._element.innerHTML=`
    ...
    `).join("")}_getFooterClasses(){let e=["footer"];return this._config.sticky&&e.push("sticky"),this._config.border_top!==!1&&e.push("with-border"),e.join(" ")}async loadCards(){let{footer_left:e,footer_right:t,cards:i}=this._config,r=[];e!=null&&e.cards&&r.push(this._loadSlotCards(e.cards,".footer-left-slot","_leftCards")),t!=null&&t.cards&&r.push(this._loadSlotCards(t.cards,".footer-right-slot","_rightCards")),i&&r.push(this._loadSlotCards(i,".footer-cards-slot","_contentCards")),await Promise.all(r)}async _loadSlotCards(e,t,i){var s;if(!Array.isArray(e)||e.length===0)return;let r=(s=this._element)==null?void 0:s.querySelector(t);if(r)try{let o=await se(e);this[i]=o;let a=document.createDocumentFragment();o.forEach(c=>{this._hass&&(c.hass=this._hass),a.appendChild(c)}),r.appendChild(a)}catch(o){console.error("[UniversalCard] Failed to load footer cards:",o)}}_updateCards(e){[...this._leftCards,...this._rightCards,...this._contentCards].forEach(i=>{if(i&&"hass"in i)try{i.hass=e}catch{}})}_bindEvents(){this._element&&(this._element.querySelectorAll(".footer-action-btn").forEach(e=>{e.addEventListener("click",t=>this._handleActionClick(t))}),(this._config.tap_action||this._config.hold_action)&&(this._element.addEventListener("click",e=>this._handleClick(e)),this._element.addEventListener("mousedown",e=>this._handleMouseDown(e)),this._element.addEventListener("mouseup",()=>this._handleMouseUp()),this._element.addEventListener("mouseleave",()=>this._cancelHold())))}_handleActionClick(e){var s;let t=e.currentTarget,i=parseInt(t.dataset.actionIndex,10),r=(s=this._config.actions)==null?void 0:s[i];r&&W(this._hass,this._element,r)}_handleClick(e){if(!this._isInteractiveElement(e.target)){if(this._isHolding){this._isHolding=!1;return}this._executeAction("tap_action")}}_handleMouseDown(e){e.button===0&&(this._isInteractiveElement(e.target)||(this._holdTimer=setTimeout(()=>{this._isHolding=!0,this._executeAction("hold_action")},500)))}_handleMouseUp(){this._holdTimer&&(clearTimeout(this._holdTimer),this._holdTimer=null)}_cancelHold(){this._handleMouseUp(),this._isHolding=!1}_isInteractiveElement(e){return e.closest("button, a, input, .footer-action-btn")!==null}_executeAction(e){let t=this._config[e];!t||t.action===H.NONE||W(this._hass,this._element,t)}destroy(){this._cancelHold(),this._leftCards=[],this._rightCards=[],this._contentCards=[],this._element=null}};var qe=class{constructor(e=[]){this._configs=e,this._element=null,this._hass=null}set hass(e){this._hass=e,this._update()}set configs(e){this._configs=e,this._render()}render(){return this._element=document.createElement("div"),this._element.className="badges-container",this._renderBadges(),this._element}_renderBadges(){this._element&&(this._element.innerHTML=this._configs.map((e,t)=>this._renderBadge(e,t)).join(""))}_renderBadge(e,t){let{type:i="state",entity:r,attribute:s,icon:o,color:a,value:c,label:l,unit:d,min:u,max:m,show_name:h=!1,tap_action:f}=e,b=this._getValue(e),y=a||this._getAutoColor(e);b!=null&&(b=this._formatValue(b,e));let V=o?`<ha-icon class="badge-icon" icon="${o}"></ha-icon>`:"",ge=l?`<span class="badge-label">${l}</span>`:"",K=d?`<span class="badge-unit">${d}</span>`:"",Re=b!=null?`<span class="badge-value">${b}</span>${K}`:"",Vt=this._renderProgress(e,b);return`
...
`)}var We=class{constructor(e=[]){this._conditions=e,this._hass=null,this._cachedResult=!0,this._cacheKey=null}set hass(e){this._hass=e,this._cacheKey=null}set conditions(e){this._conditions=e,this._cacheKey=null}evaluate(){if(!this._conditions||this._conditions.length===0)return!0;let e=this._generateCacheKey();if(e===this._cacheKey)return this._cachedResult;let t=this._conditions.every(i=>this._evaluateCondition(i));return this._cacheKey=e,this._cachedResult=t,t}_evaluateCondition(e){let t=e.condition;switch(t){case $.STATE:return this._evaluateStateCondition(e);case $.NUMERIC_STATE:return this._evaluateNumericStateCondition(e);case $.USER:return this._evaluateUserCondition(e);case $.TIME:return this._evaluateTimeCondition(e);case $.SCREEN:return this._evaluateScreenCondition(e);case $.AND:return this._evaluateAndCondition(e);case $.OR:return this._evaluateOrCondition(e);case $.NOT:return this._evaluateNotCondition(e);default:return console.warn(`[UniversalCard] Unknown condition type: ${t}`),!0}}_evaluateStateCondition(e){let{entity:t,state:i,state_not:r,attribute:s}=e;if(!t||!this._hass)return!0;let o;return s?o=Q(this._hass,t,s):o=I(this._hass,t),r!==void 0?!(Array.isArray(r)?r:[r]).includes(o):i!==void 0?(Array.isArray(i)?i:[i]).includes(o):!0}_evaluateNumericStateCondition(e){let{entity:t,attribute:i,above:r,below:s}=e;if(!t||!this._hass)return!0;let o;i?o=Q(this._hass,t,i):o=I(this._hass,t);let a=parseFloat(o);return!(isNaN(a)||r!==void 0&&a<=r||s!==void 0&&a>=s)}_evaluateUserCondition(e){let{users:t,is_admin:i,is_owner:r}=e;if(!this._hass)return!0;let s=Ye(this._hass);return s?!(t&&Array.isArray(t)&&!t.includes(s.name)&&!t.includes(s.id)||i!==void 0&&s.is_admin!==i||r!==void 0&&s.is_owner!==r):!0}_evaluateTimeCondition(e){let{after:t,before:i,weekday:r}=e,s=new Date,o=s.getHours()*60+s.getMinutes();if(t){let[a,c]=t.split(":").map(Number),l=a*60+c;if(o<l)return!1}if(i){let[a,c]=i.split(":").map(Number),l=a*60+c;if(o>=l)return!1}if(r&&Array.isArray(r)){let c=["sun","mon","tue","wed","thu","fri","sat"][s.getDay()];if(!r.includes(c))return!1}return!0}_evaluateScreenCondition(e){let{media_query:t,min_width:i,max_width:r}=e;if(t)return window.matchMedia(t).matches;let s=window.innerWidth;return!(i!==void 0&&s<i||r!==void 0&&s>r)}_evaluateAndCondition(e){let{conditions:t}=e;return!t||!Array.isArray(t)?!0:t.every(i=>this._evaluateCondition(i))}_evaluateOrCondition(e){let{conditions:t}=e;return!t||!Array.isArray(t)?!0:t.some(i=>this._evaluateCondition(i))}_evaluateNotCondition(e){let{conditions:t}=e;return!t||!Array.isArray(t)?!0:!t.every(i=>this._evaluateCondition(i))}_generateCacheKey(){if(!this._hass)return"no-hass";let t=this._getRelevantEntities().map(s=>{let o=this._hass.states[s];return o?`${s}:${o.state}`:`${s}:null`});if(this._conditions.some(s=>s.condition===$.SCREEN)&&t.push(`screen:${window.innerWidth}`),this._conditions.some(s=>s.condition===$.TIME)){let s=new Date;t.push(`time:${s.getHours()}:${s.getMinutes()}`)}return t.join("|")}_getRelevantEntities(){let e=new Set,t=i=>{i.forEach(r=>{r.entity&&e.add(r.entity),r.conditions&&Array.isArray(r.conditions)&&t(r.conditions)})};return t(this._conditions),Array.from(e)}hasEntityDependencies(){return this._getRelevantEntities().length>0}hasScreenDependencies(){return this._conditions.some(e=>e.condition===$.SCREEN)}hasTimeDependencies(){return this._conditions.some(e=>e.condition===$.TIME)}};var Xe=class{constructor(e={}){this._config=e,this._hass=null,this._element=null,this._appliedStyles={}}set hass(e){this._hass=e,this._update()}set element(e){this._element=e,this._update()}set config(e){this._config=e,this._update()}_update(){if(!this._element||!this._hass||!this._config)return;let{entity:e,state_styles:t,attribute:i}=this._config;if(!e||!t)return;let r;i?r=Q(this._hass,e,i):r=I(this._hass,e);let s=this._findMatchingStyle(r,t);this._applyStyles(s)}_findMatchingStyle(e,t){if(t[e])return t[e];let i=parseFloat(e);if(!isNaN(i)){for(let[r,s]of Object.entries(t))if(this._matchesNumericCondition(i,r))return s}return t["*"]||t.default?t["*"]||t.default:null}_matchesNumericCondition(e,t){if(t.includes("-")&&!t.startsWith("-")){let[i,r]=t.split("-").map(Number);return e>=i&&e<=r}return t.startsWith(">=")?e>=parseFloat(t.slice(2)):t.startsWith("<=")?e<=parseFloat(t.slice(2)):t.startsWith(">")?e>parseFloat(t.slice(1)):t.startsWith("<")?e<parseFloat(t.slice(1)):!1}_applyStyles(e){if(!this._element||(this._removeAppliedStyles(),!e))return;let t=this._normalizeStyles(e);if(Object.entries(t).forEach(([i,r])=>{i.startsWith("--")?this._element.style.setProperty(i,r):this._element.style[i]=r,this._appliedStyles[i]=r}),e.class){let i=Array.isArray(e.class)?e.class:[e.class];i.forEach(r=>this._element.classList.add(r)),this._appliedStyles._classes=i}}_removeAppliedStyles(){this._element&&(Object.keys(this._appliedStyles).forEach(e=>{e==="_classes"?this._appliedStyles._classes.forEach(t=>{this._element.classList.remove(t)}):e.startsWith("--")?this._element.style.removeProperty(e):this._element.style[e]=""}),this._appliedStyles={})}_normalizeStyles(e){let t={},i={background:"background",bg:"background",color:"color",text_color:"color",border:"border",border_color:"borderColor",border_width:"borderWidth",border_radius:"borderRadius",shadow:"boxShadow",box_shadow:"boxShadow",opacity:"opacity",transform:"transform",filter:"filter"};return Object.entries(e).forEach(([r,s])=>{if(r==="class")return;let a=(i[r]||r).replace(/_([a-z])/g,(c,l)=>l.toUpperCase());t[a]=s}),t}static getStateColor(e){return{on:"var(--state-active-color, #fdd835)",off:"var(--state-inactive-color, #969696)",home:"var(--state-home-color, #4caf50)",not_home:"var(--state-not-home-color, #f44336)",armed_home:"var(--warning-color, #ff9800)",armed_away:"var(--error-color, #f44336)",armed_night:"var(--warning-color, #ff9800)",disarmed:"var(--success-color, #4caf50)",triggered:"var(--error-color, #f44336)",pending:"var(--warning-color, #ff9800)",locked:"var(--success-color, #4caf50)",unlocked:"var(--warning-color, #ff9800)",open:"var(--state-active-color, #fdd835)",closed:"var(--state-inactive-color, #969696)",opening:"var(--warning-color, #ff9800)",closing:"var(--warning-color, #ff9800)",heating:"var(--error-color, #f44336)",cooling:"var(--info-color, #03a9f4)",idle:"var(--state-inactive-color, #969696)",unavailable:"var(--disabled-text-color, #bdbdbd)",unknown:"var(--disabled-text-color, #bdbdbd)"}[e]||null}static getIconColorStyles(){return`
    ...
    `}};var g={ENTRANCE:"entrance",EXIT:"exit",ATTENTION:"attention",STATE:"state",LOADING:"loading",CONTINUOUS:"continuous"},ue={fadeIn:{category:g.ENTRANCE,keyframes:`
      @keyframes uc-fadeIn {
        from { opacity: 0; }
        to { opacity: 1; }
      }
    `,animation:"uc-fadeIn 0.3s ease-out forwards",description:"\u041F\u043B\u0430\u0432\u043D\u043E\u0435 \u043F\u043E\u044F\u0432\u043B\u0435\u043D\u0438\u0435"},fadeInUp:{category:g.ENTRANCE,keyframes:`
    ...
    `,animation:"uc-fadeInUp 0.4s ease-out forwards",description:"\u041F\u043E\u044F\u0432\u043B\u0435\u043D\u0438\u0435 \u0441\u043D\u0438\u0437\u0443"},fadeInDown:{category:g.ENTRANCE,keyframes:`
    ...
    `,animation:"uc-fadeInDown 0.4s ease-out forwards",description:"\u041F\u043E\u044F\u0432\u043B\u0435\u043D\u0438\u0435 \u0441\u0432\u0435\u0440\u0445\u0443"},fadeInLeft:{category:g.ENTRANCE,keyframes:`
    ...
    `,animation:"uc-fadeInLeft 0.4s ease-out forwards",description:"\u041F\u043E\u044F\u0432\u043B\u0435\u043D\u0438\u0435 \u0441\u043B\u0435\u0432\u0430"},fadeInRight:{category:g.ENTRANCE,keyframes:`
    ...
    `,animation:"uc-fadeInRight 0.4s ease-out forwards",description:"\u041F\u043E\u044F\u0432\u043B\u0435\u043D\u0438\u0435 \u0441\u043F\u0440\u0430\u0432\u0430"},scaleIn:{category:g.ENTRANCE,keyframes:`
    ...
    `,animation:"uc-scaleIn 0.3s ease-out forwards",description:"\u041C\u0430\u0441\u0448\u0442\u0430\u0431\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u0435 \u043F\u0440\u0438 \u043F\u043E\u044F\u0432\u043B\u0435\u043D\u0438\u0438"},slideInUp:{category:g.ENTRANCE,keyframes:`
    ...
    `,animation:"uc-slideInUp 0.4s cubic-bezier(0.16, 1, 0.3, 1) forwards",description:"\u0412\u044B\u0435\u0437\u0434 \u0441\u043D\u0438\u0437\u0443"},bounceIn:{category:g.ENTRANCE,keyframes:`
    ...
    `,animation:"uc-bounceIn 0.6s ease-out forwards",description:"\u041F\u0440\u0443\u0436\u0438\u043D\u044F\u0449\u0435\u0435 \u043F\u043E\u044F\u0432\u043B\u0435\u043D\u0438\u0435"},flipInX:{category:g.ENTRANCE,keyframes:`
    ...
    `,animation:"uc-flipInX 0.5s ease-out forwards",description:"3D \u043F\u0435\u0440\u0435\u0432\u043E\u0440\u043E\u0442 \u043F\u043E X"},fadeOut:{category:g.EXIT,keyframes:`
      @keyframes uc-fadeOut {
        from { opacity: 1; }
        to { opacity: 0; }
      }
    `,animation:"uc-fadeOut 0.3s ease-out forwards",description:"\u041F\u043B\u0430\u0432\u043D\u043E\u0435 \u0438\u0441\u0447\u0435\u0437\u043D\u043E\u0432\u0435\u043D\u0438\u0435"},fadeOutDown:{category:g.EXIT,keyframes:`
    ...
    `,animation:"uc-fadeOutDown 0.3s ease-out forwards",description:"\u0418\u0441\u0447\u0435\u0437\u043D\u043E\u0432\u0435\u043D\u0438\u0435 \u0432\u043D\u0438\u0437"},scaleOut:{category:g.EXIT,keyframes:`
    ...
    `,animation:"uc-scaleOut 0.3s ease-out forwards",description:"\u0423\u043C\u0435\u043D\u044C\u0448\u0435\u043D\u0438\u0435 \u043F\u0440\u0438 \u0438\u0441\u0447\u0435\u0437\u043D\u043E\u0432\u0435\u043D\u0438\u0438"},pulse:{category:g.ATTENTION,keyframes:`
      @keyframes uc-pulse {
        0%, 100% {
          transform: scale(1);
        }
    ...
    `,animation:"uc-pulse 1s ease-in-out infinite",description:"\u041F\u0443\u043B\u044C\u0441\u0430\u0446\u0438\u044F"},shake:{category:g.ATTENTION,keyframes:`
      @keyframes uc-shake {
        0%, 100% { transform: translateX(0); }
        10%, 30%, 50%, 70%, 90% { transform: translateX(-4px); }
        20%, 40%, 60%, 80% { transform: translateX(4px); }
      }
    `,animation:"uc-shake 0.5s ease-in-out",description:"\u0422\u0440\u044F\u0441\u043A\u0430"},wobble:{category:g.ATTENTION,keyframes:`
      @keyframes uc-wobble {
    ...
    `,animation:"uc-wobble 0.8s ease-in-out",description:"\u041F\u043E\u043A\u0430\u0447\u0438\u0432\u0430\u043D\u0438\u0435"},jello:{category:g.ATTENTION,keyframes:`
      @keyframes uc-jello {
    ...
    `,animation:"uc-jello 0.9s both",description:"\u0416\u0435\u043B\u0435"},heartbeat:{category:g.ATTENTION,keyframes:`
      @keyframes uc-heartbeat {
        0%, 40%, 80%, 100% { transform: scale(1); }
        20%, 60% { transform: scale(1.15); }
      }
    `,animation:"uc-heartbeat 1.3s ease-in-out infinite",description:"\u0421\u0435\u0440\u0434\u0446\u0435\u0431\u0438\u0435\u043D\u0438\u0435"},flash:{category:g.ATTENTION,keyframes:`
      @keyframes uc-flash {
        0%, 50%, 100% { opacity: 1; }
        25%, 75% { opacity: 0; }
      }
    `,animation:"uc-flash 1s ease infinite",description:"\u041C\u0438\u0433\u0430\u043D\u0438\u0435"},rubberBand:{category:g.ATTENTION,keyframes:`
    ...
    `,animation:"uc-rubberBand 1s ease",description:"\u0420\u0435\u0437\u0438\u043D\u043A\u0430"},stateChange:{category:g.STATE,keyframes:`
      @keyframes uc-stateChange {
        0% { transform: scale(1); }
        30% { transform: scale(1.1); }
        100% { transform: scale(1); }
      }
    `,animation:"uc-stateChange 0.3s ease-out",description:"\u0418\u0437\u043C\u0435\u043D\u0435\u043D\u0438\u0435 \u0441\u043E\u0441\u0442\u043E\u044F\u043D\u0438\u044F"},colorPulse:{category:g.STATE,keyframes:`
      @keyframes uc-colorPulse {
        0%, 100% { filter: brightness(1); }
        50% { filter: brightness(1.3); }
      }
    `,animation:"uc-colorPulse 0.5s ease",description:"\u041F\u0443\u043B\u044C\u0441\u0430\u0446\u0438\u044F \u0446\u0432\u0435\u0442\u0430"},ripple:{category:g.STATE,keyframes:`
      @keyframes uc-ripple {
        0% {
          transform: scale(0);
          opacity: 0.5;
    ...
    `,animation:"uc-ripple 0.6s linear",description:"\u0412\u043E\u043B\u043D\u0430 (ripple effect)"},spin:{category:g.LOADING,keyframes:`
      @keyframes uc-spin {
        from { transform: rotate(0deg); }
        to { transform: rotate(360deg); }
      }
    `,animation:"uc-spin 1s linear infinite",description:"\u0412\u0440\u0430\u0449\u0435\u043D\u0438\u0435"},bounce:{category:g.LOADING,keyframes:`
      @keyframes uc-bounce {
        0%, 100% {
          transform: translateY(0);
    ...
    `,animation:"uc-bounce 1s infinite",description:"\u041F\u0440\u044B\u0436\u043A\u0438"},shimmer:{category:g.LOADING,keyframes:`
      @keyframes uc-shimmer {
        0% { background-position: -200% 0; }
        100% { background-position: 200% 0; }
      }
    `,animation:"uc-shimmer 1.5s ease-in-out infinite",description:"\u041C\u0435\u0440\u0446\u0430\u043D\u0438\u0435 (\u0434\u043B\u044F skeleton)"},dots:{category:g.LOADING,keyframes:`
      @keyframes uc-dots {
        0%, 80%, 100% { transform: scale(0); }
        40% { transform: scale(1); }
      }
    `,animation:"uc-dots 1.4s ease-in-out infinite both",description:"\u0422\u043E\u0447\u043A\u0438 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0438"},float:{category:g.CONTINUOUS,keyframes:`
      @keyframes uc-float {
        0%, 100% { transform: translateY(0); }
        50% { transform: translateY(-10px); }
      }
    `,animation:"uc-float 3s ease-in-out infinite",description:"\u041F\u043B\u0430\u0432\u0430\u043D\u0438\u0435"},glow:{category:g.CONTINUOUS,keyframes:`
      @keyframes uc-glow {
        0%, 100% { box-shadow: 0 0 5px currentColor; }
        50% { box-shadow: 0 0 20px currentColor, 0 0 30px currentColor; }
      }
    `,animation:"uc-glow 2s ease-in-out infinite",description:"\u0421\u0432\u0435\u0447\u0435\u043D\u0438\u0435"},wave:{category:g.CONTINUOUS,keyframes:`
      @keyframes uc-wave {
        0%, 100% { transform: rotate(0deg); }
...
`)}};var j={SPINNER:"spinner",DOTS:"dots",BARS:"bars",PULSE:"pulse",SKELETON:"skeleton",WAVE:"wave",RING:"ring",BOUNCE:"bounce",PROGRESS:"progress",SHIMMER:"shimmer"},Ee={XS:"xs",SM:"sm",MD:"md",LG:"lg",XL:"xl"},ke={[Ee.XS]:{size:16,stroke:2,dotSize:4},[Ee.SM]:{size:24,stroke:2.5,dotSize:6},[Ee.MD]:{size:32,stroke:3,dotSize:8},[Ee.LG]:{size:48,stroke:4,dotSize:10},[Ee.XL]:{size:64,stroke:5,dotSize:12}},vt=class{constructor(e={}){this._config={type:j.SPINNER,size:Ee.MD,color:"var(--primary-color, #6366f1)",secondaryColor:"var(--primary-color-light, rgba(99, 102, 241, 0.2))",speed:1,...e}}setType(e){Object.values(j).includes(e)&&(this._config.type=e)}setSize(e){Object.values(Ee).includes(e)&&(this._config.size=e)}create(){let{type:e}=this._config;switch(e){case j.SPINNER:return this._createSpinner();case j.DOTS:return this._createDots();case j.BARS:return this._createBars();case j.PULSE:return this._createPulse();case j.SKELETON:return this._createSkeleton();case j.WAVE:return this._createWave();case j.RING:return this._createRing();case j.BOUNCE:return this._createBounce();case j.PROGRESS:return this._createProgress();case j.SHIMMER:return this._createShimmer();default:return this._createSpinner()}}_createSpinner(){let e=ke[this._config.size],{size:t,stroke:i}=e,{color:r,secondaryColor:s,speed:o}=this._config,a=document.createElement("div");return a.className="uc-loading uc-loading-spinner",a.innerHTML=`
    ...
    `}};var z={CLICK:"click",TOGGLE:"toggle",SUCCESS:"success",ERROR:"error",NOTIFICATION:"notification",PROGRESS:"progress",FEEDBACK:"feedback"},Ii={ripple:{category:z.CLICK,name:"Ripple",description:"Material Design \u0432\u043E\u043B\u043D\u0430",trigger:"click"},pop:{category:z.CLICK,name:"Pop",description:"\u0411\u044B\u0441\u0442\u0440\u043E\u0435 \u0443\u0432\u0435\u043B\u0438\u0447\u0435\u043D\u0438\u0435",trigger:"click",keyframes:`
    ...
    `,duration:500}},xt=class{constructor(){this._injectedStyles=new Set}play(e,t,i={}){let r=Ii[t];if(!r){console.warn(`[MicroInteractions] Unknown interaction: ${t}`);return}switch(r.keyframes&&!this._injectedStyles.has(t)&&this._injectStyles(t,r.keyframes),t){case"ripple":this._playRipple(e,i);break;case"confetti":this._playConfetti(e,i);break;case"checkmark":case"cross":this._playSvgAnimation(e,r,i);break;default:this._playKeyframeAnimation(e,r,i)}}_playRipple(e,t={}){let{x:i,y:r,color:s="var(--primary-color, rgba(99, 102, 241, 0.3))"}=t,o=e.getBoundingClientRect(),a=i!==void 0?i-o.left:o.width/2,c=r!==void 0?r-o.top:o.height/2,l=Math.max(o.width,o.height)*2,d=document.createElement("span");d.className="uc-ripple",d.style.cssText=`
      position: absolute;
      width: ${l}px;
      height: ${l}px;
      left: ${a-l/2}px;
    ...
    `,e.style.position="relative",e.style.overflow="hidden",e.appendChild(d),setTimeout(()=>d.remove(),600)}_playConfetti(e,t={}){let{count:i=30,colors:r=["#ff0","#f0f","#0ff","#f00","#0f0"]}=t,s=e.getBoundingClientRect(),o=document.createElement("div");o.className="uc-confetti-container",o.style.cssText=`
      ...
      pointer-events: none;
      z-index: 10000;
    `;for(let a=0;a<i;a++){let c=document.createElement("span"),l=r[Math.floor(Math.random()*r.length)],d=Math.random()*360*(Math.PI/180),u=50+Math.random()*100,m=Math.cos(d)*u,h=Math.sin(d)*u,f=Math.random()*360;c.style.cssText=`
        position: absolute;
...
`)}};var or={GET:"GET",POST:"POST",PUT:"PUT",PATCH:"PATCH",DELETE:"DELETE"},Se={RAW:"raw",VALUE:"value",TABLE:"table",LIST:"list",TEMPLATE:"template",CHART:"chart"},Li={url:"",method:or.GET,headers:{},body:null,refresh_interval:0,timeout:1e4,cache_ttl:6e4,display_format:Se.VALUE,value_path:"",template:"",transform:null,error_message:"\u041E\u0448\u0438\u0431\u043A\u0430 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0438 \u0434\u0430\u043D\u043D\u044B\u0445",loading_message:"\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430...",show_timestamp:!1,authentication:null},wt=class{constructor(e,t={}){this._hass=e,this._config={...Li,...t},this._element=null,this._data=null,this._error=null,this._loading=!1,this._lastFetch=0,this._refreshInterval=null,this._cache=new Map,this._abortController=null}set hass(e){this._hass=e}setConfig(e){this._config={...Li,...e},this._stopAutoRefresh(),this._config.refresh_interval>0&&this._startAutoRefresh()}render(){return this._element=document.createElement("div"),this._element.className="uc-rest-widget",this._updateDisplay(),this._fetchData(),this._element}async _fetchData(){let{url:e,method:t,headers:i,body:r,timeout:s,cache_ttl:o}=this._config;if(!e){this._error="URL \u043D\u0435 \u0443\u043A\u0430\u0437\u0430\u043D",this._updateDisplay();return}let a=this._getCacheKey(),c=this._cache.get(a);if(c&&Date.now()-c.timestamp<o){this._data=c.data,this._updateDisplay();return}this._abortController&&this._abortController.abort(),this._abortController=new AbortController,this._loading=!0,this._error=null,this._updateDisplay();try{let l=this._processTemplate(e),d={...i};if(this._config.authentication){let f=this._config.authentication;if(f.type==="bearer")d.Authorization=`Bearer ${f.token}`;else if(f.type==="basic"){let b=btoa(`${f.username}:${f.password}`);d.Authorization=`Basic ${b}`}else f.type==="api_key"&&(d[f.header||"X-API-Key"]=f.key)}let u=await fetch(l,{method:t,headers:d,body:r?JSON.stringify(this._processTemplate(r)):null,signal:this._abortController.signal,timeout:s});if(!u.ok)throw new Error(`HTTP ${u.status}: ${u.statusText}`);let m=u.headers.get("content-type"),h;m!=null&&m.includes("application/json")?h=await u.json():h=await u.text(),this._config.transform&&(h=this._applyTransform(h)),this._cache.set(a,{data:h,timestamp:Date.now()}),this._data=h,this._lastFetch=Date.now(),this._loading=!1,this._error=null}catch(l){if(l.name==="AbortError")return;this._loading=!1,this._error=l.message||this._config.error_message,console.error("[RestApiWidget] Fetch error:",l)}this._updateDisplay()}_getCacheKey(){let{url:e,method:t,body:i}=this._config;return`${t}:${e}:${JSON.stringify(i||{})}`}_processTemplate(e){if(typeof e=="string")return e.replace(/\{\{\s*(\w+\.\w+)\s*\}\}/g,(t,i)=>{var r,s,o;return((o=(s=(r=this._hass)==null?void 0:r.states)==null?void 0:s[i])==null?void 0:o.state)||t});if(typeof e=="object"&&e!==null){let t=Array.isArray(e)?[]:{};for(let[i,r]of Object.entries(e))t[i]=this._processTemplate(r);return t}return e}_applyTransform(e){let t=this._config.transform;if(typeof t=="function")return t(e);if(typeof t=="string")try{return new Function("data",`return ${t}`)(e)}catch(i){return console.error("[RestApiWidget] Transform error:",i),e}return e}_getValueByPath(e,t){var s;if(!t)return e;let i=t.split("."),r=e;for(let o of i){let a=o.match(/^(\w+)\[(\d+)\]$/);if(a?r=(s=r==null?void 0:r[a[1]])==null?void 0:s[parseInt(a[2])]:r=r==null?void 0:r[o],r===void 0)return}return r}_updateDisplay(){var a;if(!this._element)return;if(this._loading){this._element.innerHTML=`
    ...
    `}};var nr={COMPACT:"compact",NORMAL:"normal",FULL:"full"},Ri={entity_id:"",style:nr.NORMAL,show_artwork:!0,show_volume:!0,show_progress:!0,show_source:!1,artwork_border_radius:8,volume_step:5},Et=class{constructor(e,t={}){this._hass=e,this._config={...Ri,...t},this._element=null,this._progressInterval=null}set hass(e){this._hass=e,this._update()}setConfig(e){this._config={...Ri,...e}}_getState(){var e,t;return(t=(e=this._hass)==null?void 0:e.states)==null?void 0:t[this._config.entity_id]}render(){return this._element=document.createElement("div"),this._element.className=`uc-media-mini uc-media-${this._config.style}`,this._renderContent(),this._bindEvents(),this._startProgressUpdate(),this._element}_renderContent(){var f;let e=this._getState();if(!e){this._element.innerHTML=`
    ...
    `}};var _={STRING:"string",NUMBER:"number",BOOLEAN:"boolean",ENTITY:"entity",ICON:"icon",COLOR:"color",SELECT:"select",OBJECT:"object",ARRAY:"array",TEMPLATE:"template",ACTION:"action"},C={ERROR:"error",WARNING:"warning",INFO:"info"},cr={title:{type:_.STRING,description:"\u0417\u0430\u0433\u043E\u043B\u043E\u0432\u043E\u043A \u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0438",required:!1},subtitle:{type:_.STRING,description:"\u041F\u043E\u0434\u0437\u0430\u0433\u043E\u043B\u043E\u0432\u043E\u043A",required:!1},icon:{type:_.ICON,description:"\u0418\u043A\u043E\u043D\u043A\u0430 \u0432 \u0437\u0430\u0433\u043E\u043B\u043E\u0432\u043A\u0435",required:!1,default:"mdi:card"},entity:{type:_.ENTITY,description:"\u041E\u0441\u043D\u043E\u0432\u043D\u0430\u044F entity \u0434\u043B\u044F \u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0438",required:!1},body_mode:{type:_.SELECT,description:"\u0420\u0435\u0436\u0438\u043C \u043E\u0442\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u044F \u0442\u0435\u043B\u0430 \u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0438",required:!1,default:"expand",options:Object.values(w)},cards:{type:_.ARRAY,description:"\u041C\u0430\u0441\u0441\u0438\u0432 \u0432\u043B\u043E\u0436\u0435\u043D\u043D\u044B\u0445 \u043A\u0430\u0440\u0442\u043E\u0447\u0435\u043A",required:!1,items:{type:_.OBJECT}},grid:{type:_.OBJECT,description:"\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 Grid layout",required:!1,properties:{columns:{type:_.NUMBER,description:"\u041A\u043E\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E \u043A\u043E\u043B\u043E\u043D\u043E\u043A",min:1,max:12,default:2},gap:{type:_.STRING,description:"\u041E\u0442\u0441\u0442\u0443\u043F \u043C\u0435\u0436\u0434\u0443 \u044D\u043B\u0435\u043C\u0435\u043D\u0442\u0430\u043C\u0438",default:"8px"}}},header_left:{type:_.OBJECT,description:"\u0421\u043E\u0434\u0435\u0440\u0436\u0438\u043C\u043E\u0435 \u0441\u043B\u0435\u0432\u0430 \u0432 header"},header_right:{type:_.OBJECT,description:"\u0421\u043E\u0434\u0435\u0440\u0436\u0438\u043C\u043E\u0435 \u0441\u043F\u0440\u0430\u0432\u0430 \u0432 header"},tap_action:{type:_.ACTION,description:"\u0414\u0435\u0439\u0441\u0442\u0432\u0438\u0435 \u043F\u0440\u0438 \u043A\u043B\u0438\u043A\u0435"},hold_action:{type:_.ACTION,description:"\u0414\u0435\u0439\u0441\u0442\u0432\u0438\u0435 \u043F\u0440\u0438 \u0434\u043E\u043B\u0433\u043E\u043C \u043D\u0430\u0436\u0430\u0442\u0438\u0438"},double_tap_action:{type:_.ACTION,description:"\u0414\u0435\u0439\u0441\u0442\u0432\u0438\u0435 \u043F\u0440\u0438 \u0434\u0432\u043E\u0439\u043D\u043E\u043C \u043A\u043B\u0438\u043A\u0435"},visibility:{type:_.ARRAY,description:"\u0423\u0441\u043B\u043E\u0432\u0438\u044F \u0432\u0438\u0434\u0438\u043C\u043E\u0441\u0442\u0438",items:{type:_.OBJECT}},theme:{type:_.SELECT,description:"\u0422\u0435\u043C\u0430 \u043E\u0444\u043E\u0440\u043C\u043B\u0435\u043D\u0438\u044F",options:["default","glass","neumorphism","neon"]},color_scheme:{type:_.SELECT,description:"\u0426\u0432\u0435\u0442\u043E\u0432\u0430\u044F \u0441\u0445\u0435\u043C\u0430"},lazy_load:{type:_.BOOLEAN,description:"\u041B\u0435\u043D\u0438\u0432\u0430\u044F \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0430 \u043A\u043E\u043D\u0442\u0435\u043D\u0442\u0430",default:!0},collapsed:{type:_.BOOLEAN,description:"\u041D\u0430\u0447\u0430\u043B\u044C\u043D\u043E\u0435 \u0441\u043E\u0441\u0442\u043E\u044F\u043D\u0438\u0435 (\u0441\u0432\u0451\u0440\u043D\u0443\u0442\u043E)",default:!1},link_group:{type:_.STRING,description:"ID \u0433\u0440\u0443\u043F\u043F\u044B \u0441\u0432\u044F\u0437\u0430\u043D\u043D\u044B\u0445 \u043A\u0430\u0440\u0442\u043E\u0447\u0435\u043A"},link_role:{type:_.SELECT,description:"\u0420\u043E\u043B\u044C \u0432 \u0433\u0440\u0443\u043F\u043F\u0435 \u0441\u0432\u044F\u0437\u044B\u0432\u0430\u043D\u0438\u044F",options:["master","slave"]}},Ct=class{constructor(){this._schema=cr,this._customRules=[]}addRule(e){this._customRules.push(e)}validate(e){let t={valid:!0,errors:[],warnings:[],suggestions:[]};if(!e||typeof e!="object")return t.valid=!1,t.errors.push({path:"",message:"\u041A\u043E\u043D\u0444\u0438\u0433\u0443\u0440\u0430\u0446\u0438\u044F \u0434\u043E\u043B\u0436\u043D\u0430 \u0431\u044B\u0442\u044C \u043E\u0431\u044A\u0435\u043A\u0442\u043E\u043C",level:C.ERROR}),t;this._validateSchema(e,this._schema,"",t);for(let i of this._customRules)try{let r=i(e);if(Array.isArray(r))for(let s of r)s.level===C.ERROR?(t.errors.push(s),t.valid=!1):s.level===C.WARNING?t.warnings.push(s):t.suggestions.push(s)}catch(r){console.warn("[ConfigValidator] Rule error:",r)}return this._addSuggestions(e,t),t}_validateSchema(e,t,i,r){for(let[s,o]of Object.entries(t)){let a=i?`${i}.${s}`:s,c=e[s];if(o.required&&c===void 0){r.errors.push({path:a,message:`\u041E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u043E\u0435 \u043F\u043E\u043B\u0435 "${s}" \u043D\u0435 \u0443\u043A\u0430\u0437\u0430\u043D\u043E`,level:C.ERROR}),r.valid=!1;continue}c===void 0||!this._validateType(c,o,a,r)||(o.type===_.OBJECT&&o.properties&&this._validateSchema(c,o.properties,a,r),o.type===_.ARRAY&&o.items&&Array.isArray(c)&&c.forEach((d,u)=>{o.items.type===_.OBJECT&&o.items.properties&&this._validateSchema(d,o.items.properties,`${a}[${u}]`,r)}),o.type===_.NUMBER&&(o.min!==void 0&&c<o.min&&r.warnings.push({path:a,message:`\u0417\u043D\u0430\u0447\u0435\u043D\u0438\u0435 ${c} \u043C\u0435\u043D\u044C\u0448\u0435 \u043C\u0438\u043D\u0438\u043C\u0443\u043C\u0430 ${o.min}`,level:C.WARNING}),o.max!==void 0&&c>o.max&&r.warnings.push({path:a,message:`\u0417\u043D\u0430\u0447\u0435\u043D\u0438\u0435 ${c} \u0431\u043E\u043B\u044C\u0448\u0435 \u043C\u0430\u043A\u0441\u0438\u043C\u0443\u043C\u0430 ${o.max}`,level:C.WARNING})),o.type===_.SELECT&&o.options&&(o.options.includes(c)||(r.errors.push({path:a,message:`\u041D\u0435\u0434\u043E\u043F\u0443\u0441\u0442\u0438\u043C\u043E\u0435 \u0437\u043D\u0430\u0447\u0435\u043D\u0438\u0435 "${c}". \u0414\u043E\u043F\u0443\u0441\u0442\u0438\u043C\u044B\u0435: ${o.options.join(", ")}`,level:C.ERROR}),r.valid=!1)))}for(let s of Object.keys(e))t[s]||r.warnings.push({path:i?`${i}.${s}`:s,message:`\u041D\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043D\u043E\u0435 \u043F\u043E\u043B\u0435 "${s}"`,level:C.WARNING})}_validateType(e,t,i,r){let{type:s}=t;switch(s){case _.STRING:if(typeof e!="string")return r.errors.push({path:i,message:`\u041E\u0436\u0438\u0434\u0430\u0435\u0442\u0441\u044F \u0441\u0442\u0440\u043E\u043A\u0430, \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u043E ${typeof e}`,level:C.ERROR}),r.valid=!1,!1;break;case _.NUMBER:if(typeof e!="number"||isNaN(e))return r.errors.push({path:i,message:`\u041E\u0436\u0438\u0434\u0430\u0435\u0442\u0441\u044F \u0447\u0438\u0441\u043B\u043E, \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u043E ${typeof e}`,level:C.ERROR}),r.valid=!1,!1;break;case _.BOOLEAN:if(typeof e!="boolean")return r.errors.push({path:i,message:`\u041E\u0436\u0438\u0434\u0430\u0435\u0442\u0441\u044F boolean, \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u043E ${typeof e}`,level:C.ERROR}),r.valid=!1,!1;break;case _.OBJECT:if(typeof e!="object"||e===null||Array.isArray(e))return r.errors.push({path:i,message:"\u041E\u0436\u0438\u0434\u0430\u0435\u0442\u0441\u044F \u043E\u0431\u044A\u0435\u043A\u0442",level:C.ERROR}),r.valid=!1,!1;break;case _.ARRAY:if(!Array.isArray(e))return r.errors.push({path:i,message:"\u041E\u0436\u0438\u0434\u0430\u0435\u0442\u0441\u044F \u043C\u0430\u0441\u0441\u0438\u0432",level:C.ERROR}),r.valid=!1,!1;break;case _.ENTITY:(typeof e!="string"||!e.includes("."))&&r.warnings.push({path:i,message:'Entity ID \u0434\u043E\u043B\u0436\u0435\u043D \u0431\u044B\u0442\u044C \u0432 \u0444\u043E\u0440\u043C\u0430\u0442\u0435 "domain.entity"',level:C.WARNING});break;case _.ICON:(typeof e!="string"||!e.includes(":"))&&r.warnings.push({path:i,message:'\u0418\u043A\u043E\u043D\u043A\u0430 \u0434\u043E\u043B\u0436\u043D\u0430 \u0431\u044B\u0442\u044C \u0432 \u0444\u043E\u0440\u043C\u0430\u0442\u0435 "mdi:icon-name"',level:C.WARNING});break}return!0}_addSuggestions(e,t){var i,r;((i=e.cards)==null?void 0:i.length)>5&&e.lazy_load!==!0&&t.suggestions.push({path:"lazy_load",message:"\u0420\u0435\u043A\u043E\u043C\u0435\u043D\u0434\u0443\u0435\u0442\u0441\u044F \u0432\u043A\u043B\u044E\u0447\u0438\u0442\u044C lazy_load \u0434\u043B\u044F \u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0438 \u0441 \u0431\u043E\u043B\u0435\u0435 \u0447\u0435\u043C 5 \u0432\u043B\u043E\u0436\u0435\u043D\u043D\u044B\u043C\u0438 \u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0430\u043C\u0438",level:C.INFO,fix:{lazy_load:!0}}),((r=e.cards)==null?void 0:r.length)>1&&!e.grid&&t.suggestions.push({path:"grid",message:"\u0420\u0435\u043A\u043E\u043C\u0435\u043D\u0434\u0443\u0435\u0442\u0441\u044F \u043D\u0430\u0441\u0442\u0440\u043E\u0438\u0442\u044C grid layout \u0434\u043B\u044F \u043D\u0435\u0441\u043A\u043E\u043B\u044C\u043A\u0438\u0445 \u043A\u0430\u0440\u0442\u043E\u0447\u0435\u043A",level:C.INFO,fix:{grid:{columns:2}}}),(e.state_styles||e.alerts)&&!e.entity&&t.warnings.push({path:"entity",message:"\u0414\u043B\u044F state_styles \u0438 alerts \u0442\u0440\u0435\u0431\u0443\u0435\u0442\u0441\u044F \u0443\u043A\u0430\u0437\u0430\u0442\u044C entity",level:C.WARNING}),e.body_mode==="tabs"&&(!e.tabs||e.tabs.length===0)&&t.warnings.push({path:"tabs",message:"\u0414\u043B\u044F \u0440\u0435\u0436\u0438\u043C\u0430 tabs \u043D\u0435\u043E\u0431\u0445\u043E\u0434\u0438\u043C\u043E \u0443\u043A\u0430\u0437\u0430\u0442\u044C \u043C\u0430\u0441\u0441\u0438\u0432 \u0432\u043A\u043B\u0430\u0434\u043E\u043A",level:C.WARNING})}getCompletions(e=""){let t=[],i=e.split(".").filter(Boolean),r=this._schema;for(let s of i)if(r[s])r=r[s],r.properties&&(r=r.properties);else return[];for(let[s,o]of Object.entries(r))t.push({label:s,type:o.type,description:o.description,required:o.required,default:o.default,options:o.options});return t}getFieldDocumentation(e){let t=e.split(".").filter(Boolean),i=this._schema;for(let r of t)if(i[r])i=i[r],i.properties&&(i=i.properties);else return null;return{...i,path:e}}static getStyles(){return`
      .uc-validation-error {
        color: var(--error-color, #f44336);
        background: rgba(244, 67, 54, 0.1);
        padding: 8px 12px;
    ...
    `}};var G=class{constructor(e={}){this._config=e,this._element=null}render(){throw new Error("render() must be implemented")}getValue(){throw new Error("getValue() must be implemented")}setValue(e){throw new Error("setValue() must be implemented")}},Ot=class extends G{render(){return this._element=document.createElement("div"),this._element.className="uc-editor-field",this._element.innerHTML=`
    ...
    `,this._input=this._element.querySelector("input"),this._input.addEventListener("input",()=>{p(this._element,"value-changed",{value:this.getValue()})}),this._element}getValue(){var e;return((e=this._input)==null?void 0:e.value)||""}setValue(e){this._input&&(this._input.value=e||"")}},It=class extends G{render(){var e,t,i,r;return this._element=document.createElement("div"),this._element.className="uc-editor-field",this._element.innerHTML=`
      ${this._config.label?`<label class="uc-editor-label">${this._config.label}</label>`:""}
      <input type="number" 
             class="uc-editor-input"
             ...
             ${this._config.required?"required":""} />
      ${this._config.helper?`<span class="uc-editor-helper">${this._config.helper}</span>`:""}
    `,this._input=this._element.querySelector("input"),this._input.addEventListener("input",()=>{p(this._element,"value-changed",{value:this.getValue()})}),this._element}getValue(){var t;let e=(t=this._input)==null?void 0:t.value;return e!==""?Number(e):null}setValue(e){this._input&&(this._input.value=e!=null?e:"")}},Lt=class extends G{render(){return this._element=document.createElement("div"),this._element.className="uc-editor-field uc-editor-checkbox",this._element.innerHTML=`
      ...
      ${this._config.helper?`<span class="uc-editor-helper">${this._config.helper}</span>`:""}
    `,this._input=this._element.querySelector("input"),this._input.addEventListener("change",()=>{p(this._element,"value-changed",{value:this.getValue()})}),this._element}getValue(){var e;return((e=this._input)==null?void 0:e.checked)||!1}setValue(e){this._input&&(this._input.checked=!!e)}},Nt=class extends G{render(){this._element=document.createElement("div"),this._element.className="uc-editor-field";let e=(this._config.options||[]).map(t=>{let i=typeof t=="object"?t.value:t,r=typeof t=="object"?t.label:t,s=i===this._config.value?"selected":"";return`<option value="${i}" ${s}>${r}</option>`}).join("");return this._element.innerHTML=`
      ${this._config.label?`<label class="uc-editor-label">${this._config.label}</label>`:""}
      ...
      ${this._config.helper?`<span class="uc-editor-helper">${this._config.helper}</span>`:""}
    `,this._select=this._element.querySelector("select"),this._select.addEventListener("change",()=>{p(this._element,"value-changed",{value:this.getValue()})}),this._element}getValue(){var e;return((e=this._select)==null?void 0:e.value)||""}setValue(e){this._select&&(this._select.value=e||"")}},Rt=class extends G{render(){var e;return this._element=document.createElement("div"),this._element.className="uc-editor-field",this._element.innerHTML=`
      ${this._config.label?`<label class="uc-editor-label">${this._config.label}</label>`:""}
      <ha-entity-picker
      ...
      ></ha-entity-picker>
      ${this._config.helper?`<span class="uc-editor-helper">${this._config.helper}</span>`:""}
    `,this._picker=this._element.querySelector("ha-entity-picker"),(e=this._picker)==null||e.addEventListener("value-changed",t=>{p(this._element,"value-changed",{value:t.detail.value})}),this._element}getValue(){var e;return((e=this._picker)==null?void 0:e.value)||""}setValue(e){this._picker&&(this._picker.value=e||"")}},Mt=class extends G{render(){var e;return this._element=document.createElement("div"),this._element.className="uc-editor-field",this._element.innerHTML=`
      ${this._config.label?`<label class="uc-editor-label">${this._config.label}</label>`:""}
      <ha-icon-picker
        .hass="${this._config.hass}"
        .value="${this._config.value||""}"
      ></ha-icon-picker>
      ${this._config.helper?`<span class="uc-editor-helper">${this._config.helper}</span>`:""}
    `,this._picker=this._element.querySelector("ha-icon-picker"),(e=this._picker)==null||e.addEventListener("value-changed",t=>{p(this._element,"value-changed",{value:t.detail.value})}),this._element}getValue(){var e;return((e=this._picker)==null?void 0:e.value)||""}setValue(e){this._picker&&(this._picker.value=e||"")}},Dt=class extends G{render(){return this._element=document.createElement("div"),this._element.className="uc-editor-field uc-editor-color",this._element.innerHTML=`
      ${this._config.label?`<label class="uc-editor-label">${this._config.label}</label>`:""}
      ...
      ${this._config.helper?`<span class="uc-editor-helper">${this._config.helper}</span>`:""}
    `,this._colorInput=this._element.querySelector(".uc-editor-color-input"),this._textInput=this._element.querySelector(".uc-editor-color-text"),this._colorInput.addEventListener("input",()=>{this._textInput.value=this._colorInput.value,p(this._element,"value-changed",{value:this.getValue()})}),this._textInput.addEventListener("input",()=>{/^#[0-9a-fA-F]{6}$/.test(this._textInput.value)&&(this._colorInput.value=this._textInput.value),p(this._element,"value-changed",{value:this.getValue()})}),this._element}getValue(){var e;return((e=this._textInput)==null?void 0:e.value)||""}setValue(e){this._colorInput&&this._textInput&&(this._colorInput.value=e||"#ffffff",this._textInput.value=e||"")}},zt=class extends G{render(){return this._element=document.createElement("div"),this._element.className=`uc-editor-section ${this._config.expanded?"expanded":""}`,this._element.innerHTML=`
    ...
    `,this._typeSelect=this._element.querySelector(".uc-editor-action-type"),this._optionsContainer=this._element.querySelector(".uc-editor-action-options"),this._typeSelect.addEventListener("change",()=>{this._updateOptions(),p(this._element,"value-changed",{value:this.getValue()})}),this._updateOptions(),this._element}_updateOptions(){var t,i,r,s;let e=this._typeSelect.value;switch(this._optionsContainer.innerHTML="",e){case"call-service":this._optionsContainer.innerHTML=`
          <input type="text" 
        ...
        `;break}this._optionsContainer.querySelectorAll("input, textarea").forEach(o=>{o.addEventListener("input",()=>{p(this._element,"value-changed",{value:this.getValue()})})})}getValue(){var i,r,s,o;let e=this._typeSelect.value,t={action:e};switch(e){case"call-service":let a=(i=this._optionsContainer.querySelector(".action-service"))==null?void 0:i.value,c=(r=this._optionsContainer.querySelector(".action-data"))==null?void 0:r.value;if(a&&(t.service=a),c)try{t.service_data=JSON.parse(c)}catch{}break;case"navigate":let l=(s=this._optionsContainer.querySelector(".action-path"))==null?void 0:s.value;l&&(t.navigation_path=l);break;case"url":let d=(o=this._optionsContainer.querySelector(".action-url"))==null?void 0:o.value;d&&(t.url_path=d);break}return e==="none"?null:t}setValue(e){this._config.value=e,this._typeSelect&&(this._typeSelect.value=(e==null?void 0:e.action)||"none",this._updateOptions())}};function Di(){return`
    .uc-editor-field {
      margin-bottom: 16px;
    }
