...
(()=>{var ui=!1;function Xt(n){ui=n}function h(...n){ui&&console.log(...n)}function Ve(n="uc"){let e=Math.random().toString(36).substring(2,10);return`${n}-${e}`}function q(n){return n!==null&&typeof n=="object"&&!Array.isArray(n)}function Kt(n){return typeof n=="string"&&n.trim().length>0}function ji(n){return typeof n=="number"&&!Number.isNaN(n)}function Jt(n,e){let t={...n};return q(n)&&q(e)&&Object.keys(e).forEach(i=>{q(e[i])&&i in n?t[i]=Jt(n[i],e[i]):t[i]=e[i]}),t}function W(n){if(n===null||typeof n!="object")return n;if(Array.isArray(n))return n.map(t=>W(t));let e={};return Object.keys(n).forEach(t=>{e[t]=W(n[t])}),e}function hi(n,e,t=void 0){if(!n||!e)return t;let i=e.split("."),r=n;for(let s of i){if(r==null)return t;r=r[s]}return r!==void 0?r:t}function pi(n){return n==null?[]:Array.isArray(n)?n:[n]}function f(n,e,t={},i={}){let r=new CustomEvent(e,{bubbles:i.bubbles!==!1,cancelable:i.cancelable!==!1,composed:i.composed!==!1,detail:t});return n.dispatchEvent(r),r}function mi(){return new Promise(n=>{requestAnimationFrame(()=>{requestAnimationFrame(n)})})}function fi(n,e=2){return ji(n)?n.toFixed(e):""}function _i(n,e={},t="ru-RU"){let i=n instanceof Date?n:new Date(n),r={year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"};return new Intl.DateTimeFormat(t,{...r,...e}).format(i)}function Ye(n){return Kt(n)?/^[a-z_]+\.[a-z0-9_]+$/.test(n):!1}var Zt="1.0.0",gi="Universal Card",bi="\u041F\u0440\u043E\u0434\u0432\u0438\u043D\u0443\u0442\u0430\u044F \u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0430 \u0441 7 \u0440\u0435\u0436\u0438\u043C\u0430\u043C\u0438 body, grid layout, lazy loading \u0438 \u0440\u0430\u0441\u0448\u0438\u0440\u0435\u043D\u043D\u043E\u0439 \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u043E\u0439",k=Object.freeze({EXPAND:"expand",MODAL:"modal",FULLSCREEN:"fullscreen",TABS:"tabs",CAROUSEL:"carousel",SUBVIEW:"subview",NONE:"none"}),$e=Object.values(k),$=Object.freeze({DEFAULT:"default",TRANSPARENT:"transparent",SOLID:"solid",GLASS:"glass",GLASSMORPHISM:"glassmorphism",NEUMORPHISM:"neumorphism",MINIMAL:"minimal",GRADIENT:"gradient",DARK:"dark",NEON:"neon",AURORA:"aurora",CARBON:"carbon",SLATE:"slate",OBSIDIAN:"obsidian",CHARCOAL:"charcoal",MIDNIGHT:"midnight",CYBER:"cyber",VOID:"void",EMBER:"ember",FOREST:"forest",OCEAN:"ocean",PURPLE_HAZE:"purple-haze",MATRIX:"matrix",GRAPHITE:"graphite",SMOKE:"smoke",NORD:"nord",DRACULA:"dracula",MONOKAI:"monokai",TOKYO_NIGHT:"tokyo-night",CATPPUCCIN:"catppuccin"}),Gi=Object.freeze({NONE:"none",FADE:"fade",SLIDE:"slide",BOUNCE:"bounce",ELASTIC:"elastic",SMOOTH:"smooth",SHARP:"sharp",ZOOM:"zoom"}),Vi=Object.freeze({SKELETON:"skeleton",SPINNER:"spinner",DOTS:"dots",PROGRESS:"progress",SHIMMER:"shimmer",PULSE:"pulse"}),A=Object.freeze({STATE:"state",NUMERIC_STATE:"numeric_state",USER:"user",TIME:"time",SCREEN:"screen",AND:"and",OR:"or",NOT:"not"}),F=Object.freeze({NONE:"none",TOGGLE:"toggle",CALL_SERVICE:"call-service",NAVIGATE:"navigate",URL:"url",MORE_INFO:"more-info",FIRE_EVENT:"fire-dom-event",EXPAND:"expand",COLLAPSE:"collapse"}),ye=Object.freeze({CARD_EXPANDED:"universal-card-expanded",CARD_COLLAPSED:"universal-card-collapsed",CARD_CONTROL:"universal-card-control",CONFIG_CHANGED:"config-changed",HASS_UPDATED:"hass-updated"}),yi=Object.freeze({PRIMARY:"--uc-primary-color",SECONDARY:"--uc-secondary-color",ACCENT:"--uc-accent-color",BACKGROUND:"--uc-background-color",SURFACE:"--uc-surface-color",TEXT:"--uc-text-color",TEXT_SECONDARY:"--uc-text-secondary-color",BORDER:"--uc-border-color",BORDER_RADIUS:"--uc-border-radius",PADDING:"--uc-padding",GAP:"--uc-gap",SHADOW:"--uc-shadow",SHADOW_HOVER:"--uc-shadow-hover",TRANSITION_DURATION:"--uc-transition-duration",TRANSITION_TIMING:"--uc-transition-timing"}),E=Object.freeze({body_mode:k.EXPAND,expanded:!1,animation:!0,theme:$.DEFAULT,border_radius:"var(--ha-card-border-radius, 12px)",padding:"16px",grid_columns:1,grid_gap:"16px",modal_width:"90%",modal_max_width:"600px",backdrop_color:"rgba(0, 0, 0, 0.6)",lazy_load:!0,remember_state:!1,show_expand_icon:!0,expand_icon:"mdi:chevron-down",haptic:!1,loading_type:Vi.SKELETON,skeleton_count:3,carousel_autoplay:!1,carousel_interval:5e3,animation_preset:Gi.SMOOTH,animation_duration:300}),R=Object.freeze({MAX_GRID_COLUMNS:12,MIN_GRID_COLUMNS:1,MAX_CARDS_PER_BODY:100,MAX_TABS:20,UPDATE_THROTTLE_MS:100,RESIZE_DEBOUNCE_MS:200,INTERSECTION_MARGIN:"100px",MAX_UNDO_HISTORY:50,MAX_LOG_ENTRIES:1e3});var x=class extends Error{constructor(e,t){super(t?`${t}: ${e}`:e),this.name="ConfigValidationError",this.path=t}},ve=class{static validate(e){var i,r;if(!q(e))throw new x("Configuration must be an object");if(e.body_mode&&!$e.includes(e.body_mode))throw new x(`Invalid body_mode: "${e.body_mode}". Valid modes: ${$e.join(", ")}`,"body_mode");let t=Object.values($);if(e.theme&&!t.includes(e.theme))throw new x(`Invalid theme: "${e.theme}". Valid themes: ${t.join(", ")}`,"theme");if(e.entity&&!Ye(e.entity))throw new x(`Invalid entity format: "${e.entity}"`,"entity");if(e.grid&&e.grid.columns!==void 0){let s=e.grid.columns;if(typeof s=="number"){if(s<R.MIN_GRID_COLUMNS||s>R.MAX_GRID_COLUMNS)throw new x("Grid columns must be between "+R.MIN_GRID_COLUMNS+" and "+R.MAX_GRID_COLUMNS,"grid.columns")}else if(typeof s!="string")throw new x("Grid columns must be a number or CSS template string","grid.columns")}if((i=e.body)!=null&&i.cards){if(!Array.isArray(e.body.cards))throw new x("body.cards must be an array","body.cards");if(e.body.cards.length>R.MAX_CARDS_PER_BODY)throw new x(`Maximum ${R.MAX_CARDS_PER_BODY} cards allowed in body`,"body.cards");e.body.cards.forEach((s,o)=>{this._validateCardConfig(s,`body.cards[${o}]`)})}if((r=e.header)!=null&&r.cards){if(!Array.isArray(e.header.cards))throw new x("header.cards must be an array","header.cards");e.header.cards.forEach((s,o)=>{this._validateCardConfig(s,`header.cards[${o}]`)})}return e.tabs&&this._validateTabs(e.tabs),e.visibility&&this._validateConditions(e.visibility,"visibility"),["tap_action","hold_action","double_tap_action"].forEach(s=>{e[s]&&this._validateAction(e[s],s)}),!0}static _validateCardConfig(e,t){if(!q(e))throw new x("Card config must be an object",t);if(!e.type)throw new x("Card must have a type",t)}static _validateTabs(e){if(!Array.isArray(e))throw new x("tabs must be an array","tabs");if(e.length>R.MAX_TABS)throw new x(`Maximum ${R.MAX_TABS} tabs allowed`,"tabs");e.forEach((t,i)=>{if(!q(t))throw new x("Tab config must be an object",`tabs[${i}]`);if(t.cards&&!Array.isArray(t.cards))throw new x("Tab cards must be an array",`tabs[${i}].cards`)})}static _validateConditions(e,t){if(!Array.isArray(e))throw new x("Visibility must be an array",t);let i=Object.values(A);e.forEach((r,s)=>{let o=`${t}[${s}]`;if(!q(r))throw new x("Condition must be an object",o);if(!r.condition)throw new x('Condition must have a "condition" type',o);if(!i.includes(r.condition))throw new x(`Invalid condition type: "${r.condition}"`,o)})}static _validateAction(e,t){if(!q(e))throw new x("Action must be an object",t);let i=Object.values(F);if(e.action&&!i.includes(e.action))throw new x(`Invalid action: "${e.action}"`,t);if(e.action===F.CALL_SERVICE&&!e.service)throw new x('call-service action requires a "service" property',t);if(e.action===F.NAVIGATE&&!e.navigation_path)throw new x('navigate action requires a "navigation_path" property',t);if(e.action===F.URL&&!e.url_path)throw new x('url action requires a "url_path" property',t)}static normalize(e){this.validate(e);let t={...E,...e};return t.card_id||(t.card_id=Ve("uc")),t.header=this._normalizeSection(e.header,"header"),e.body?t.body=this._normalizeSection(e.body,"body"):e.cards?t.body={cards:e.cards}:t.body={cards:[]},e.footer&&(t.footer=this._normalizeSection(e.footer,"footer")),e.tabs&&(t.tabs=e.tabs.map((i,r)=>({label:i.label||`Tab ${r+1}`,icon:i.icon||null,cards:i.cards||[],...i}))),t.grid=this._normalizeGrid(e.grid),t.tap_action=this._normalizeAction(e.tap_action,"toggle"),t.hold_action=this._normalizeAction(e.hold_action,"none"),t.double_tap_action=this._normalizeAction(e.double_tap_action,"none"),e.visibility&&(t.visibility=e.visibility.map(i=>this._normalizeCondition(i))),t}static _normalizeSection(e,t){return e?{cards:e.cards||[],...e}:{cards:[]}}static _normalizeGrid(e){return e?{columns:e.columns||E.grid_columns,gap:e.gap||E.grid_gap,responsive:e.responsive||null}:{columns:E.grid_columns,gap:E.grid_gap}}static _normalizeAction(e,t="none"){return e?{action:e.action||t,...e}:{action:t}}static _normalizeCondition(e){let t={condition:e.condition,...e};return e.condition===A.STATE&&e.state&&(t.state=Array.isArray(e.state)?e.state:[e.state]),t}static getTitle(e,t){var i;return e.title?e.title:e.entity&&((i=t==null?void 0:t.states)!=null&&i[e.entity])?t.states[e.entity].attributes.friendly_name||e.entity:""}static getSubtitle(e,t){var i;return e.subtitle?e.subtitle:e.entity&&((i=t==null?void 0:t.states)!=null&&i[e.entity])?t.states[e.entity].state:""}static hasChanged(e,t){return JSON.stringify(e)!==JSON.stringify(t)}static getSchema(){return{type:"object",properties:{title:{type:"string"},subtitle:{type:"string"},icon:{type:"string"},entity:{type:"string"},body_mode:{type:"string",enum:$e,default:k.EXPAND},theme:{type:"string",enum:Object.values($),default:$.SOLID},expanded:{type:"boolean",default:!1},animation:{type:"boolean",default:!0},lazy_load:{type:"boolean",default:!0},show_expand_icon:{type:"boolean",default:!0},grid:{type:"object",properties:{columns:{type:"number",minimum:1,maximum:12},gap:{type:"string"}}}}}}};function Z(n,e=100,t={}){let{leading:i=!1,trailing:r=!0}=t,s=null,o=null,a=null,c=null,l=null;function d(v){let Y=o,be=a;return o=null,a=null,l=v,c=n.apply(be,Y),c}function u(v){let Y=l===null?e:v-l;return l===null||Y>=e}function m(){let v=Date.now();if(u(v))return p(v);s=setTimeout(m,e-(v-l))}function p(v){return s=null,r&&o?d(v):(o=null,a=null,c)}function _(v){return l=v,s=setTimeout(m,e),i?d(v):c}function b(...v){let Y=Date.now(),be=u(Y);return o=v,a=this,be&&s===null?_(Y):(s===null&&(s=setTimeout(m,e)),c)}return b.cancel=function(){s!==null&&clearTimeout(s),o=null,a=null,l=null,s=null},b.flush=function(){return s!==null?p(Date.now()):c},b.pending=function(){return s!==null},b}function Ae(n,e=16,t={}){let{leading:i=!0,trailing:r=!0}=t,s=0,o=null,a=null,c=null;function l(){let u=a,m=c;return a=null,c=null,s=Date.now(),n.apply(m,u)}function d(...u){let p=Date.now()-s;if(a=u,c=this,p>=e&&(o!==null&&(clearTimeout(o),o=null),i))return l();if(o===null&&r){let _=e-p;o=setTimeout(()=>{o=null,l()},_>0?_:0)}}return d.cancel=function(){o!==null&&(clearTimeout(o),o=null),s=0,a=null,c=null},d}function vi(n){return requestAnimationFrame(n)}function xi(n){return new Promise(e=>{requestAnimationFrame(()=>{requestAnimationFrame(()=>{n(),e()})})})}function Qt(n){return new Promise(e=>{requestAnimationFrame(()=>{n.forEach(t=>{try{t()}catch(i){console.error("[UniversalCard] Batch update error:",i)}}),e()})})}function wi(){let n=[],e=!1;function t(){if(n.length===0)return;let r=[...n];n.length=0,e=!1,Qt(r)}function i(r){n.push(r),e||(e=!0,requestAnimationFrame(t))}return{add:i,flush:t}}function ki(n,e={}){let{timeout:t=1e3}=e;return"requestIdleCallback"in window?window.requestIdleCallback(n,{timeout:t}):setTimeout(n,1)}function Ei(n,e){let t=performance.now(),i=e(),r=performance.now();return console.debug(`[UniversalCard] ${n}: ${(r-t).toFixed(2)}ms`),i}var qe=null;async function De(){return qe||(qe=new Promise(async n=>{if(window.loadCardHelpers){n(await window.loadCardHelpers());return}let e=setInterval(async()=>{window.loadCardHelpers&&(clearInterval(e),n(await window.loadCardHelpers()))},100);setTimeout(()=>{clearInterval(e),console.warn("[UniversalCard] Card helpers not available"),n(null)},1e4)}),qe)}async function ei(n){if(!n||!n.type)throw new Error("Card config must have a type");let e=await De();if(e)try{return await e.createCardElement(n)}catch(t){throw new Error(`Failed to create card: ${t.message}`)}return Yi(n)}function Yi(n){let e=n.type,t=e;e.startsWith("custom:")?t=e.slice(7):t=`hui-${e}-card`;let i=document.createElement(t);return i.setConfig&&i.setConfig(n),i}async function ne(n){return Array.isArray(n)?(await Promise.allSettled(n.map(t=>ei(t)))).map((t,i)=>t.status==="fulfilled"?t.value:(console.error("[UniversalCard] Card creation failed:",t.reason),ti(t.reason,n[i]))):[]}function ti(n,e){let t=document.createElement("ha-card");return t.className="uc-error-card",t.innerHTML=`
    <div class="error-content">
      <ha-icon icon="mdi:alert-circle-outline"></ha-icon>
      <span class="error-message">${n.message||"Unknown error"}</span>
      <button class="error-details-btn">?</button>
    </div>
  `,t._errorData={error:n,config:e,stack:n.stack},t}function We(n,e){return!(n!=null&&n.states)||!e?null:n.states[e]||null}function I(n,e,t="unavailable"){let i=We(n,e);return i&&i.state!==void 0?i.state:t}function ie(n,e,t,i){let r=We(n,e);var s=r&&r.attributes?r.attributes[t]:void 0;return s!==void 0?s:i}function Si(n,e,t){let i=I(n,e);return(Array.isArray(t)?t:[t]).includes(i)}async function X(n,e,t,i={}){if(!t||t.action==="none")return;let{action:r}=t;switch(r){case"toggle":await qi(n,t);break;case"call-service":await Wi(n,t);break;case"navigate":Xi(t);break;case"url":Ki(t);break;case"more-info":Ji(e,t);break;case"fire-dom-event":Zi(e,t);break;default:console.warn(`[UniversalCard] Unknown action: ${r}`)}}async function qi(n,e){let t=e.entity;if(!t)return;let i=t.split(".")[0];await n.callService(i,"toggle",{entity_id:t})}async function Wi(n,e){let{service:t,service_data:i,target:r}=e;if(!t)return;let[s,o]=t.split(".");await n.callService(s,o,i||{},r)}function Xi(n){let e=n.navigation_path;e&&(history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")))}function Ki(n){let e=n.url_path;if(!e)return;let t=n.url_target||"_blank";window.open(e,t)}function Ji(n,e){let t=e.entity;if(!t)return;let i=new CustomEvent("hass-more-info",{bubbles:!0,composed:!0,detail:{entityId:t}}),r=n;for(;r&&r.tagName!=="UNIVERSAL-CARD";)r=r.parentElement||r.getRootNode().host;r&&r.isConnected?r.dispatchEvent(i):(document.querySelector("ha-panel-lovelace")||document.querySelector("home-assistant")||document.body).dispatchEvent(i)}function Zi(n,e){let t=new CustomEvent("ll-custom",{bubbles:!0,composed:!0,detail:e});n.dispatchEvent(t)}function Ci(n="light"){let e=new CustomEvent("haptic",{bubbles:!0,composed:!0,detail:n});window.dispatchEvent(e)}function Ti(n){let e=getComputedStyle(n);return{primaryColor:e.getPropertyValue("--primary-color").trim(),accentColor:e.getPropertyValue("--accent-color").trim(),textColor:e.getPropertyValue("--primary-text-color").trim(),secondaryTextColor:e.getPropertyValue("--secondary-text-color").trim(),backgroundColor:e.getPropertyValue("--primary-background-color").trim(),cardBackgroundColor:e.getPropertyValue("--ha-card-background").trim()||e.getPropertyValue("--card-background-color").trim(),dividerColor:e.getPropertyValue("--divider-color").trim(),borderRadius:e.getPropertyValue("--ha-card-border-radius").trim()||"12px"}}function Xe(n){return(n==null?void 0:n.user)||null}function $i(n){var e;return((e=n==null?void 0:n.user)==null?void 0:e.is_admin)===!0}var Oe=class{constructor(e,t={}){this._config=e,this._options=t,this._element=null,this._leftCards=[],this._rightCards=[],this._contentCards=[],this._hass=null,this._expanded=!1,this._holdTimer=null,this._isHolding=!1,this._holdDuration=500,this._lastTapTime=0,this._doubleTapThreshold=300,this._attached=!1,this._boundHandlers=null}set hass(e){this._hass=e,this._updateCards(e),this._updateDynamicContent()}set expanded(e){this._expanded=e,this._updateExpandedState()}render(){let e=this._config;return this._element=document.createElement("div"),this._element.className=this._getHeaderClasses(),this._element.setAttribute("role","button"),this._element.setAttribute("tabindex","0"),this._element.setAttribute("aria-expanded",String(this._expanded)),this._element.innerHTML=`
    ...
    `:""}_renderTitle(){let{title:e,entity:t}=this._config,i=e||this._getEntityName(t)||"";return i?`<div class="header-title">${i}</div>`:""}_renderSubtitle(){let{subtitle:e,entity:t,show_state:i}=this._config,r=e||"";if(i!==!1&&t&&this._hass){let s=I(this._hass,t);s&&s!=="unavailable"&&(r=r?`${r} \xB7 ${s}`:s)}return r?`<div class="header-subtitle">${r}</div>`:""}_renderBadges(){let{badges:e}=this._config;return!e||!Array.isArray(e)||e.length===0?"":`<div class="header-badges">${e.map(i=>this._renderBadge(i)).join("")}</div>`}_renderBadge(e){let{entity:t,icon:i,color:r,value:s,label:o}=e,a=s||"",c=r||"var(--primary-color)";if(t&&this._hass){a=I(this._hass,t,"");let m=this._hass.states[t];if(m){let p=this._getStateColor(m.state);p&&(c=p)}}let l=i?`<ha-icon icon="${i}"></ha-icon>`:"",d=o?`<span class="badge-label">${o}</span>`:"",u=a?`<span class="badge-value">${a}</span>`:"";return`
    ...
    `}_getHeaderClasses(){let e=["header"];return this._expanded&&e.push("expanded"),(this._config.sticky_header||this._config.sticky)&&e.push("sticky"),this._config.clickable===!1&&e.push("non-clickable"),e.join(" ")}async loadCards(){let{header_left:e,header_right:t,cards:i}=this._config,r=[];e!=null&&e.cards&&r.push(this._loadSlotCards(e.cards,".header-left-slot","_leftCards")),t!=null&&t.cards&&r.push(this._loadSlotCards(t.cards,".header-right-slot","_rightCards")),i&&r.push(this._loadSlotCards(i,".header-cards-slot","_contentCards")),await Promise.all(r)}async _loadSlotCards(e,t,i){var s;if(!Array.isArray(e)||e.length===0)return;let r=(s=this._element)==null?void 0:s.querySelector(t);if(r)try{let o=await ne(e);this[i]=o;let a=document.createDocumentFragment();o.forEach(c=>{this._hass&&(c.hass=this._hass),a.appendChild(c)}),r.appendChild(a)}catch(o){console.error("[UniversalCard] Failed to load slot cards:",o)}}_updateCards(e){[...this._leftCards,...this._rightCards,...this._contentCards].forEach(i=>{if(i&&"hass"in i)try{i.hass=e}catch(r){}})}_bindEvents(){this._element&&(this._boundHandlers={click:e=>this._handleClick(e),touchstart:e=>this._handleTouchStart(e),touchend:e=>this._handleTouchEnd(e),touchcancel:()=>this._cancelHold(),mousedown:e=>this._handleMouseDown(e),mouseup:()=>this._handleMouseUp(),mouseleave:()=>this._cancelHold(),keydown:e=>this._handleKeydown(e),contextmenu:e=>this._handleContextMenu(e)},this._element.addEventListener("click",this._boundHandlers.click),this._element.addEventListener("touchstart",this._boundHandlers.touchstart,{passive:!0}),this._element.addEventListener("touchend",this._boundHandlers.touchend),this._element.addEventListener("touchcancel",this._boundHandlers.touchcancel),this._element.addEventListener("mousedown",this._boundHandlers.mousedown),this._element.addEventListener("mouseup",this._boundHandlers.mouseup),this._element.addEventListener("mouseleave",this._boundHandlers.mouseleave),this._element.addEventListener("keydown",this._boundHandlers.keydown),this._element.addEventListener("contextmenu",this._boundHandlers.contextmenu))}_handleClick(e){if(h("[UC-Header] click!",e.target),this._isInteractiveElement(e.target)){h("[UC-Header] ignored - interactive element");return}if(this._isHolding){h("[UC-Header] ignored - was holding"),this._isHolding=!1;return}let t=Date.now(),i=t-this._lastTapTime;if(this._lastTapTime=t,i<this._doubleTapThreshold){h("[UC-Header] double-tap detected"),e.preventDefault(),this._executeAction("double_tap_action");return}setTimeout(()=>{Date.now()-this._lastTapTime>=this._doubleTapThreshold&&this._executeAction("tap_action")},this._doubleTapThreshold)}_handleTouchStart(e){this._isInteractiveElement(e.target)||this._startHold()}_handleTouchEnd(e){this._endHold()}_handleMouseDown(e){e.button===0&&(this._isInteractiveElement(e.target)||this._startHold())}_handleMouseUp(){this._endHold()}_startHold(){this._cancelHold(),this._holdTimer=setTimeout(()=>{this._isHolding=!0,this._executeAction("hold_action")},this._holdDuration)}_endHold(){this._holdTimer&&(clearTimeout(this._holdTimer),this._holdTimer=null)}_cancelHold(){this._endHold(),this._isHolding=!1}_handleKeydown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),this._executeAction("tap_action"))}_handleContextMenu(e){this._config.context_menu&&(e.preventDefault(),f(this._element,"uc-context-menu",{x:e.clientX,y:e.clientY,config:this._config.context_menu}))}_isInteractiveElement(e){if(!this._element||!e)return!0;if(e===this._element||this._element.contains(e)){let t=["ha-icon-button","button","a[href]","input","select","textarea",".badge.clickable",".quick-action"],i=e;for(;i&&i!==this._element;){if(i.matches&&i.matches(t.join(", ")))return h("[UC-Header] blocked interactive:",i.tagName),!0;i=i.parentElement}return!1}return!1}_executeAction(e){h("[UC-Header] _executeAction:",e);let t=this._config[e];if(h("[UC-Header] actionConfig:",t),!t&&e==="tap_action"){h("[UC-Header] firing uc-toggle (default)"),f(this._element,"uc-toggle");return}if(!t||t.action===F.NONE){h("[UC-Header] no action config or action=none");return}if(t.action===F.EXPAND){h("[UC-Header] firing uc-expand"),f(this._element,"uc-expand");return}if(t.action===F.COLLAPSE){h("[UC-Header] firing uc-collapse"),f(this._element,"uc-collapse");return}if(t.action==="toggle"){h("[UC-Header] firing uc-toggle"),f(this._element,"uc-toggle");return}h("[UC-Header] executing HA action"),X(this._hass,this._element,t)}_updateExpandedState(){if(!this._element)return;this._element.classList.toggle("expanded",this._expanded),this._element.setAttribute("aria-expanded",String(this._expanded));let e=this._element.querySelector(".expand-icon");e&&e.classList.toggle("expanded",this._expanded)}_updateDynamicContent(){if(!(!this._element||!this._hass)){if(this._config.entity&&this._config.show_state!==!1){let e=this._element.querySelector(".header-subtitle");if(e){let t=I(this._hass,this._config.entity),i=this._config.subtitle;e.textContent=i?`${i} \xB7 ${t}`:t}}this._updateBadges()}}_updateBadges(){let{badges:e}=this._config;if(!e||!Array.isArray(e))return;let t=this._element.querySelectorAll(".badge");e.forEach((i,r)=>{if(!i.entity||!t[r])return;let s=I(this._hass,i.entity,""),o=t[r].querySelector(".badge-value");o&&(o.textContent=s)})}_getEntityIcon(e){if(!this._hass||!e)return null;let t=this._hass.states[e];if(!t)return null;if(t.attributes.icon)return t.attributes.icon;let i=e.split(".")[0];return this._getDomainIcon(i)}_getEntityName(e){var i;if(!this._hass||!e)return null;let t=this._hass.states[e];return((i=t==null?void 0:t.attributes)==null?void 0:i.friendly_name)||null}_getDomainIcon(e){return{light:"mdi:lightbulb",switch:"mdi:toggle-switch",sensor:"mdi:eye",binary_sensor:"mdi:radiobox-blank",climate:"mdi:thermostat",cover:"mdi:window-shutter",fan:"mdi:fan",media_player:"mdi:cast",camera:"mdi:video",lock:"mdi:lock",alarm_control_panel:"mdi:shield-home",automation:"mdi:robot",script:"mdi:script-text",scene:"mdi:palette",input_boolean:"mdi:toggle-switch-outline",input_number:"mdi:ray-vertex",input_select:"mdi:format-list-bulleted",input_text:"mdi:form-textbox",person:"mdi:account",device_tracker:"mdi:account",weather:"mdi:weather-partly-cloudy",vacuum:"mdi:robot-vacuum"}[e]||"mdi:bookmark"}_getStateColor(e){return{on:"var(--state-active-color, #fdd835)",off:"var(--state-inactive-color, #969696)",home:"var(--state-home-color, #4caf50)",not_home:"var(--state-not-home-color, #f44336)",armed_home:"var(--state-warning-color, #ff9800)",armed_away:"var(--state-error-color, #f44336)",disarmed:"var(--state-success-color, #4caf50)",unavailable:"var(--state-unavailable-color, #bdbdbd)"}[e]||null}detach(){this._cancelHold(),this._removeEventListeners(),this._attached=!1}attach(){this._attached||this._element&&(this._bindEvents(),this._attached=!0)}_removeEventListeners(){this._element&&this._boundHandlers&&(this._element.removeEventListener("click",this._boundHandlers.click),this._element.removeEventListener("touchstart",this._boundHandlers.touchstart),this._element.removeEventListener("touchend",this._boundHandlers.touchend),this._element.removeEventListener("touchcancel",this._boundHandlers.touchcancel),this._element.removeEventListener("mousedown",this._boundHandlers.mousedown),this._element.removeEventListener("mouseup",this._boundHandlers.mouseup),this._element.removeEventListener("mouseleave",this._boundHandlers.mouseleave),this._element.removeEventListener("keydown",this._boundHandlers.keydown),this._element.removeEventListener("contextmenu",this._boundHandlers.contextmenu)),this._boundHandlers=null}destroy(){this._cancelHold(),this._removeEventListeners(),this._leftCards=[],this._rightCards=[],this._contentCards=[],this._hass=null,this._element=null,this._attached=!1}};var Le=class{constructor(e,t={}){this._config=e,this._options=t,this._element=null,this._leftCards=[],this._rightCards=[],this._contentCards=[],this._hass=null,this._holdTimer=null,this._isHolding=!1}set hass(e){this._hass=e,this._updateCards(e)}render(){let e=this._config;return this._element=document.createElement("div"),this._element.className=this._getFooterClasses(),this._element.innerHTML=`
    ...
    `).join("")}_getFooterClasses(){let e=["footer"];return this._config.sticky&&e.push("sticky"),this._config.border_top!==!1&&e.push("with-border"),e.join(" ")}async loadCards(){let{footer_left:e,footer_right:t,cards:i}=this._config,r=[];e!=null&&e.cards&&r.push(this._loadSlotCards(e.cards,".footer-left-slot","_leftCards")),t!=null&&t.cards&&r.push(this._loadSlotCards(t.cards,".footer-right-slot","_rightCards")),i&&r.push(this._loadSlotCards(i,".footer-cards-slot","_contentCards")),await Promise.all(r)}async _loadSlotCards(e,t,i){var s;if(!Array.isArray(e)||e.length===0)return;let r=(s=this._element)==null?void 0:s.querySelector(t);if(r)try{let o=await ne(e);this[i]=o;let a=document.createDocumentFragment();o.forEach(c=>{this._hass&&(c.hass=this._hass),a.appendChild(c)}),r.appendChild(a)}catch(o){console.error("[UniversalCard] Failed to load footer cards:",o)}}_updateCards(e){[...this._leftCards,...this._rightCards,...this._contentCards].forEach(i=>{if(i&&"hass"in i)try{i.hass=e}catch(r){}})}_bindEvents(){this._element&&(this._element.querySelectorAll(".footer-action-btn").forEach(e=>{e.addEventListener("click",t=>this._handleActionClick(t))}),(this._config.tap_action||this._config.hold_action)&&(this._element.addEventListener("click",e=>this._handleClick(e)),this._element.addEventListener("mousedown",e=>this._handleMouseDown(e)),this._element.addEventListener("mouseup",()=>this._handleMouseUp()),this._element.addEventListener("mouseleave",()=>this._cancelHold())))}_handleActionClick(e){var s;let t=e.currentTarget,i=parseInt(t.dataset.actionIndex,10),r=(s=this._config.actions)==null?void 0:s[i];r&&X(this._hass,this._element,r)}_handleClick(e){if(!this._isInteractiveElement(e.target)){if(this._isHolding){this._isHolding=!1;return}this._executeAction("tap_action")}}_handleMouseDown(e){e.button===0&&(this._isInteractiveElement(e.target)||(this._holdTimer=setTimeout(()=>{this._isHolding=!0,this._executeAction("hold_action")},500)))}_handleMouseUp(){this._holdTimer&&(clearTimeout(this._holdTimer),this._holdTimer=null)}_cancelHold(){this._handleMouseUp(),this._isHolding=!1}_isInteractiveElement(e){return e.closest("button, a, input, .footer-action-btn")!==null}_executeAction(e){let t=this._config[e];!t||t.action===F.NONE||X(this._hass,this._element,t)}destroy(){this._cancelHold(),this._leftCards=[],this._rightCards=[],this._contentCards=[],this._element=null}};var Ke=class{constructor(e=[]){this._configs=e,this._element=null,this._hass=null}set hass(e){this._hass=e,this._update()}set configs(e){this._configs=e,this._render()}render(){return this._element=document.createElement("div"),this._element.className="badges-container",this._renderBadges(),this._element}_renderBadges(){this._element&&(this._element.innerHTML=this._configs.map((e,t)=>this._renderBadge(e,t)).join(""))}_renderBadge(e,t){let{type:i="state",entity:r,attribute:s,icon:o,color:a,value:c,label:l,unit:d,min:u,max:m,show_name:p=!1,tap_action:_}=e,b=this._getValue(e),v=a||this._getAutoColor(e);b!=null&&(b=this._formatValue(b,e));let Y=o?`<ha-icon class="badge-icon" icon="${o}"></ha-icon>`:"",be=l?`<span class="badge-label">${l}</span>`:"",J=d?`<span class="badge-unit">${d}</span>`:"",Me=b!=null?`<span class="badge-value">${b}</span>${J}`:"",Wt=this._renderProgress(e,b);return`
      <div class="badge ${_?"clickable":""}" 
           data-badge-index="${t}"
           style="--badge-color: ${v}">
        ${Y}
    ...
    `}destroy(){this._stopAutoplay(),this._track=null,this._indicators=null,super.destroy()}};var Qi={expand:ce,modal:le,fullscreen:de,tabs:Q,carousel:ee};function Je(n,e,t={}){let i=Qi[n];return i?new i(e,t):(console.warn(`[UniversalCard] Unknown mode type: ${n}`),null)}function Ze(){return[ce.getStyles(),le.getStyles(),de.getStyles(),Q.getStyles(),ee.getStyles()].join(`
`)}var er=`
  /* ============================= */
  /* HEADER */
  /* ============================= */
...
`;var Ue=class extends HTMLElement{static getConfigElement(){return document.createElement("universal-card-editor")}static getStubConfig(){return{title:"Universal Card",icon:"mdi:card-outline",body_mode:k.EXPAND,body:{cards:[{type:"markdown",content:"Configure this card in the editor"}]}}}constructor(){super(),h("[UC] constructor() called"),this.attachShadow({mode:"open"}),h("[UC] shadowRoot attached"),this._config={},this._hass=null,this._expanded=!1,this._initialized=!1,this._pendingHass=null,this._header=null,this._footer=null,this._badges=null,this._mode=null,this._tabsMode=null,this._carouselMode=null,this._headerCards=[],this._bodyCards=[],this._tabCards={},this._bodyCardsLoaded=!1,this._helpers=null,this._activeTab=0,this._carouselIndex=0,this._isLoading=!1,this._autoCollapseTimer=null,this._carouselTimer=null,this._boundControlHandler=this._handleExternalControl.bind(this),this._resizeHandler=Z(()=>this._handleResize(),R.RESIZE_DEBOUNCE_MS),this._hassUpdateHandler=Ae(()=>this._updateDynamicContent(),R.UPDATE_THROTTLE_MS),this._intersectionObserver=null,this._debug={initTime:0,renderCount:0,lastRenderTime:0}}connectedCallback(){h("[UC] connectedCallback()"),window.addEventListener(ye.CARD_CONTROL,this._boundControlHandler),window.addEventListener("resize",this._resizeHandler),this._setupIntersectionObserver(),this._header&&this._header.attach(),this._footer&&this._footer.attach&&this._footer.attach(),this._mode&&this._mode.attach&&this._mode.attach(),h("[UC] connectedCallback() done")}disconnectedCallback(){h("[UC] disconnectedCallback()"),window.removeEventListener(ye.CARD_CONTROL,this._boundControlHandler),window.removeEventListener("resize",this._resizeHandler),this._header&&this._header.detach(),this._footer&&this._footer.detach&&this._footer.detach(),this._mode&&this._mode.detach&&this._mode.detach(),this._clearAllTimers(),this._destroyIntersectionObserver(),h("[UC] disconnectedCallback() done")}set hass(e){if(this._hass=e,!this._initialized){this._pendingHass=e;return}this._header&&(this._header.hass=e),this._footer&&(this._footer.hass=e),this._badges&&(this._badges.hass=e),this._tabsMode&&(this._tabsMode.hass=e),this._carouselMode&&(this._carouselMode.hass=e),this._updateChildCardsHass(e),this._hassUpdateHandler()}get hass(){return this._hass}setConfig(e){h("[UC] setConfig() called",e);let t=performance.now();try{this._config=ve.normalize(e),h("[UC] config normalized")}catch(i){throw console.error("[UC] config normalize error:",i),i}this._debug.initTime=performance.now()-t,this._initializeCard()}getConfig(){return W(this._config)}async _initializeCard(){h("[UC] _initializeCard() start");try{h("[UC] getting card helpers..."),this._helpers=await De(),h("[UC] card helpers loaded"),this._restoreState(),h("[UC] state restored"),this._createHeaderComponent(),h("[UC] header created"),this._config.footer&&(this._createFooterComponent(),h("[UC] footer created")),this._createModeInstance(),h("[UC] mode created:",this._config.body_mode),h("[UC] starting render..."),await this._render(),h("[UC] render done"),this._header&&(h("[UC] loading header cards..."),await this._header.loadCards(),h("[UC] header cards loaded")),this._footer&&(h("[UC] loading footer cards..."),await this._footer.loadCards(),h("[UC] footer cards loaded")),this._config.lazy_load?(this._observeForLazyLoad(),h("[UC] lazy load setup")):this._expanded&&(h("[UC] loading body cards..."),await this._loadBodyCards(),h("[UC] body cards loaded")),this._bindEvents(),h("[UC] events bound"),this._initialized=!0,h("[UC] initialization complete!"),this._pendingHass&&(this.hass=this._pendingHass,this._pendingHass=null)}catch(e){console.error("[UC] Initialization failed:",e),this._renderError(e)}}_createHeaderComponent(){let e={...this._config,...this._config.header,title:this._config.title,subtitle:this._config.subtitle,icon:this._config.icon,entity:this._config.entity,show_state:this._config.show_state,show_expand_icon:this._config.show_expand_icon,expand_icon:this._config.expand_icon,body_mode:this._config.body_mode,sticky_header:this._config.sticky_header,badges:this._config.badges,tap_action:this._config.tap_action,hold_action:this._config.hold_action,double_tap_action:this._config.double_tap_action,context_menu:this._config.context_menu};this._header=new Oe(e),this._hass&&(this._header.hass=this._hass)}_createFooterComponent(){this._footer=new Le(this._config.footer),this._hass&&(this._footer.hass=this._hass)}_createModeInstance(){var t;let e=this._config.body_mode||k.EXPAND;if(e===k.NONE){this._mode=null;return}this._mode=Je(e,{...this._config,cards:((t=this._config.body)==null?void 0:t.cards)||[],tabs:this._config.tabs||[]},{hass:this._hass,helpers:this._helpers,shadowRoot:this.shadowRoot,card:this}),this._mode&&this._hass&&(this._mode.hass=this._hass)}_restoreState(){if(this._config.remember_state&&this._config.card_id)try{let e=`uc-state-${this._config.card_id}`,t=localStorage.getItem(e);t!==null?this._expanded=JSON.parse(t):this._expanded=this._config.expanded}catch(e){this._expanded=this._config.expanded}else this._expanded=this._config.expanded}_saveState(){if(this._config.remember_state&&this._config.card_id)try{let e=`uc-state-${this._config.card_id}`;localStorage.setItem(e,JSON.stringify(this._expanded))}catch(e){}}async _render(){let e=performance.now(),t=this._generateStyles(),i=["universal-card"];this._config.theme&&this._config.theme!=="default"&&i.push(`theme-${this._config.theme}`);let r=document.createElement("div");if(r.className=i.join(" "),r.dataset.cardId=this._config.card_id,this._header){this._header.expanded=this._expanded;let o=this._header.render();r.appendChild(o)}let s=this._renderBodyElement();if(s&&r.appendChild(s),this._footer){let o=this._footer.render();r.appendChild(o)}this.shadowRoot.innerHTML=`<style>${t}</style>`,this.shadowRoot.appendChild(r),this._debug.renderCount++,this._debug.lastRenderTime=performance.now()-e}_renderBodyElement(){let e=this._config,t=e.body_mode||"expand";if(t==="none"||t==="modal"||t==="fullscreen")return null;let i=document.createElement("div");if(i.className="body",i.dataset.state=this._expanded?"expanded":"collapsed",i.dataset.mode=t,t==="tabs"){this._tabsMode=new Q(e),this._hass&&(this._tabsMode.hass=this._hass);let o=this._tabsMode.render();return i.appendChild(o),i}if(t==="carousel"){this._carouselMode=new ee(e),this._hass&&(this._carouselMode.hass=this._hass);let o=this._carouselMode.render();return i.appendChild(o),i}let r=document.createElement("div");r.className="body-content";let s=this._getGridStyles();return s&&(r.style.cssText=s),!this._bodyCardsLoaded&&this._expanded&&(r.innerHTML=this._renderSkeleton()),i.appendChild(r),i}_renderSkeleton(){let e=this._config.skeleton_count||E.skeleton_count;return`<div class="skeleton-container">${Array(e).fill(0).map(()=>`
      <div class="skeleton-card">
        <div class="skeleton-line title"></div>
        <div class="skeleton-line text"></div>
        <div class="skeleton-line text short"></div>
    ...
    `}async _loadBodyCards(){var e;if(!(this._bodyCardsLoaded||this._isLoading)){this._isLoading=!0;try{let t=this._config.body_mode||"expand";if(t==="tabs"||t==="carousel"){this._bodyCardsLoaded=!0;return}let i=((e=this._config.body)==null?void 0:e.cards)||[];if(i.length===0){this._bodyCardsLoaded=!0;return}if(this._bodyCards=await ne(i),this._bodyCards.forEach(a=>{this._hass&&(a.hass=this._hass)}),t==="modal"||t==="fullscreen"){this._bodyCardsLoaded=!0;return}let r=this.shadowRoot.querySelector(".body-content");if(!r)return;let s=r.querySelector(".skeleton-container");s&&(s.classList.add("fade-out"),await new Promise(a=>setTimeout(a,200)),s.remove());let o=document.createDocumentFragment();this._bodyCards.forEach((a,c)=>{let l=document.createElement("div");l.className="card-wrapper";let d=i[c];if(d){let u=d.colspan||d.card_options&&d.card_options.colspan,m=d.rowspan||d.card_options&&d.card_options.rowspan;u&&(l.style.gridColumn="span "+u),m&&(l.style.gridRow="span "+m)}l.appendChild(a),o.appendChild(l)}),r.appendChild(o),this._bodyCardsLoaded=!0}finally{this._isLoading=!1}}}_updateChildCardsHass(e){[...this._headerCards,...this._bodyCards,...Object.values(this._tabCards).flat()].forEach(i=>{if(i&&"hass"in i)try{i.hass=e}catch(r){}})}_destroyChildCards(){this._header&&(this._header.destroy(),this._header=null),this._footer&&(this._footer.destroy(),this._footer=null),this._badges&&(this._badges.destroy(),this._badges=null),this._headerCards=[],this._bodyCards=[],this._tabCards={},this._bodyCardsLoaded=!1}_generateStyles(){return`
      /* ============================= */
      /* HOST */
      /* ============================= */
    ...
    `}_renderSidebar(){return`
      <div class="sidebar">
        ${[{id:B.BASIC,icon:"mdi:cog",label:"\u041E\u0441\u043D\u043E\u0432\u043D\u044B\u0435"},{id:B.HEADER,icon:"mdi:page-layout-header",label:"\u0417\u0430\u0433\u043E\u043B\u043E\u0432\u043E\u043A"},{id:B.BODY,icon:"mdi:card-text-outline",label:"\u0421\u043E\u0434\u0435\u0440\u0436\u0438\u043C\u043E\u0435"},{id:B.STYLE,icon:"mdi:palette",label:"\u0421\u0442\u0438\u043B\u044C"},{id:B.FEATURES,icon:"mdi:tune",label:"\u0424\u0443\u043D\u043A\u0446\u0438\u0438"},{id:B.ADVANCED,icon:"mdi:code-tags",label:"\u0420\u0430\u0441\u0448\u0438\u0440\u0435\u043D\u043D\u044B\u0435"}].map(t=>`
      ...
      <div class="section">
        ...
        <div class="field">
          ...
          <input type="text" 
                 id="expand_icon" 
                 name="expand_icon"
                 value="${this._config.expand_icon||E.expand_icon}" 
    ...
    `}_renderBodySection(){var e,t,i;return`
      <div class="section">
          ...
          <div class="field-row">
            <div class="field">
              ...
              <input type="number" 
                     id="grid_columns" 
                     name="grid.columns"
                     value="${((e=this._config.grid)==null?void 0:e.columns)||E.grid_columns}" 
                     min="1" 
                     max="12">
            </div>
            ...
            <div class="field">
              ...
              <input type="text" 
                     id="grid_gap" 
                     name="grid.gap"
                     value="${((t=this._config.grid)==null?void 0:t.gap)||E.grid_gap}" 
                     placeholder="16px">
            </div>
          </div>
        </div>
        ...
        ${this._config.body_mode===k.TABS?this._renderTabsEditor():""}
        ${this._config.body_mode===k.CAROUSEL?this._renderCarouselEditor():""}
      </div>
      ...
      <div class="section">
        ...
        <div class="field">
          ...
          <input type="text" 
                 id="border_radius" 
                 name="border_radius"
                 value="${this._config.border_radius||E.border_radius}" 
                 placeholder="12px">
        </div>
        ...
        <div class="field">
          ...
          <input type="text" 
                 id="padding" 
                 name="padding"
                 value="${this._config.padding||E.padding}" 
                 placeholder="16px">
        </div>
        ...
        <div class="field">
          ...
          <input type="number" 
                 ...
                 value="${this._config.animation_duration||E.animation_duration}" 
                 min="0" 
                 max="2000">
        </div>
      </div>
        ...
        <div class="subsection">
          ...
          <div class="field">
            ...
            <input type="number" 
                   id="skeleton_count" 
                   name="skeleton_count"
                   value="${this._config.skeleton_count||E.skeleton_count}" 
                   min="1" 
                   max="10">
          </div>
        </div>
      ...
      <div class="subsection">
        ...
        <div class="field">
          ...
          <input type="number" 
                 ...
                 value="${this._config.carousel_interval||E.carousel_interval}" 
                 min="1000" 
                 max="60000">
        </div>
      </div>
...
`)}_bindEvents(){this.shadowRoot.querySelectorAll(".sidebar-item").forEach(e=>{e.addEventListener("click",()=>{this._activeSection=e.dataset.section,this._render()})}),this.shadowRoot.querySelectorAll(".toolbar-btn").forEach(e=>{e.addEventListener("click",()=>this._handleToolbarAction(e.dataset.action))}),this.shadowRoot.querySelectorAll("input, select").forEach(e=>{e.addEventListener("change",t=>this._handleInputChange(t))}),this.shadowRoot.querySelectorAll('[data-action="add-header-card"]').forEach(e=>{e.addEventListener("click",()=>this._addCard("header"))}),this.shadowRoot.querySelectorAll('[data-action="add-body-card"]').forEach(e=>{e.addEventListener("click",()=>this._addCard("body"))})}_handleToolbarAction(e){switch(e){case"undo":this._undo();break;case"redo":this._redo();break;case"reset":this._config={type:"custom:universal-card"},this._fireConfigChanged();break}}_handleInputChange(e){let{name:t,value:i,type:r,checked:s}=e.target,o=t.split("."),a=this._config;for(let l=0;l<o.length-1;l++)a[o[l]]||(a[o[l]]={}),a=a[o[l]];let c=o[o.length-1];r==="checkbox"?a[c]=s:r==="number"?a[c]=parseInt(i,10):a[c]=i,this._pushHistory(this._config),this._fireConfigChanged()}_addCard(e){this._config[e]||(this._config[e]={cards:[]}),this._config[e].cards||(this._config[e].cards=[]),this._config[e].cards.push({type:"markdown",content:"\u041D\u043E\u0432\u0430\u044F \u043A\u0430\u0440\u0442\u043E\u0447\u043A\u0430"}),this._pushHistory(this._config),this._fireConfigChanged()}_pushHistory(e){this._historyIndex<this._history.length-1&&(this._history=this._history.slice(0,this._historyIndex+1)),this._history.push(W(e)),this._historyIndex=this._history.length-1,this._history.length>50&&(this._history.shift(),this._historyIndex--)}_undo(){this._historyIndex>0&&(this._historyIndex--,this._config=W(this._history[this._historyIndex]),this._fireConfigChanged())}_redo(){this._historyIndex<this._history.length-1&&(this._historyIndex++,this._config=W(this._history[this._historyIndex]),this._fireConfigChanged())}_fireConfigChanged(){f(this,"config-changed",{config:this._config}),this._render()}_getStyles(){return`
    ...
    `}destroy(){this.hide()}};var ir={width:120,height:40,hours:24,strokeWidth:2,strokeColor:"var(--primary-color, #03a9f4)",fillColor:"var(--primary-color, #03a9f4)",fillOpacity:.1,showValue:!0,showMinMax:!1,animationDuration:200,position:"top",offset:8},at=class{constructor(e,t={}){this._hass=e,this._config={...ir,...t},this._previewElement=null,this._currentEntityId=null,this._historyCache=new Map,this._hideTimeout=null,this._debouncedShow=Z(this._showPreview.bind(this),150)}set hass(e){this._hass=e}_createPreviewElement(){let e=document.createElement("div");return e.className="uc-entity-preview",e.innerHTML=`
    ...
    `,document.body.appendChild(e),e}attach(e,t){!e||!t||(e.addEventListener("mouseenter",i=>{this._currentEntityId=t,this._debouncedShow(e,t)}),e.addEventListener("mouseleave",()=>{this._hidePreview()}),e.addEventListener("mousemove",i=>{this._updatePosition(i)}))}detach(e){var i;if(!e)return;let t=e.cloneNode(!0);return(i=e.parentNode)==null||i.replaceChild(t,e),t}async _showPreview(e,t){var a,c;if(this._currentEntityId!==t)return;this._previewElement||(this._previewElement=this._createPreviewElement());let i=(c=(a=this._hass)==null?void 0:a.states)==null?void 0:c[t];if(!i)return;let r=this._previewElement.querySelector(".uc-preview-name"),s=this._previewElement.querySelector(".uc-preview-value");r.textContent=i.attributes.friendly_name||t,s.textContent=`${i.state} ${i.attributes.unit_of_measurement||""}`;let o=await this._fetchHistory(t);o&&o.length>0&&this._currentEntityId===t&&(this._renderSparkline(o),this._config.showMinMax&&this._renderStats(o)),this._positionPreview(e),this._previewElement.classList.add("visible")}_hidePreview(){this._currentEntityId=null,this._hideTimeout&&clearTimeout(this._hideTimeout),this._hideTimeout=setTimeout(()=>{this._previewElement&&this._previewElement.classList.remove("visible")},100)}async _fetchHistory(e){let t=this._historyCache.get(e);if(t&&Date.now()-t.timestamp<6e4)return t.data;try{let i=new Date,r=new Date(i.getTime()-this._config.hours*60*60*1e3),s=await this._hass.callApi("GET",`history/period/${r.toISOString()}?filter_entity_id=${e}&end_time=${i.toISOString()}&minimal_response&no_attributes`);if(s&&s[0]){let o=s[0].map(a=>({time:new Date(a.last_changed),value:parseFloat(a.state)})).filter(a=>!isNaN(a.value));return this._historyCache.set(e,{data:o,timestamp:Date.now()}),o}}catch(i){console.warn(`[EntityPreview] Failed to fetch history for ${e}:`,i)}return[]}_renderSparkline(e){let t=this._previewElement.querySelector(".uc-preview-sparkline");if(!t||e.length<2)return;let{width:i,height:r,strokeWidth:s,strokeColor:o,fillColor:a,fillOpacity:c}=this._config,l=e.map(J=>J.value),d=Math.min(...l),m=Math.max(...l)-d||1,p=s,_=i-p*2,b=r-p*2,v=e.map((J,Me)=>{let Wt=p+Me/(e.length-1)*_,di=p+b-(J.value-d)/m*b;return{x:Wt,y:di}}),Y=v.map((J,Me)=>Me===0?`M ${J.x} ${J.y}`:`L ${J.x} ${J.y}`).join(" "),be=`${Y} L ${v[v.length-1].x} ${r-p} L ${p} ${r-p} Z`;t.setAttribute("width",i),t.setAttribute("height",r),t.innerHTML=`
      ...
      <path d="${be}" fill="url(#sparkline-gradient)" />
      <path d="${Y}" fill="none" stroke="${o}" stroke-width="${s}" 
            stroke-linecap="round" stroke-linejoin="round" />
      <circle cx="${v[v.length-1].x}" cy="${v[v.length-1].y}" 
              r="3" fill="${o}" />
    ...
    `}};var ue={INFO:"info",WARNING:"warning",ERROR:"error",SUCCESS:"success",CRITICAL:"critical"},K={ABOVE:"above",BELOW:"below",EQUALS:"equals",NOT_EQUALS:"not_equals",BETWEEN:"between",OUTSIDE:"outside",CHANGED:"changed",UNAVAILABLE:"unavailable"},xe={BADGE:"badge",BORDER:"border",PULSE:"pulse",SHAKE:"shake",NOTIFICATION:"notification",SOUND:"sound",SERVICE:"service"},rr={debounce_time:1e3,history_size:10,auto_dismiss:5e3,sounds:{info:"/local/sounds/info.mp3",warning:"/local/sounds/warning.mp3",error:"/local/sounds/error.mp3",critical:"/local/sounds/critical.mp3"}},nt=class{constructor(e,t={}){this._hass=e,this._config={...rr,...t},this._alerts=new Map,this._history=[],this._lastTriggerTime=new Map,this._entityStates=new Map,this._container=null,this._callbacks=new Set}set hass(e){let t=this._hass;this._hass=e,this._checkAlerts(t)}register(e,t){var r,s;let i={id:e,entity_id:t.entity_id,condition:t.condition||K.ABOVE,value:t.value,value_min:t.value_min,value_max:t.value_max,type:t.type||ue.WARNING,message:t.message,actions:t.actions||[xe.BADGE],service:t.service,service_data:t.service_data,enabled:t.enabled!==!1,triggered:!1};return this._alerts.set(e,i),(s=(r=this._hass)==null?void 0:r.states)!=null&&s[i.entity_id]&&this._entityStates.set(i.entity_id,this._hass.states[i.entity_id].state),e}unregister(e){this._alerts.delete(e),this._lastTriggerTime.delete(e)}setEnabled(e,t){let i=this._alerts.get(e);i&&(i.enabled=t,t||(i.triggered=!1))}_checkAlerts(e){var t,i;if(this._hass)for(let[r,s]of this._alerts){if(!s.enabled)continue;let o=s.entity_id,a=(t=this._hass.states)==null?void 0:t[o],c=(i=e==null?void 0:e.states)==null?void 0:i[o];if(!a)continue;let l=this._evaluateCondition(s,a,c);l&&!s.triggered?this._triggerAlert(s,a):!l&&s.triggered&&this._clearAlert(s)}}_evaluateCondition(e,t,i){let r=t.state,s=parseFloat(r),{condition:o,value:a,value_min:c,value_max:l}=e;switch(o){case K.ABOVE:return!isNaN(s)&&s>a;case K.BELOW:return!isNaN(s)&&s<a;case K.EQUALS:return r===String(a)||s===a;case K.NOT_EQUALS:return r!==String(a)&&s!==a;case K.BETWEEN:return!isNaN(s)&&s>=c&&s<=l;case K.OUTSIDE:return!isNaN(s)&&(s<c||s>l);case K.CHANGED:return i&&i.state!==r;case K.UNAVAILABLE:return r==="unavailable"||r==="unknown";default:return!1}}_triggerAlert(e,t){let i=this._lastTriggerTime.get(e.id),r=Date.now();if(!(i&&r-i<this._config.debounce_time)){e.triggered=!0,this._lastTriggerTime.set(e.id,r),this._addToHistory(e,t);for(let s of e.actions)this._executeAction(s,e,t);this._notifyCallbacks("triggered",e,t)}}_clearAlert(e){e.triggered=!1,this._notifyCallbacks("cleared",e)}_executeAction(e,t,i){switch(e){case xe.NOTIFICATION:this._showNotification(t,i);break;case xe.SOUND:this._playSound(t.type);break;case xe.SERVICE:this._callService(t);break;default:break}}_showNotification(e,t){var s;let i=this._formatMessage(e.message,t);this._container||(this._container=document.createElement("div"),this._container.className="uc-alerts-container",document.body.appendChild(this._container));let r=document.createElement("div");r.className=`uc-alert-notification uc-alert-${e.type}`,r.innerHTML=`
    ...
    `}};var y={ENTRANCE:"entrance",EXIT:"exit",ATTENTION:"attention",STATE:"state",LOADING:"loading",CONTINUOUS:"continuous"},he={fadeIn:{category:y.ENTRANCE,keyframes:`
      @keyframes uc-fadeIn {
        from { opacity: 0; }
        to { opacity: 1; }
      }
    ...
    `,animation:"uc-wave 2.5s infinite",description:"\u041C\u0430\u0448\u0443\u0449\u0430\u044F \u0440\u0443\u043A\u0430"}},ut=class{constructor(){this._injectedStyles=new Set}getPreset(e){return he[e]||null}getByCategory(e){let t={};for(let[i,r]of Object.entries(he))r.category===e&&(t[i]=r);return t}apply(e,t,i={}){let r=he[t];if(!r){console.warn(`[AnimationPresets] Unknown preset: ${t}`);return}this._injectKeyframes(t,r.keyframes);let s=r.animation;i.duration&&(s=s.replace(/\d+\.?\d*s/,`${i.duration}s`)),i.delay&&(s+=` ${i.delay}s`),i.iterations&&(s=s.replace(/infinite|1/,String(i.iterations))),e.style.animation=s,i.onComplete&&e.addEventListener("animationend",i.onComplete,{once:!0}),i.removeOnComplete!==!1&&e.addEventListener("animationend",()=>{e.style.animation=""},{once:!0})}stagger(e,t,i={}){let r=i.staggerDelay||.05,s=i.startDelay||0;Array.from(e).forEach((o,a)=>{this.apply(o,t,{...i,delay:s+a*r})})}_injectKeyframes(e,t){if(this._injectedStyles.has(e))return;let i=document.createElement("style");i.textContent=t,i.setAttribute("data-uc-animation",e),document.head.appendChild(i),this._injectedStyles.add(e)}static getAllStyles(){let e=[];for(let[t,i]of Object.entries(he))e.push(i.keyframes),e.push(`
        .uc-animate-${t} {
...
`)}static getPresetNames(){return Object.keys(he)}static getDescription(e){var t;return((t=he[e])==null?void 0:t.description)||""}};var pe={IMMEDIATE:"immediate",THROTTLED:"throttled",BATCHED:"batched",ON_DEMAND:"on_demand",VISIBLE_ONLY:"visible_only"},re={CRITICAL:0,HIGH:1,NORMAL:2,LOW:3,BACKGROUND:4},or={strategy:pe.THROTTLED,throttleMs:100,batchDelayMs:50,maxBatchSize:50,visibilityThreshold:.1,priorityThrottles:{[re.CRITICAL]:0,[re.HIGH]:50,[re.NORMAL]:100,[re.LOW]:250,[re.BACKGROUND]:500}},ze=class{constructor(){this._config={...or},this._subscribers=new Map,this._pendingUpdates=new Map,this._batchTimeout=null,this._lastUpdateTime=new Map,this._visibilityObserver=null,this._visibleElements=new WeakSet,this._metrics={totalUpdates:0,throttledUpdates:0,batchedUpdates:0,skippedUpdates:0}}configure(e){this._config={...this._config,...e}}subscribe(e,t,i={}){let r={callback:t,priority:i.priority!=null?i.priority:re.NORMAL,element:i.element,strategy:i.strategy!=null?i.strategy:this._config.strategy};return this._subscribers.has(e)||this._subscribers.set(e,new Set),this._subscribers.get(e).add(r),i.element&&r.strategy===pe.VISIBLE_ONLY&&this._observeVisibility(i.element),()=>{this._unsubscribe(e,r)}}_unsubscribe(e,t){let i=this._subscribers.get(e);i&&(i.delete(t),i.size===0&&this._subscribers.delete(e)),t.element&&this._unobserveVisibility(t.element)}processHassUpdate(e,t){var r,s;if(!(t!=null&&t.states))return;let i=[];for(let o of this._subscribers.keys()){let a=(r=e==null?void 0:e.states)==null?void 0:r[o],c=(s=t==null?void 0:t.states)==null?void 0:s[o];this._hasStateChanged(a,c)&&i.push({entityId:o,newState:c})}if(i.length!==0)switch(this._config.strategy){case pe.IMMEDIATE:this._processImmediate(i);break;case pe.THROTTLED:this._processThrottled(i);break;case pe.BATCHED:this._processBatched(i);break;default:this._processThrottled(i)}}_hasStateChanged(e,t){return!e&&t||e&&!t?!0:!e&&!t?!1:e.state!==t.state||e.last_changed!==t.last_changed}_processImmediate(e){for(let{entityId:t,newState:i}of e)this._notifySubscribers(t,i);this._metrics.totalUpdates+=e.length}_processThrottled(e){let t=Date.now();for(let{entityId:i,newState:r}of e){let s=this._subscribers.get(i);if(!s)continue;let o=re.BACKGROUND;for(let l of s)l.priority<o&&(o=l.priority);let a=this._config.priorityThrottles[o]!=null?this._config.priorityThrottles[o]:this._config.throttleMs,c=this._lastUpdateTime.get(i)||0;t-c>=a?(this._notifySubscribers(i,r),this._lastUpdateTime.set(i,t),this._metrics.totalUpdates++):(this._pendingUpdates.set(i,r),this._scheduleDeferredUpdate(i,a-(t-c)),this._metrics.throttledUpdates++)}}_processBatched(e){for(let{entityId:t,newState:i}of e)this._pendingUpdates.set(t,i);this._metrics.batchedUpdates+=e.length,this._batchTimeout||(this._batchTimeout=setTimeout(()=>{this._processBatch()},this._config.batchDelayMs))}_processBatch(){this._batchTimeout=null;let e=Array.from(this._pendingUpdates.entries()).slice(0,this._config.maxBatchSize);requestAnimationFrame(()=>{for(let[t,i]of e)this._notifySubscribers(t,i),this._pendingUpdates.delete(t);this._metrics.totalUpdates+=e.length}),this._pendingUpdates.size>0&&(this._batchTimeout=setTimeout(()=>{this._processBatch()},this._config.batchDelayMs))}_scheduleDeferredUpdate(e,t){setTimeout(()=>{let i=this._pendingUpdates.get(e);i&&(this._notifySubscribers(e,i),this._pendingUpdates.delete(e),this._lastUpdateTime.set(e,Date.now()))},t)}_notifySubscribers(e,t){let i=this._subscribers.get(e);if(i)for(let r of i){if(r.strategy===pe.VISIBLE_ONLY&&r.element&&!this._visibleElements.has(r.element)){this._metrics.skippedUpdates++;continue}try{r.callback(t)}catch(s){console.error(`[WebSocketOptimizer] Callback error for ${e}:`,s)}}}_observeVisibility(e){this._visibilityObserver||(this._visibilityObserver=new IntersectionObserver(t=>{for(let i of t)i.isIntersecting?this._visibleElements.add(i.target):this._visibleElements.delete(i.target)},{threshold:this._config.visibilityThreshold})),this._visibilityObserver.observe(e)}_unobserveVisibility(e){this._visibilityObserver&&this._visibilityObserver.unobserve(e),this._visibleElements.delete(e)}forceUpdate(e,t){this._notifySubscribers(e,t),this._lastUpdateTime.set(e,Date.now())}flush(){this._batchTimeout&&(clearTimeout(this._batchTimeout),this._batchTimeout=null);for(let[e,t]of this._pendingUpdates)this._notifySubscribers(e,t);this._pendingUpdates.clear()}getMetrics(){return{...this._metrics,activeSubscriptions:this._subscribers.size,pendingUpdates:this._pendingUpdates.size,efficiency:this._metrics.totalUpdates>0?((this._metrics.totalUpdates-this._metrics.throttledUpdates)/this._metrics.totalUpdates*100).toFixed(1)+"%":"100%"}}resetMetrics(){this._metrics={totalUpdates:0,throttledUpdates:0,batchedUpdates:0,skippedUpdates:0}}destroy(){this.flush(),this._subscribers.clear(),this._lastUpdateTime.clear(),this._visibilityObserver&&(this._visibilityObserver.disconnect(),this._visibilityObserver=null)}},ii=null;function Ii(){return ii||(ii=new ze),ii}function Ni(n,e=100){return Ae(n,e)}function Ri(n,e=100){return Z(n,e)}var H={STATE_CHANGE:"uc-link-state-change",EXPAND:"uc-link-expand",COLLAPSE:"uc-link-collapse",TOGGLE:"uc-link-toggle",TAB_CHANGE:"uc-link-tab-change",CUSTOM:"uc-link-custom"},Ne={MIRROR:"mirror",EXPAND_ONLY:"expand_only",COLLAPSE_ONLY:"collapse_only",INVERSE:"inverse",CUSTOM:"custom"},si=class{constructor(){this._groups=new Map,this._masters=new Map,this._slaves=new Map,this._listeners=new Map}register(e,t,i={}){let{role:r="slave",syncMode:s=Ne.MIRROR}=i;this._groups.has(e)||(this._groups.set(e,new Set),this._slaves.set(e,new Set)),this._groups.get(e).add(t),r==="master"?(this._masters.set(e,t),this._setupMasterListeners(e,t)):(this._slaves.get(e).add(t),this._setupSlaveListeners(e,t,s)),t._ucLinkData={groupId:e,role:r,syncMode:s}}unregister(e,t){let i=this._groups.get(e);i&&(i.delete(t),i.size===0&&(this._groups.delete(e),this._masters.delete(e),this._slaves.delete(e))),this._removeListeners(t),delete t._ucLinkData}_setupMasterListeners(e,t){let i=new Map,r=l=>{this._broadcastToSlaves(e,H.STATE_CHANGE,l.detail)},s=()=>{this._broadcastToSlaves(e,H.EXPAND,{})},o=()=>{this._broadcastToSlaves(e,H.COLLAPSE,{})},a=l=>{this._broadcastToSlaves(e,H.TOGGLE,l.detail)},c=l=>{this._broadcastToSlaves(e,H.TAB_CHANGE,l.detail)};t.addEventListener("uc-state-changed",r),t.addEventListener("uc-expanded",s),t.addEventListener("uc-collapsed",o),t.addEventListener("uc-toggled",a),t.addEventListener("uc-tab-changed",c),i.set("uc-state-changed",r),i.set("uc-expanded",s),i.set("uc-collapsed",o),i.set("uc-toggled",a),i.set("uc-tab-changed",c),this._listeners.set(t,i)}_setupSlaveListeners(e,t,i){let r=new Map,s=o=>{let{type:a,detail:c}=o;o.target!==t&&this._applySyncAction(t,a,c,i)};for(let o of Object.values(H)){let a=c=>{var l;((l=c.detail)==null?void 0:l.groupId)===e&&s({type:o,detail:c.detail})};window.addEventListener(o,a),r.set(o,a)}this._listeners.set(t,r)}_removeListeners(e){let t=this._listeners.get(e);if(!t)return;let i=e._ucLinkData;if((i==null?void 0:i.role)==="master")for(let[r,s]of t)e.removeEventListener(r,s);else for(let[r,s]of t)window.removeEventListener(r,s);this._listeners.delete(e)}_broadcastToSlaves(e,t,i){f(window,t,{...i,groupId:e})}_applySyncAction(e,t,i,r){var s,o,a,c,l;if(!(r===Ne.EXPAND_ONLY&&t!==H.EXPAND)&&!(r===Ne.COLLAPSE_ONLY&&t!==H.COLLAPSE))switch(t){case H.EXPAND:r===Ne.INVERSE?(s=e._collapse)==null||s.call(e):(o=e._expand)==null||o.call(e);break;case H.COLLAPSE:r===Ne.INVERSE?(a=e._expand)==null||a.call(e):(c=e._collapse)==null||c.call(e);break;case H.TOGGLE:(l=e._toggle)==null||l.call(e);break;case H.TAB_CHANGE:e._setActiveTab&&i.tabIndex!==void 0&&e._setActiveTab(i.tabIndex);break;case H.STATE_CHANGE:e._handleLinkedStateChange&&e._handleLinkedStateChange(i);break}}getGroup(e){return this._groups.get(e)||new Set}getMaster(e){return this._masters.get(e)}getSlaves(e){return this._slaves.get(e)||new Set}hasGroup(e){return this._groups.has(e)}sendToGroup(e,t,i={}){f(window,H.CUSTOM,{groupId:e,eventName:t,data:i})}clear(){for(let[e,t]of this._groups)for(let i of t)this.unregister(e,i)}},ri=null;function ar(){return ri||(ri=new si),ri}var ht=class{constructor(e,t={}){this._card=e,this._config=t,this._registry=ar()}setConfig(e){this._config.group_id&&this._registry.unregister(this._config.group_id,this._card),this._config=e,e.group_id&&this._registry.register(e.group_id,this._card,{role:e.role||"slave",syncMode:e.sync_mode||Ne.MIRROR})}broadcast(e,t={}){this._config.group_id&&this._config.role==="master"&&f(this._card,e,t)}sendCustomEvent(e,t={}){this._config.group_id&&this._registry.sendToGroup(this._config.group_id,e,t)}isMaster(){return this._config.role==="master"}getGroupInfo(){let e=this._config.group_id;return e?{id:e,totalCards:this._registry.getGroup(e).size,hasMaster:!!this._registry.getMaster(e),slavesCount:this._registry.getSlaves(e).size}:null}destroy(){this._config.group_id&&this._registry.unregister(this._config.group_id,this._card)}};var se={DOMAIN:"domain",AREA:"area",DEVICE_CLASS:"device_class",DEVICE:"device",FLOOR:"floor",LABEL:"label",STATE:"state",CUSTOM:"custom"},He={ALPHABETICAL:"alphabetical",COUNT_DESC:"count_desc",COUNT_ASC:"count_asc",PRIORITY:"priority",CUSTOM:"custom"},nr={automation:"mdi:robot",binary_sensor:"mdi:checkbox-marked-circle",button:"mdi:gesture-tap-button",calendar:"mdi:calendar",camera:"mdi:video",climate:"mdi:thermostat",cover:"mdi:window-shutter",device_tracker:"mdi:account",fan:"mdi:fan",group:"mdi:google-circles-communities",input_boolean:"mdi:toggle-switch",input_number:"mdi:ray-vertex",input_select:"mdi:format-list-bulleted",input_text:"mdi:form-textbox",light:"mdi:lightbulb",lock:"mdi:lock",media_player:"mdi:cast",number:"mdi:ray-vertex",person:"mdi:account",scene:"mdi:palette",script:"mdi:script-text",select:"mdi:format-list-bulleted",sensor:"mdi:eye",sun:"mdi:white-balance-sunny",switch:"mdi:flash",timer:"mdi:timer",update:"mdi:package-up",vacuum:"mdi:robot-vacuum",weather:"mdi:weather-cloudy",zone:"mdi:map-marker"},cr={automation:"\u0410\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0437\u0430\u0446\u0438\u0438",binary_sensor:"\u0411\u0438\u043D\u0430\u0440\u043D\u044B\u0435 \u0441\u0435\u043D\u0441\u043E\u0440\u044B",button:"\u041A\u043D\u043E\u043F\u043A\u0438",calendar:"\u041A\u0430\u043B\u0435\u043D\u0434\u0430\u0440\u0438",camera:"\u041A\u0430\u043C\u0435\u0440\u044B",climate:"\u041A\u043B\u0438\u043C\u0430\u0442",cover:"\u0428\u0442\u043E\u0440\u044B/\u0416\u0430\u043B\u044E\u0437\u0438",device_tracker:"\u0422\u0440\u0435\u043A\u0435\u0440\u044B",fan:"\u0412\u0435\u043D\u0442\u0438\u043B\u044F\u0442\u043E\u0440\u044B",group:"\u0413\u0440\u0443\u043F\u043F\u044B",input_boolean:"\u041F\u0435\u0440\u0435\u043A\u043B\u044E\u0447\u0430\u0442\u0435\u043B\u0438",input_number:"\u0427\u0438\u0441\u043B\u0430",input_select:"\u0421\u043F\u0438\u0441\u043A\u0438 \u0432\u044B\u0431\u043E\u0440\u0430",input_text:"\u0422\u0435\u043A\u0441\u0442\u043E\u0432\u044B\u0435 \u043F\u043E\u043B\u044F",light:"\u041E\u0441\u0432\u0435\u0449\u0435\u043D\u0438\u0435",lock:"\u0417\u0430\u043C\u043A\u0438",media_player:"\u041C\u0435\u0434\u0438\u0430\u043F\u043B\u0435\u0435\u0440\u044B",number:"\u0427\u0438\u0441\u043B\u0430",person:"\u041B\u044E\u0434\u0438",scene:"\u0421\u0446\u0435\u043D\u044B",script:"\u0421\u043A\u0440\u0438\u043F\u0442\u044B",select:"\u0421\u043F\u0438\u0441\u043A\u0438 \u0432\u044B\u0431\u043E\u0440\u0430",sensor:"\u0421\u0435\u043D\u0441\u043E\u0440\u044B",sun:"\u0421\u043E\u043B\u043D\u0446\u0435",switch:"\u0412\u044B\u043A\u043B\u044E\u0447\u0430\u0442\u0435\u043B\u0438",timer:"\u0422\u0430\u0439\u043C\u0435\u0440\u044B",update:"\u041E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0438\u044F",vacuum:"\u041F\u044B\u043B\u0435\u0441\u043E\u0441\u044B",weather:"\u041F\u043E\u0433\u043E\u0434\u0430",zone:"\u0417\u043E\u043D\u044B"},Mi={strategy:se.DOMAIN,sort:He.ALPHABETICAL,collapsed_by_default:!1,show_empty_groups:!1,show_counts:!0,max_items_per_group:0,exclude_domains:[],exclude_entities:[],include_entities:[],priority_order:[],custom_groups:{}},pt=class{constructor(e,t={}){this._hass=e,this._config={...Mi,...t},this._cache=null,this._cacheTimestamp=0}set hass(e){this._hass=e,this._invalidateCache()}setConfig(e){this._config={...Mi,...e},this._invalidateCache()}getGroups(e=null){if(this._cache&&Date.now()-this._cacheTimestamp<1e3)return this._cache;let t=this._getFilteredEntities(e),i;switch(this._config.strategy){case se.DOMAIN:i=this._groupByDomain(t);break;case se.AREA:i=this._groupByArea(t);break;case se.DEVICE_CLASS:i=this._groupByDeviceClass(t);break;case se.DEVICE:i=this._groupByDevice(t);break;case se.FLOOR:i=this._groupByFloor(t);break;case se.LABEL:i=this._groupByLabel(t);break;case se.STATE:i=this._groupByState(t);break;case se.CUSTOM:i=this._groupByCustomRules(t);break;default:i=this._groupByDomain(t)}return i=this._sortGroups(i),this._config.max_items_per_group>0&&(i=i.map(r=>({...r,entities:r.entities.slice(0,this._config.max_items_per_group),hasMore:r.entities.length>this._config.max_items_per_group}))),this._cache=i,this._cacheTimestamp=Date.now(),i}_getFilteredEntities(e){var r,s;let t=((r=this._hass)==null?void 0:r.states)||{},i;return e?i=e.filter(o=>t[o]).map(o=>({entity_id:o,...t[o]})):((s=this._config.include_entities)==null?void 0:s.length)>0?i=this._config.include_entities.filter(o=>t[o]).map(o=>({entity_id:o,...t[o]})):i=Object.entries(t).map(([o,a])=>({entity_id:o,...a})),i.filter(o=>{let a=o.entity_id.split(".")[0];return!(this._config.exclude_domains.includes(a)||this._config.exclude_entities.includes(o.entity_id))})}_groupByDomain(e){let t=new Map;for(let i of e){let r=i.entity_id.split(".")[0];t.has(r)||t.set(r,{id:r,name:cr[r]||this._capitalize(r),icon:nr[r]||"mdi:bookmark",entities:[],collapsed:this._config.collapsed_by_default}),t.get(r).entities.push(i)}return Array.from(t.values()).filter(i=>this._config.show_empty_groups||i.entities.length>0)}_groupByArea(e){var o,a,c;let t=new Map,i=((o=this._hass)==null?void 0:o.areas)||{},r=((a=this._hass)==null?void 0:a.entities)||{},s=((c=this._hass)==null?void 0:c.devices)||{};t.set("_no_area",{id:"_no_area",name:"\u0411\u0435\u0437 \u043E\u0431\u043B\u0430\u0441\u0442\u0438",icon:"mdi:help-circle-outline",entities:[],collapsed:this._config.collapsed_by_default});for(let l of e){let d=null,u=r[l.entity_id];if(u!=null&&u.area_id)d=u.area_id;else if(u!=null&&u.device_id){let m=s[u.device_id];m!=null&&m.area_id&&(d=m.area_id)}d&&i[d]?(t.has(d)||t.set(d,{id:d,name:i[d].name,icon:i[d].icon||"mdi:home-floor-0",entities:[],collapsed:this._config.collapsed_by_default}),t.get(d).entities.push(l)):t.get("_no_area").entities.push(l)}return Array.from(t.values()).filter(l=>this._config.show_empty_groups||l.entities.length>0)}_groupByDeviceClass(e){var i;let t=new Map;for(let r of e){let s=((i=r.attributes)==null?void 0:i.device_class)||"_none";t.has(s)||t.set(s,{id:s,name:s==="_none"?"\u0411\u0435\u0437 \u043A\u043B\u0430\u0441\u0441\u0430":this._capitalize(s),icon:this._getDeviceClassIcon(s),entities:[],collapsed:this._config.collapsed_by_default}),t.get(s).entities.push(r)}return Array.from(t.values()).filter(r=>this._config.show_empty_groups||r.entities.length>0)}_groupByDevice(e){var s,o;let t=new Map,i=((s=this._hass)==null?void 0:s.entities)||{},r=((o=this._hass)==null?void 0:o.devices)||{};t.set("_no_device",{id:"_no_device",name:"\u0411\u0435\u0437 \u0443\u0441\u0442\u0440\u043E\u0439\u0441\u0442\u0432\u0430",icon:"mdi:help-circle-outline",entities:[],collapsed:this._config.collapsed_by_default});for(let a of e){let c=i[a.entity_id],l=c==null?void 0:c.device_id;if(l&&r[l]){let d=r[l];t.has(l)||t.set(l,{id:l,name:d.name||d.name_by_user||l,icon:"mdi:devices",manufacturer:d.manufacturer,model:d.model,entities:[],collapsed:this._config.collapsed_by_default}),t.get(l).entities.push(a)}else t.get("_no_device").entities.push(a)}return Array.from(t.values()).filter(a=>this._config.show_empty_groups||a.entities.length>0)}_groupByFloor(e){var a,c,l,d,u;let t=new Map,i=((a=this._hass)==null?void 0:a.areas)||{},r=((c=this._hass)==null?void 0:c.floors)||{},s=((l=this._hass)==null?void 0:l.entities)||{},o=((d=this._hass)==null?void 0:d.devices)||{};t.set("_no_floor",{id:"_no_floor",name:"\u0411\u0435\u0437 \u044D\u0442\u0430\u0436\u0430",icon:"mdi:help-circle-outline",entities:[],collapsed:this._config.collapsed_by_default});for(let m of e){let p=null,_=s[m.entity_id],b=_==null?void 0:_.area_id;if(!b&&(_!=null&&_.device_id)){let v=o[_.device_id];b=v==null?void 0:v.area_id}b&&((u=i[b])!=null&&u.floor_id)&&(p=i[b].floor_id),p&&r[p]?(t.has(p)||t.set(p,{id:p,name:r[p].name,icon:r[p].icon||"mdi:home-floor-0",level:r[p].level,entities:[],collapsed:this._config.collapsed_by_default}),t.get(p).entities.push(m)):t.get("_no_floor").entities.push(m)}return Array.from(t.values()).filter(m=>this._config.show_empty_groups||m.entities.length>0)}_groupByLabel(e){var s,o;let t=new Map,i=((s=this._hass)==null?void 0:s.labels)||{},r=((o=this._hass)==null?void 0:o.entities)||{};t.set("_no_label",{id:"_no_label",name:"\u0411\u0435\u0437 \u043C\u0435\u0442\u043A\u0438",icon:"mdi:label-off-outline",entities:[],collapsed:this._config.collapsed_by_default});for(let a of e){let c=r[a.entity_id],l=(c==null?void 0:c.labels)||[];if(l.length===0)t.get("_no_label").entities.push(a);else for(let d of l){if(!t.has(d)){let u=i[d]||{name:d};t.set(d,{id:d,name:u.name,icon:u.icon||"mdi:label",color:u.color,entities:[],collapsed:this._config.collapsed_by_default})}t.get(d).entities.push(a)}}return Array.from(t.values()).filter(a=>this._config.show_empty_groups||a.entities.length>0)}_groupByState(e){let t=new Map;for(let i of e){let r=i.state;t.has(r)||t.set(r,{id:r,name:this._getStateName(r),icon:this._getStateIcon(r),entities:[],collapsed:this._config.collapsed_by_default}),t.get(r).entities.push(i)}return Array.from(t.values()).filter(i=>this._config.show_empty_groups||i.entities.length>0)}_groupByCustomRules(e){let t=new Map,i=this._config.custom_groups||{};for(let[r,s]of Object.entries(i))t.set(r,{id:r,name:s.name||r,icon:s.icon||"mdi:folder",entities:[],collapsed:s.collapsed!=null?s.collapsed:this._config.collapsed_by_default});t.set("_other",{id:"_other",name:"\u041F\u0440\u043E\u0447\u0435\u0435",icon:"mdi:dots-horizontal",entities:[],collapsed:this._config.collapsed_by_default});for(let r of e){let s=!1;for(let[o,a]of Object.entries(i))if(this._matchesGroupRules(r,a)){t.get(o).entities.push(r),s=!0;break}s||t.get("_other").entities.push(r)}return Array.from(t.values()).filter(r=>this._config.show_empty_groups||r.entities.length>0)}_matchesGroupRules(e,t){var r;let i=t.rules||{};if(i.entity_id&&!new RegExp(i.entity_id.replace(/\*/g,".*")).test(e.entity_id))return!1;if(i.domain){let s=e.entity_id.split(".")[0];if(!(Array.isArray(i.domain)?i.domain:[i.domain]).includes(s))return!1}if(i.state&&!(Array.isArray(i.state)?i.state:[i.state]).includes(e.state))return!1;if(i.attribute){let{name:s,value:o,above:a,below:c}=i.attribute,l=(r=e.attributes)==null?void 0:r[s];if(o!==void 0&&l!==o||a!==void 0&&parseFloat(l)<=a||c!==void 0&&parseFloat(l)>=c)return!1}return!0}_sortGroups(e){switch(this._config.sort){case He.ALPHABETICAL:return e.sort((i,r)=>i.name.localeCompare(r.name));case He.COUNT_DESC:return e.sort((i,r)=>r.entities.length-i.entities.length);case He.COUNT_ASC:return e.sort((i,r)=>i.entities.length-r.entities.length);case He.PRIORITY:let t=this._config.priority_order||[];return e.sort((i,r)=>{let s=t.indexOf(i.id),o=t.indexOf(r.id);return s===-1&&o===-1?0:s===-1?1:o===-1?-1:s-o});default:return e}}_invalidateCache(){this._cache=null,this._cacheTimestamp=0}_capitalize(e){return e.charAt(0).toUpperCase()+e.slice(1).replace(/_/g," ")}_getDeviceClassIcon(e){return{battery:"mdi:battery",carbon_dioxide:"mdi:molecule-co2",carbon_monoxide:"mdi:molecule-co",connectivity:"mdi:connection",current:"mdi:current-ac",door:"mdi:door",energy:"mdi:lightning-bolt",gas:"mdi:gas-cylinder",humidity:"mdi:water-percent",illuminance:"mdi:brightness-5",moisture:"mdi:water",motion:"mdi:motion-sensor",occupancy:"mdi:home-account",power:"mdi:flash",power_factor:"mdi:angle-acute",pressure:"mdi:gauge",problem:"mdi:alert-circle",safety:"mdi:shield-check",smoke:"mdi:smoke-detector",sound:"mdi:volume-high",temperature:"mdi:thermometer",timestamp:"mdi:clock",voltage:"mdi:sine-wave",window:"mdi:window-closed"}[e]||"mdi:bookmark"}_getStateName(e){return{on:"\u0412\u043A\u043B\u044E\u0447\u0435\u043D\u043E",off:"\u0412\u044B\u043A\u043B\u044E\u0447\u0435\u043D\u043E",home:"\u0414\u043E\u043C\u0430",not_home:"\u041D\u0435 \u0434\u043E\u043C\u0430",open:"\u041E\u0442\u043A\u0440\u044B\u0442\u043E",closed:"\u0417\u0430\u043A\u0440\u044B\u0442\u043E",locked:"\u0417\u0430\u0431\u043B\u043E\u043A\u0438\u0440\u043E\u0432\u0430\u043D\u043E",unlocked:"\u0420\u0430\u0437\u0431\u043B\u043E\u043A\u0438\u0440\u043E\u0432\u0430\u043D\u043E",playing:"\u0412\u043E\u0441\u043F\u0440\u043E\u0438\u0437\u0432\u0435\u0434\u0435\u043D\u0438\u0435",paused:"\u041F\u0430\u0443\u0437\u0430",idle:"\u041E\u0436\u0438\u0434\u0430\u043D\u0438\u0435",unavailable:"\u041D\u0435\u0434\u043E\u0441\u0442\u0443\u043F\u043D\u043E",unknown:"\u041D\u0435\u0438\u0437\u0432\u0435\u0441\u0442\u043D\u043E"}[e]||this._capitalize(e)}_getStateIcon(e){return{on:"mdi:check-circle",off:"mdi:close-circle",home:"mdi:home",not_home:"mdi:home-export-outline",open:"mdi:door-open",closed:"mdi:door-closed",locked:"mdi:lock",unlocked:"mdi:lock-open",playing:"mdi:play",paused:"mdi:pause",idle:"mdi:sleep",unavailable:"mdi:alert",unknown:"mdi:help-circle"}[e]||"mdi:circle"}};var w={NONE:"none",REDUCED:"reduced",COMPACT:"compact",MINIMAL:"minimal",ICON_ONLY:"icon_only"},me={MANUAL:"manual",SCREEN_WIDTH:"screen_width",CONTAINER_WIDTH:"container_width",CARD_COUNT:"card_count",AUTO:"auto"},lr={enabled:!0,level:w.NONE,trigger:me.AUTO,breakpoints:{[w.REDUCED]:768,[w.COMPACT]:480,[w.MINIMAL]:320,[w.ICON_ONLY]:200},containerBreakpoints:{[w.REDUCED]:400,[w.COMPACT]:300,[w.MINIMAL]:200,[w.ICON_ONLY]:120},levelSettings:{[w.NONE]:{padding:"16px",gap:"12px",fontSize:"14px",iconSize:"24px",showTitle:!0,showSubtitle:!0,showBadges:!0,showFooter:!0,gridColumns:null},[w.REDUCED]:{padding:"12px",gap:"8px",fontSize:"13px",iconSize:"22px",showTitle:!0,showSubtitle:!0,showBadges:!0,showFooter:!0,gridColumns:null},[w.COMPACT]:{padding:"8px",gap:"6px",fontSize:"12px",iconSize:"20px",showTitle:!0,showSubtitle:!1,showBadges:!0,showFooter:!1,gridColumns:1},[w.MINIMAL]:{padding:"6px",gap:"4px",fontSize:"11px",iconSize:"18px",showTitle:!0,showSubtitle:!1,showBadges:!1,showFooter:!1,gridColumns:1},[w.ICON_ONLY]:{padding:"4px",gap:"2px",fontSize:"10px",iconSize:"16px",showTitle:!1,showSubtitle:!1,showBadges:!1,showFooter:!1,gridColumns:1}}},mt=class{constructor(e,t={}){this._element=e,this._config=this._mergeConfig(lr,t),this._currentLevel=w.NONE,this._resizeObserver=null,this._mediaQueryListeners=[],this._callbacks=new Set,this._init()}_mergeConfig(e,t){let i={...e};for(let r of Object.keys(t))t[r]&&typeof t[r]=="object"&&!Array.isArray(t[r])?i[r]=this._mergeConfig(e[r]||{},t[r]):i[r]=t[r];return i}_init(){if(this._config.enabled){switch(this._config.trigger){case me.SCREEN_WIDTH:case me.AUTO:this._setupMediaQueries();break;case me.CONTAINER_WIDTH:this._setupResizeObserver();break;case me.MANUAL:this.setLevel(this._config.level);break}this._config.trigger===me.AUTO&&this._setupResizeObserver()}}_setupMediaQueries(){let e=this._config.breakpoints,t=Object.entries(e).sort(([,i],[,r])=>i-r);for(let[i,r]of t){let s=window.matchMedia(`(max-width: ${r}px)`),o=a=>{this._evaluateLevel()};s.addEventListener("change",o),this._mediaQueryListeners.push({mql:s,handler:o})}this._evaluateLevel()}_setupResizeObserver(){window.ResizeObserver&&(this._resizeObserver=new ResizeObserver(e=>{for(let t of e)this._handleResize(t.contentRect.width)}),this._resizeObserver.observe(this._element))}_handleResize(e){if(this._config.trigger!==me.CONTAINER_WIDTH&&this._config.trigger!==me.AUTO)return;let t=this._config.containerBreakpoints,i=w.NONE;for(let[r,s]of Object.entries(t))e<=s&&(i=r);this.setLevel(i)}_evaluateLevel(){let e=this._config.breakpoints,t=window.innerWidth,i=w.NONE;for(let[r,s]of Object.entries(e))t<=s&&(i=r);this.setLevel(i)}setLevel(e){if(!Object.values(w).includes(e)){console.warn(`[CompactMode] Unknown level: ${e}`);return}if(e===this._currentLevel)return;let t=this._currentLevel;this._currentLevel=e,this._applyLevel(e),this._notifyCallbacks(e,t)}getLevel(){return this._currentLevel}getCurrentSettings(){return this._config.levelSettings[this._currentLevel]||{}}_applyLevel(e){for(let i of Object.values(w))this._element.classList.remove(`uc-compact-${i}`);this._element.classList.add(`uc-compact-${e}`);let t=this._config.levelSettings[e];t&&(this._element.style.setProperty("--uc-compact-padding",t.padding),this._element.style.setProperty("--uc-compact-gap",t.gap),this._element.style.setProperty("--uc-compact-font-size",t.fontSize),this._element.style.setProperty("--uc-compact-icon-size",t.iconSize)),this._element.dataset.compactLevel=e}toggleNext(){let e=Object.values(w),i=(e.indexOf(this._currentLevel)+1)%e.length;this.setLevel(e[i])}togglePrevious(){let e=Object.values(w),i=(e.indexOf(this._currentLevel)-1+e.length)%e.length;this.setLevel(e[i])}reset(){this.setLevel(w.NONE)}isCompact(){return this._currentLevel!==w.NONE}shouldShow(e){let t=this.getCurrentSettings(),i=`show${e.charAt(0).toUpperCase()+e.slice(1)}`;return t[i]!==!1}getGridColumns(e=2){let t=this.getCurrentSettings();return t.gridColumns!=null?t.gridColumns:e}subscribe(e){return this._callbacks.add(e),()=>this._callbacks.delete(e)}_notifyCallbacks(e,t){for(let i of this._callbacks)try{i(e,t)}catch(r){console.error("[CompactMode] Callback error:",r)}}destroy(){for(let{mql:e,handler:t}of this._mediaQueryListeners)e.removeEventListener("change",t);this._mediaQueryListeners=[],this._resizeObserver&&(this._resizeObserver.disconnect(),this._resizeObserver=null),this._callbacks.clear();for(let e of Object.values(w))this._element.classList.remove(`uc-compact-${e}`);this._element.style.removeProperty("--uc-compact-padding"),this._element.style.removeProperty("--uc-compact-gap"),this._element.style.removeProperty("--uc-compact-font-size"),this._element.style.removeProperty("--uc-compact-icon-size"),delete this._element.dataset.compactLevel}static getStyles(){return`
    ...
    `);for(let[t,i]of Object.entries(ft)){let r=`uc-glass-${t.toLowerCase()}`,s=`rgba(255, 255, 255, ${i.opacity})`,o=`rgba(0, 0, 0, ${i.opacity})`,a=`rgba(255, 255, 255, ${i.borderOpacity})`,c=`rgba(0, 0, 0, ${i.shadowOpacity})`;e.push(`
        .${r} {
          background: ${s};
    ...
    `),e.join(`
`)}};var U={FLAT:"flat",RAISED:"raised",PRESSED:"pressed",INSET:"inset",CONVEX:"convex",CONCAVE:"concave"},fe={SUBTLE:"subtle",LIGHT:"light",MEDIUM:"medium",STRONG:"strong",EXTREME:"extreme"},ai={[fe.SUBTLE]:{distance:3,blur:6,lightOpacity:.5,shadowOpacity:.1},[fe.LIGHT]:{distance:5,blur:10,lightOpacity:.7,shadowOpacity:.15},[fe.MEDIUM]:{distance:8,blur:16,lightOpacity:1,shadowOpacity:.2},[fe.STRONG]:{distance:12,blur:24,lightOpacity:1,shadowOpacity:.3},[fe.EXTREME]:{distance:20,blur:40,lightOpacity:1,shadowOpacity:.4}},gt={LIGHT:{background:"#e0e5ec",lightShadow:"#ffffff",darkShadow:"#a3b1c6",text:"#333333",accent:"#6d5dfc"},DARK:{background:"#2d2d2d",lightShadow:"#3d3d3d",darkShadow:"#1d1d1d",text:"#e0e0e0",accent:"#6d5dfc"},BLUE:{background:"#d6e4f0",lightShadow:"#ffffff",darkShadow:"#a3b8cc",text:"#2c3e50",accent:"#3498db"},GREEN:{background:"#d4e6d4",lightShadow:"#ffffff",darkShadow:"#a3c4a3",text:"#2d4a2d",accent:"#27ae60"},PINK:{background:"#f0d6e4",lightShadow:"#ffffff",darkShadow:"#c4a3b4",text:"#4a2d3d",accent:"#e91e63"},CUSTOM:{background:"var(--neu-background, #e0e5ec)",lightShadow:"var(--neu-light-shadow, #ffffff)",darkShadow:"var(--neu-dark-shadow, #a3b1c6)",text:"var(--neu-text, #333333)",accent:"var(--neu-accent, #6d5dfc)"}},bt=class{constructor(e={}){this._config={type:U.RAISED,intensity:fe.MEDIUM,palette:"LIGHT",lightAngle:145,borderRadius:12,...e}}setType(e){Object.values(U).includes(e)&&(this._config.type=e)}setIntensity(e){Object.values(fe).includes(e)&&(this._config.intensity=e)}setPalette(e){gt[e]&&(this._config.palette=e)}setLightAngle(e){this._config.lightAngle=e%360}getPalette(){return gt[this._config.palette]||gt.LIGHT}_calculateShadowOffset(){let t=this._config.lightAngle*Math.PI/180,i=ai[this._config.intensity],r=i.distance,s=Math.round(-Math.cos(t)*r),o=Math.round(-Math.sin(t)*r),a=Math.round(Math.cos(t)*r),c=Math.round(Math.sin(t)*r);return{lightX:s,lightY:o,darkX:a,darkY:c,blur:i.blur}}generateShadow(e={}){let t={...this._config,...e},i=this.getPalette(),r=ai[t.intensity],s=this._calculateShadowOffset(),o=i.lightShadow,a=i.darkShadow;switch(t.type){case U.FLAT:return"none";case U.RAISED:return`
    ...
    `),e.join(`
`)}};var O={GEOMETRIC:"geometric",DOTS:"dots",LINES:"lines",WAVES:"waves",NOISE:"noise",ORGANIC:"organic"},ke={grid:{category:O.GEOMETRIC,name:"Grid",css:(n="rgba(0,0,0,0.05)",e=20)=>`
      linear-gradient(${n} 1px, transparent 1px),
      linear-gradient(90deg, ${n} 1px, transparent 1px)
    `,size:(n=20)=>`${n}px ${n}px`,description:"\u0421\u0435\u0442\u043A\u0430"},checkerboard:{category:O.GEOMETRIC,name:"Checkerboard",css:(n="rgba(0,0,0,0.05)",e=20)=>`
      linear-gradient(45deg, ${n} 25%, transparent 25%),
      linear-gradient(-45deg, ${n} 25%, transparent 25%),
      linear-gradient(45deg, transparent 75%, ${n} 75%),
      linear-gradient(-45deg, transparent 75%, ${n} 75%)
    `,size:(n=20)=>`${n}px ${n}px`,position:(n=20)=>`0 0, 0 ${n/2}px, ${n/2}px -${n/2}px, -${n/2}px 0px`,description:"\u0428\u0430\u0445\u043C\u0430\u0442\u043D\u0430\u044F \u0434\u043E\u0441\u043A\u0430"},triangles:{category:O.GEOMETRIC,name:"Triangles",css:(n="rgba(0,0,0,0.05)",e=40)=>`
      ...
      linear-gradient(45deg, ${n} 25%, transparent 25%)
    `,size:(n=40)=>`${n}px ${n}px`,description:"\u0422\u0440\u0435\u0443\u0433\u043E\u043B\u044C\u043D\u0438\u043A\u0438"},hexagons:{category:O.GEOMETRIC,name:"Hexagons",svg:(n="#00000010",e=30)=>`
    ...
    `,description:"\u0428\u0435\u0441\u0442\u0438\u0443\u0433\u043E\u043B\u044C\u043D\u0438\u043A\u0438"},diamonds:{category:O.GEOMETRIC,name:"Diamonds",css:(n="rgba(0,0,0,0.05)",e=20)=>`
      ...
      linear-gradient(45deg, ${n} 25%, transparent 25%),
      linear-gradient(315deg, ${n} 25%, transparent 25%)
    `,size:(n=20)=>`${n}px ${n}px`,position:(n=20)=>`${n/2}px 0, ${n/2}px 0, 0 0, 0 0`,description:"\u0420\u043E\u043C\u0431\u044B"},dots:{category:O.DOTS,name:"Dots",css:(n="rgba(0,0,0,0.1)",e=20)=>`
      radial-gradient(${n} 2px, transparent 2px)
    `,size:(n=20)=>`${n}px ${n}px`,description:"\u0422\u043E\u0447\u043A\u0438"},dotsLarge:{category:O.DOTS,name:"Dots Large",css:(n="rgba(0,0,0,0.08)",e=30)=>`
      radial-gradient(${n} 4px, transparent 4px)
    `,size:(n=30)=>`${n}px ${n}px`,description:"\u041A\u0440\u0443\u043F\u043D\u044B\u0435 \u0442\u043E\u0447\u043A\u0438"},dotsGradient:{category:O.DOTS,name:"Dots Gradient",css:(n="rgba(0,0,0,0.1)",e=20)=>`
      radial-gradient(circle at center, ${n}, transparent 50%)
    `,size:(n=20)=>`${n}px ${n}px`,description:"\u0422\u043E\u0447\u043A\u0438 \u0441 \u0433\u0440\u0430\u0434\u0438\u0435\u043D\u0442\u043E\u043C"},horizontalLines:{category:O.LINES,name:"Horizontal Lines",css:(n="rgba(0,0,0,0.05)",e=10)=>`
      linear-gradient(${n} 1px, transparent 1px)
    `,size:(n=10)=>`100% ${n}px`,description:"\u0413\u043E\u0440\u0438\u0437\u043E\u043D\u0442\u0430\u043B\u044C\u043D\u044B\u0435 \u043B\u0438\u043D\u0438\u0438"},verticalLines:{category:O.LINES,name:"Vertical Lines",css:(n="rgba(0,0,0,0.05)",e=10)=>`
      linear-gradient(90deg, ${n} 1px, transparent 1px)
    `,size:(n=10)=>`${n}px 100%`,description:"\u0412\u0435\u0440\u0442\u0438\u043A\u0430\u043B\u044C\u043D\u044B\u0435 \u043B\u0438\u043D\u0438\u0438"},diagonalLines:{category:O.LINES,name:"Diagonal Lines",css:(n="rgba(0,0,0,0.05)",e=10)=>`
      repeating-linear-gradient(
        45deg,
        transparent,
        transparent ${e}px,
    ...
    `,description:"\u0412\u043E\u043B\u043D\u044B"},zigzag:{category:O.WAVES,name:"Zigzag",css:(n="rgba(0,0,0,0.05)",e=20)=>`
      linear-gradient(135deg, ${n} 25%, transparent 25%),
      linear-gradient(225deg, ${n} 25%, transparent 25%)
    `,size:(n=20)=>`${n}px ${n}px`,position:()=>"0 0, 10px 0",description:"\u0417\u0438\u0433\u0437\u0430\u0433"},noise:{category:O.NOISE,name:"Noise",svg:()=>`
    ...
    `),e.join(`
`)}};var te={GRADIENT:"gradient",GLOW:"glow",PULSE:"pulse",RAINBOW:"rainbow",DASH:"dash",WAVE:"wave",NEON:"neon",SHIMMER:"shimmer"},vt={PRIMARY:["var(--primary-color)","var(--accent-color, #6366f1)"],RAINBOW:["#ff0000","#ff7f00","#ffff00","#00ff00","#0000ff","#8b00ff","#ff0000"],SUNSET:["#ff6b6b","#feca57","#ff9ff3"],OCEAN:["#0077be","#00a5cf","#00d4aa"],FIRE:["#ff4500","#ff6b00","#ffd700"],PURPLE:["#667eea","#764ba2"],CYAN:["#00d2ff","#3a7bd5"],EMERALD:["#11998e","#38ef7d"]},dr={type:te.GRADIENT,width:2,radius:12,duration:3,colors:vt.PRIMARY,glowSize:10,glowOpacity:.5},xt=class{constructor(e={}){this._config={...dr,...e},this._styleElement=null,this._animationId=`uc-border-${Math.random().toString(36).substr(2,9)}`}setType(e){Object.values(te).includes(e)&&(this._config.type=e)}setColors(e){this._config.colors=e}setGradientPreset(e){vt[e]&&(this._config.colors=vt[e])}generateStyles(){let{type:e,width:t,radius:i,colors:r,glowSize:s,glowOpacity:o}=this._config;switch(e){case te.GRADIENT:return this._generateGradientStyles();case te.GLOW:return this._generateGlowStyles();case te.PULSE:return this._generatePulseStyles();case te.RAINBOW:return this._generateRainbowStyles();case te.DASH:return this._generateDashStyles();case te.WAVE:return this._generateWaveStyles();case te.NEON:return this._generateNeonStyles();case te.SHIMMER:return this._generateShimmerStyles();default:return{}}}_generateGradientStyles(){let{width:e,radius:t,colors:i,duration:r}=this._config,s=`linear-gradient(90deg, ${i.join(", ")})`;return{position:"relative",borderRadius:`${t}px`,padding:`${e}px`,background:s,backgroundSize:"200% 200%",animation:`${this._animationId}-gradient ${r}s ease infinite`,keyframes:`
      ...
      `}}_generateRainbowStyles(){let{width:e,radius:t,duration:i}=this._config,r=vt.RAINBOW;return{position:"relative",borderRadius:`${t}px`,padding:`${e}px`,background:`linear-gradient(90deg, ${r.join(", ")})`,backgroundSize:"400% 400%",animation:`${this._animationId}-rainbow ${i}s linear infinite`,keyframes:`
...
`)}};var _e={light:{name:"Light",type:"light",colors:{background:"#ffffff",surface:"#f5f5f5",primary:"#6366f1",secondary:"#8b5cf6",accent:"#06b6d4",text:"#1f2937",textSecondary:"#6b7280",border:"#e5e7eb",success:"#10b981",warning:"#f59e0b",error:"#ef4444",info:"#3b82f6"}},paper:{name:"Paper",type:"light",colors:{background:"#faf8f5",surface:"#f5f2ed",primary:"#8b7355",secondary:"#a67c52",accent:"#c49a6c",text:"#3d3d3d",textSecondary:"#6b6b6b",border:"#e0dcd5",success:"#5d8a66",warning:"#c9a227",error:"#b54040",info:"#5a7fa6"}},cream:{name:"Cream",type:"light",colors:{background:"#fffdf7",surface:"#fff9e6",primary:"#d4a574",secondary:"#c49570",accent:"#e6c88a",text:"#4a4540",textSecondary:"#7d7267",border:"#ece4d4",success:"#7db47d",warning:"#e0b050",error:"#d47070",info:"#70a0c0"}},dark:{name:"Dark",type:"dark",colors:{background:"#1a1a2e",surface:"#16213e",primary:"#6366f1",secondary:"#8b5cf6",accent:"#06b6d4",text:"#f1f5f9",textSecondary:"#94a3b8",border:"#334155",success:"#10b981",warning:"#f59e0b",error:"#ef4444",info:"#3b82f6"}},midnight:{name:"Midnight",type:"dark",colors:{background:"#0f0f1a",surface:"#1a1a2e",primary:"#818cf8",secondary:"#a78bfa",accent:"#22d3ee",text:"#e2e8f0",textSecondary:"#94a3b8",border:"#2d2d44",success:"#34d399",warning:"#fbbf24",error:"#f87171",info:"#60a5fa"}},amoled:{name:"AMOLED",type:"dark",colors:{background:"#000000",surface:"#0a0a0a",primary:"#6366f1",secondary:"#8b5cf6",accent:"#06b6d4",text:"#ffffff",textSecondary:"#a1a1aa",border:"#27272a",success:"#22c55e",warning:"#eab308",error:"#ef4444",info:"#3b82f6"}},ocean:{name:"Ocean",type:"dark",colors:{background:"#0c1929",surface:"#132f4c",primary:"#00a9ff",secondary:"#0091ea",accent:"#00e5ff",text:"#e3f2fd",textSecondary:"#90caf9",border:"#1e4976",success:"#4caf50",warning:"#ffc107",error:"#ff5252",info:"#29b6f6"}},forest:{name:"Forest",type:"dark",colors:{background:"#1a2f1a",surface:"#2d4a2d",primary:"#4caf50",secondary:"#66bb6a",accent:"#a5d6a7",text:"#e8f5e9",textSecondary:"#a5d6a7",border:"#3d6b3d",success:"#81c784",warning:"#ffd54f",error:"#ef5350",info:"#4fc3f7"}},sunset:{name:"Sunset",type:"dark",colors:{background:"#2d1f2f",surface:"#4a2d4a",primary:"#ff6b6b",secondary:"#feca57",accent:"#ff9ff3",text:"#fff5f5",textSecondary:"#ffb8b8",border:"#5c3a5c",success:"#7bed9f",warning:"#ffeaa7",error:"#ff6b6b",info:"#74b9ff"}},lavender:{name:"Lavender",type:"light",colors:{background:"#f5f0ff",surface:"#ede4ff",primary:"#7c3aed",secondary:"#8b5cf6",accent:"#c4b5fd",text:"#3b0764",textSecondary:"#6b21a8",border:"#d8b4fe",success:"#22c55e",warning:"#f59e0b",error:"#ef4444",info:"#6366f1"}},rose:{name:"Rose",type:"light",colors:{background:"#fff5f7",surface:"#ffe4e6",primary:"#f43f5e",secondary:"#fb7185",accent:"#fda4af",text:"#4c0519",textSecondary:"#881337",border:"#fecdd3",success:"#10b981",warning:"#f59e0b",error:"#e11d48",info:"#3b82f6"}},neon:{name:"Neon",type:"dark",colors:{background:"#0a0a0a",surface:"#141414",primary:"#00ff88",secondary:"#ff00ff",accent:"#00ffff",text:"#ffffff",textSecondary:"#888888",border:"#333333",success:"#00ff88",warning:"#ffff00",error:"#ff0055",info:"#00ffff"}},cyberpunk:{name:"Cyberpunk",type:"dark",colors:{background:"#0d0221",surface:"#1a0a3e",primary:"#ff00ff",secondary:"#00ffff",accent:"#ffff00",text:"#ffffff",textSecondary:"#b794f6",border:"#3d1a78",success:"#00ff88",warning:"#ffff00",error:"#ff0055",info:"#00ffff"}},terminal:{name:"Terminal",type:"dark",colors:{background:"#0c0c0c",surface:"#1a1a1a",primary:"#00ff00",secondary:"#00cc00",accent:"#88ff88",text:"#00ff00",textSecondary:"#00aa00",border:"#004400",success:"#00ff00",warning:"#ffff00",error:"#ff0000",info:"#00ffff"}},sepia:{name:"Sepia",type:"light",colors:{background:"#f4ecd8",surface:"#e8dcc8",primary:"#8b4513",secondary:"#a0522d",accent:"#cd853f",text:"#3e2723",textSecondary:"#5d4037",border:"#d7cbb9",success:"#558b2f",warning:"#f9a825",error:"#c62828",info:"#0277bd"}}},Et=class{constructor(e={}){this._config={scheme:"light",customColors:{},...e}}setScheme(e){_e[e]&&(this._config.scheme=e)}getScheme(){let e=_e[this._config.scheme]||_e.light;return{...e,colors:{...e.colors,...this._config.customColors}}}getColor(e){return this.getScheme().colors[e]||e}setCustomColor(e,t){this._config.customColors[e]=t}generateCSSVariables(){let e=this.getScheme(),t={};for(let[i,r]of Object.entries(e.colors)){t[`--uc-${this._kebabCase(i)}`]=r;let s=this._hexToRgb(r);s&&(t[`--uc-${this._kebabCase(i)}-rgb`]=`${s.r}, ${s.g}, ${s.b}`)}return t}apply(e){let t=this.generateCSSVariables();for(let[i,r]of Object.entries(t))e.style.setProperty(i,r);e.dataset.colorScheme=this._config.scheme,e.classList.add("uc-color-scheme")}remove(e){let t=this.getScheme();for(let i of Object.keys(t.colors))e.style.removeProperty(`--uc-${this._kebabCase(i)}`),e.style.removeProperty(`--uc-${this._kebabCase(i)}-rgb`);delete e.dataset.colorScheme,e.classList.remove("uc-color-scheme")}_kebabCase(e){return e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase()}_hexToRgb(e){if(!e.startsWith("#"))return null;let t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e);return t?{r:parseInt(t[1],16),g:parseInt(t[2],16),b:parseInt(t[3],16)}:null}static getSchemeNames(){return Object.keys(_e)}static getSchemesByType(e){let t={};for(let[i,r]of Object.entries(_e))r.type===e&&(t[i]=r);return t}static getStyles(){let e=[];for(let[t,i]of Object.entries(_e)){let r=Object.entries(i.colors).map(([s,o])=>`--uc-${s.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase()}: ${o}`).join(`;
    ...
    `),e.join(`
`)}};var G={SPINNER:"spinner",DOTS:"dots",BARS:"bars",PULSE:"pulse",SKELETON:"skeleton",WAVE:"wave",RING:"ring",BOUNCE:"bounce",PROGRESS:"progress",SHIMMER:"shimmer"},Se={XS:"xs",SM:"sm",MD:"md",LG:"lg",XL:"xl"},Ee={[Se.XS]:{size:16,stroke:2,dotSize:4},[Se.SM]:{size:24,stroke:2.5,dotSize:6},[Se.MD]:{size:32,stroke:3,dotSize:8},[Se.LG]:{size:48,stroke:4,dotSize:10},[Se.XL]:{size:64,stroke:5,dotSize:12}},St=class{constructor(e={}){this._config={type:G.SPINNER,size:Se.MD,color:"var(--primary-color, #6366f1)",secondaryColor:"var(--primary-color-light, rgba(99, 102, 241, 0.2))",speed:1,...e}}setType(e){Object.values(G).includes(e)&&(this._config.type=e)}setSize(e){Object.values(Se).includes(e)&&(this._config.size=e)}create(){let{type:e}=this._config;switch(e){case G.SPINNER:return this._createSpinner();case G.DOTS:return this._createDots();case G.BARS:return this._createBars();case G.PULSE:return this._createPulse();case G.SKELETON:return this._createSkeleton();case G.WAVE:return this._createWave();case G.RING:return this._createRing();case G.BOUNCE:return this._createBounce();case G.PROGRESS:return this._createProgress();case G.SHIMMER:return this._createShimmer();default:return this._createSpinner()}}_createSpinner(){let e=Ee[this._config.size],{size:t,stroke:i}=e,{color:r,secondaryColor:s,speed:o}=this._config,a=document.createElement("div");return a.className="uc-loading uc-loading-spinner",a.innerHTML=`
    ...
    `,a}_createDots(){let e=Ee[this._config.size],{dotSize:t}=e,{color:i,speed:r}=this._config,s=document.createElement("div");s.className="uc-loading uc-loading-dots",s.style.gap=`${t/2}px`;for(let o=0;o<3;o++){let a=document.createElement("span");a.style.cssText=`
        width: ${t}px;
        height: ${t}px;
        background: ${i};
        border-radius: 50%;
      ...
      `,s.appendChild(a)}return s}_createBars(){let e=Ee[this._config.size],{size:t}=e,{color:i,speed:r}=this._config,s=document.createElement("div");s.className="uc-loading uc-loading-bars",s.style.height=`${t}px`,s.style.gap="3px";for(let o=0;o<5;o++){let a=document.createElement("span");a.style.cssText=`
        width: ${t/8}px;
        height: 100%;
        background: ${i};
        border-radius: 2px;
        ...
        animation-delay: ${o*.1}s;
      `,s.appendChild(a)}return s}_createPulse(){let e=Ee[this._config.size],{size:t}=e,{color:i,speed:r}=this._config,s=document.createElement("div");return s.className="uc-loading uc-loading-pulse",s.style.cssText=`
      width: ${t}px;
      height: ${t}px;
      background: ${i};
      border-radius: 50%;
    ...
    `,s}_createSkeleton(){let{color:e,secondaryColor:t}=this._config,i=document.createElement("div");return i.className="uc-loading uc-loading-skeleton",i.style.cssText=`
      ...
      border-radius: inherit;
    `,i}_createWave(){let e=Ee[this._config.size],{size:t}=e,{color:i,speed:r}=this._config,s=document.createElement("div");s.className="uc-loading uc-loading-wave",s.style.cssText=`
      display: flex;
      align-items: center;
      gap: 4px;
      height: ${t}px;
    `;for(let o=0;o<5;o++){let a=document.createElement("span");a.style.cssText=`
        ...
        animation-delay: ${o*.1}s;
      `,s.appendChild(a)}return s}_createRing(){let e=Ee[this._config.size],{size:t,stroke:i}=e,{color:r,speed:s}=this._config,o=document.createElement("div");return o.className="uc-loading uc-loading-ring",o.style.cssText=`
      width: ${t}px;
      height: ${t}px;
    ...
    `,o}_createBounce(){let e=Ee[this._config.size],{dotSize:t}=e,{color:i,speed:r}=this._config,s=document.createElement("div");s.className="uc-loading uc-loading-bounce",s.style.cssText=`
      display: flex;
    ...
    `}};var P={CLICK:"click",TOGGLE:"toggle",SUCCESS:"success",ERROR:"error",NOTIFICATION:"notification",PROGRESS:"progress",FEEDBACK:"feedback"},Di={ripple:{category:P.CLICK,name:"Ripple",description:"Material Design \u0432\u043E\u043B\u043D\u0430",trigger:"click"},pop:{category:P.CLICK,name:"Pop",description:"\u0411\u044B\u0441\u0442\u0440\u043E\u0435 \u0443\u0432\u0435\u043B\u0438\u0447\u0435\u043D\u0438\u0435",trigger:"click",keyframes:`
    ...
    `,duration:500}},Ct=class{constructor(){this._injectedStyles=new Set}play(e,t,i={}){let r=Di[t];if(!r){console.warn(`[MicroInteractions] Unknown interaction: ${t}`);return}switch(r.keyframes&&!this._injectedStyles.has(t)&&this._injectStyles(t,r.keyframes),t){case"ripple":this._playRipple(e,i);break;case"confetti":this._playConfetti(e,i);break;case"checkmark":case"cross":this._playSvgAnimation(e,r,i);break;default:this._playKeyframeAnimation(e,r,i)}}_playRipple(e,t={}){let{x:i,y:r,color:s="var(--primary-color, rgba(99, 102, 241, 0.3))"}=t,o=e.getBoundingClientRect(),a=i!==void 0?i-o.left:o.width/2,c=r!==void 0?r-o.top:o.height/2,l=Math.max(o.width,o.height)*2,d=document.createElement("span");d.className="uc-ripple",d.style.cssText=`
      position: absolute;
      width: ${l}px;
      height: ${l}px;
      left: ${a-l/2}px;
    ...
    `,e.style.position="relative",e.style.overflow="hidden",e.appendChild(d),setTimeout(()=>d.remove(),600)}_playConfetti(e,t={}){let{count:i=30,colors:r=["#ff0","#f0f","#0ff","#f00","#0f0"]}=t,s=e.getBoundingClientRect(),o=document.createElement("div");o.className="uc-confetti-container",o.style.cssText=`
      ...
      pointer-events: none;
      z-index: 10000;
    `;for(let a=0;a<i;a++){let c=document.createElement("span"),l=r[Math.floor(Math.random()*r.length)],d=Math.random()*360*(Math.PI/180),u=50+Math.random()*100,m=Math.cos(d)*u,p=Math.sin(d)*u,_=Math.random()*360;c.style.cssText=`
        position: absolute;
    ...
    `),e.join(`
`)}};var ur={GET:"GET",POST:"POST",PUT:"PUT",PATCH:"PATCH",DELETE:"DELETE"},Ce={RAW:"raw",VALUE:"value",TABLE:"table",LIST:"list",TEMPLATE:"template",CHART:"chart"},Ui={url:"",method:ur.GET,headers:{},body:null,refresh_interval:0,timeout:1e4,cache_ttl:6e4,display_format:Ce.VALUE,value_path:"",template:"",transform:null,error_message:"\u041E\u0448\u0438\u0431\u043A\u0430 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0438 \u0434\u0430\u043D\u043D\u044B\u0445",loading_message:"\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430...",show_timestamp:!1,authentication:null},Tt=class{constructor(e,t={}){this._hass=e,this._config={...Ui,...t},this._element=null,this._data=null,this._error=null,this._loading=!1,this._lastFetch=0,this._refreshInterval=null,this._cache=new Map,this._abortController=null}set hass(e){this._hass=e}setConfig(e){this._config={...Ui,...e},this._stopAutoRefresh(),this._config.refresh_interval>0&&this._startAutoRefresh()}render(){return this._element=document.createElement("div"),this._element.className="uc-rest-widget",this._updateDisplay(),this._fetchData(),this._element}async _fetchData(){let{url:e,method:t,headers:i,body:r,timeout:s,cache_ttl:o}=this._config;if(!e){this._error="URL \u043D\u0435 \u0443\u043A\u0430\u0437\u0430\u043D",this._updateDisplay();return}let a=this._getCacheKey(),c=this._cache.get(a);if(c&&Date.now()-c.timestamp<o){this._data=c.data,this._updateDisplay();return}this._abortController&&this._abortController.abort(),this._abortController=new AbortController,this._loading=!0,this._error=null,this._updateDisplay();try{let l=this._processTemplate(e),d={...i};if(this._config.authentication){let _=this._config.authentication;if(_.type==="bearer")d.Authorization=`Bearer ${_.token}`;else if(_.type==="basic"){let b=btoa(`${_.username}:${_.password}`);d.Authorization=`Basic ${b}`}else _.type==="api_key"&&(d[_.header||"X-API-Key"]=_.key)}let u=await fetch(l,{method:t,headers:d,body:r?JSON.stringify(this._processTemplate(r)):null,signal:this._abortController.signal,timeout:s});if(!u.ok)throw new Error(`HTTP ${u.status}: ${u.statusText}`);let m=u.headers.get("content-type"),p;m!=null&&m.includes("application/json")?p=await u.json():p=await u.text(),this._config.transform&&(p=this._applyTransform(p)),this._cache.set(a,{data:p,timestamp:Date.now()}),this._data=p,this._lastFetch=Date.now(),this._loading=!1,this._error=null}catch(l){if(l.name==="AbortError")return;this._loading=!1,this._error=l.message||this._config.error_message,console.error("[RestApiWidget] Fetch error:",l)}this._updateDisplay()}_getCacheKey(){let{url:e,method:t,body:i}=this._config;return`${t}:${e}:${JSON.stringify(i||{})}`}_processTemplate(e){if(typeof e=="string")return e.replace(/\{\{\s*(\w+\.\w+)\s*\}\}/g,(t,i)=>{var r,s,o;return((o=(s=(r=this._hass)==null?void 0:r.states)==null?void 0:s[i])==null?void 0:o.state)||t});if(typeof e=="object"&&e!==null){let t=Array.isArray(e)?[]:{};for(let[i,r]of Object.entries(e))t[i]=this._processTemplate(r);return t}return e}_applyTransform(e){let t=this._config.transform;if(typeof t=="function")return t(e);if(typeof t=="string")try{return new Function("data",`return ${t}`)(e)}catch(i){return console.error("[RestApiWidget] Transform error:",i),e}return e}_getValueByPath(e,t){var s;if(!t)return e;let i=t.split("."),r=e;for(let o of i){let a=o.match(/^(\w+)\[(\d+)\]$/);if(a?r=(s=r==null?void 0:r[a[1]])==null?void 0:s[parseInt(a[2])]:r=r==null?void 0:r[o],r===void 0)return}return r}_updateDisplay(){var a;if(!this._element)return;if(this._loading){this._element.innerHTML=`
      ...
      `,(a=this._element.querySelector(".uc-rest-retry"))==null||a.addEventListener("click",()=>{this._fetchData()});return}let{display_format:e,value_path:t,template:i,show_timestamp:r}=this._config,s=this._getValueByPath(this._data,t),o="";switch(e){case Ce.RAW:o=`<pre class="uc-rest-raw">${JSON.stringify(s,null,2)}</pre>`;break;case Ce.VALUE:o=`<div class="uc-rest-value">${this._formatValue(s)}</div>`;break;case Ce.TABLE:o=this._renderTable(s);break;case Ce.LIST:o=this._renderList(s);break;case Ce.TEMPLATE:o=this._renderTemplate(i,s);break;case Ce.CHART:o=this._renderChart(s);break;default:o=`<div class="uc-rest-value">${this._formatValue(s)}</div>`}if(r&&this._lastFetch){let c=new Date(this._lastFetch).toLocaleTimeString();o+=`<div class="uc-rest-timestamp">\u041E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u043E: ${c}</div>`}this._element.innerHTML=o}_formatValue(e){return e==null?"-":typeof e=="object"?JSON.stringify(e):String(e)}_renderTable(e){if(!e)return'<div class="uc-rest-empty">\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445</div>';let t=Array.isArray(e)?e:[e];if(t.length===0)return'<div class="uc-rest-empty">\u041D\u0435\u0442 \u0434\u0430\u043D\u043D\u044B\u0445</div>';let i=Object.keys(t[0]||{});return`
    ...
    `}};var hr={CONTAIN:"contain",COVER:"cover",FILL:"fill",NONE:"none",SCALE_DOWN:"scale-down"},j={CAMERA:"camera",IMAGE:"image",URL:"url",PERSON:"person",LOCAL:"local"},Pi={entity_id:"",url:"",fit:hr.CONTAIN,aspect_ratio:"16:9",refresh_interval:0,show_state:!1,show_name:!1,placeholder:"mdi:image",error_placeholder:"mdi:image-broken",lazy_load:!0,click_action:"more-info",border_radius:8},$t=class{constructor(e,t={}){this._hass=e,this._config={...Pi,...t},this._element=null,this._imgElement=null,this._refreshInterval=null,this._intersectionObserver=null,this._isVisible=!1,this._errorCount=0}set hass(e){this._hass=e,this._updateImage()}setConfig(e){this._config={...Pi,...e}}render(){return this._element=document.createElement("div"),this._element.className="uc-image-widget",this._applyAspectRatio(),this._element.innerHTML=`
    ...
    `}};var pr={COMPACT:"compact",NORMAL:"normal",FULL:"full"},zi={entity_id:"",style:pr.NORMAL,show_artwork:!0,show_volume:!0,show_progress:!0,show_source:!1,artwork_border_radius:8,volume_step:5},At=class{constructor(e,t={}){this._hass=e,this._config={...zi,...t},this._element=null,this._progressInterval=null}set hass(e){this._hass=e,this._update()}setConfig(e){this._config={...zi,...e}}_getState(){var e,t;return(t=(e=this._hass)==null?void 0:e.states)==null?void 0:t[this._config.entity_id]}render(){return this._element=document.createElement("div"),this._element.className=`uc-media-mini uc-media-${this._config.style}`,this._renderContent(),this._bindEvents(),this._startProgressUpdate(),this._element}_renderContent(){var _;let e=this._getState();if(!e){this._element.innerHTML=`
    ...
    `:"",u=Math.round((s.volume_level||0)*100),m=this._config.show_volume?`
    ...
    `}};var V=class{constructor(e={}){this._config=e,this._element=null}render(){throw new Error("render() must be implemented")}getValue(){throw new Error("getValue() must be implemented")}setValue(e){throw new Error("setValue() must be implemented")}},Mt=class extends V{render(){return this._element=document.createElement("div"),this._element.className="uc-editor-field",this._element.innerHTML=`
    ...
    `,this._input=this._element.querySelector("input"),this._input.addEventListener("input",()=>{f(this._element,"value-changed",{value:this.getValue()})}),this._element}getValue(){var e;return((e=this._input)==null?void 0:e.value)||""}setValue(e){this._input&&(this._input.value=e||"")}},Dt=class extends V{render(){return this._element=document.createElement("div"),this._element.className="uc-editor-field",this._element.innerHTML=`
      ${this._config.label?`<label class="uc-editor-label">${this._config.label}</label>`:""}
      <input type="number" 
             class="uc-editor-input"
             ...
             ${this._config.required?"required":""} />
      ${this._config.helper?`<span class="uc-editor-helper">${this._config.helper}</span>`:""}
    `,this._input=this._element.querySelector("input"),this._input.addEventListener("input",()=>{f(this._element,"value-changed",{value:this.getValue()})}),this._element}getValue(){var t;let e=(t=this._input)==null?void 0:t.value;return e!==""?Number(e):null}setValue(e){this._input&&(this._input.value=e!=null?e:"")}},Ut=class extends V{render(){return this._element=document.createElement("div"),this._element.className="uc-editor-field uc-editor-checkbox",this._element.innerHTML=`
      ...
      ${this._config.helper?`<span class="uc-editor-helper">${this._config.helper}</span>`:""}
    `,this._input=this._element.querySelector("input"),this._input.addEventListener("change",()=>{f(this._element,"value-changed",{value:this.getValue()})}),this._element}getValue(){var e;return((e=this._input)==null?void 0:e.checked)||!1}setValue(e){this._input&&(this._input.checked=!!e)}},Pt=class extends V{render(){this._element=document.createElement("div"),this._element.className="uc-editor-field";let e=(this._config.options||[]).map(t=>{let i=typeof t=="object"?t.value:t,r=typeof t=="object"?t.label:t,s=i===this._config.value?"selected":"";return`<option value="${i}" ${s}>${r}</option>`}).join("");return this._element.innerHTML=`
      ${this._config.label?`<label class="uc-editor-label">${this._config.label}</label>`:""}
    ...
    `,this._select=this._element.querySelector("select"),this._select.addEventListener("change",()=>{f(this._element,"value-changed",{value:this.getValue()})}),this._element}getValue(){var e;return((e=this._select)==null?void 0:e.value)||""}setValue(e){this._select&&(this._select.value=e||"")}},zt=class extends V{render(){var e;return this._element=document.createElement("div"),this._element.className="uc-editor-field",this._element.innerHTML=`
      ...
      ></ha-entity-picker>
      ${this._config.helper?`<span class="uc-editor-helper">${this._config.helper}</span>`:""}
    `,this._picker=this._element.querySelector("ha-entity-picker"),(e=this._picker)==null||e.addEventListener("value-changed",t=>{f(this._element,"value-changed",{value:t.detail.value})}),this._element}getValue(){var e;return((e=this._picker)==null?void 0:e.value)||""}setValue(e){this._picker&&(this._picker.value=e||"")}},Ht=class extends V{render(){var e;return this._element=document.createElement("div"),this._element.className="uc-editor-field",this._element.innerHTML=`
      ${this._config.label?`<label class="uc-editor-label">${this._config.label}</label>`:""}
      <ha-icon-picker
        .hass="${this._config.hass}"
        .value="${this._config.value||""}"
      ></ha-icon-picker>
      ${this._config.helper?`<span class="uc-editor-helper">${this._config.helper}</span>`:""}
    `,this._picker=this._element.querySelector("ha-icon-picker"),(e=this._picker)==null||e.addEventListener("value-changed",t=>{f(this._element,"value-changed",{value:t.detail.value})}),this._element}getValue(){var e;return((e=this._picker)==null?void 0:e.value)||""}setValue(e){this._picker&&(this._picker.value=e||"")}},Ft=class extends V{render(){return this._element=document.createElement("div"),this._element.className="uc-editor-field uc-editor-color",this._element.innerHTML=`
      ${this._config.label?`<label class="uc-editor-label">${this._config.label}</label>`:""}
      ...
      ${this._config.helper?`<span class="uc-editor-helper">${this._config.helper}</span>`:""}
    `,this._colorInput=this._element.querySelector(".uc-editor-color-input"),this._textInput=this._element.querySelector(".uc-editor-color-text"),this._colorInput.addEventListener("input",()=>{this._textInput.value=this._colorInput.value,f(this._element,"value-changed",{value:this.getValue()})}),this._textInput.addEventListener("input",()=>{/^#[0-9a-fA-F]{6}$/.test(this._textInput.value)&&(this._colorInput.value=this._textInput.value),f(this._element,"value-changed",{value:this.getValue()})}),this._element}getValue(){var e;return((e=this._textInput)==null?void 0:e.value)||""}setValue(e){this._colorInput&&this._textInput&&(this._colorInput.value=e||"#ffffff",this._textInput.value=e||"")}},Bt=class extends V{render(){return this._element=document.createElement("div"),this._element.className=`uc-editor-section ${this._config.expanded?"expanded":""}`,this._element.innerHTML=`
    ...
    `,this._header=this._element.querySelector(".uc-editor-section-header"),this._content=this._element.querySelector(".uc-editor-section-content"),this._header.addEventListener("click",()=>{this._element.classList.toggle("expanded")}),this._element}addContent(e){e instanceof V?this._content.appendChild(e.render()):this._content.appendChild(e)}getValue(){return null}setValue(){}},jt=class extends V{render(){var i;this._element=document.createElement("div"),this._element.className="uc-editor-field uc-editor-action";let e=[{value:"none",label:"\u041D\u0435\u0442 \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u044F"},{value:"more-info",label:"\u0418\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044F"},{value:"toggle",label:"\u041F\u0435\u0440\u0435\u043A\u043B\u044E\u0447\u0438\u0442\u044C"},{value:"call-service",label:"\u0412\u044B\u0437\u0432\u0430\u0442\u044C \u0441\u0435\u0440\u0432\u0438\u0441"},{value:"navigate",label:"\u041D\u0430\u0432\u0438\u0433\u0430\u0446\u0438\u044F"},{value:"url",label:"\u041E\u0442\u043A\u0440\u044B\u0442\u044C URL"}],t=((i=this._config.value)==null?void 0:i.action)||"none";return this._element.innerHTML=`
      ${this._config.label?`<label class="uc-editor-label">${this._config.label}</label>`:""}
      ...
      <div class="uc-logger-header">
        ...
        <div class="uc-logger-controls">
          <select class="uc-logger-filter-level">
            ...
            ${Object.values(z).map(e=>`<option value="${e}">${e}</option>`).join("")}
          </select>
          <select class="uc-logger-filter-category">
            <option value="">All Categories</option>
            ${Object.values(Re).map(e=>`<option value="${e}">${e}</option>`).join("")}
          </select>
...
`)}static get helpers(){return{hide:e=>`${e} { display: none !important; }`,color:(e,t)=>`${e} { color: ${t} !important; }`,background:(e,t)=>`${e} { background: ${t} !important; }`,padding:(e,t)=>`${e} { padding: ${t} !important; }`,border:(e,t)=>`${e} { border: ${t} !important; }`,fontSize:(e,t)=>`${e} { font-size: ${t} !important; }`,borderRadius:(e,t)=>`${e} { border-radius: ${t} !important; }`,shadow:(e,t)=>`${e} { box-shadow: ${t} !important; }`,fadeIn:(e,t="0.3s")=>`
      ...
      `,gradient:(e,t,i,r="to bottom")=>`${e} { background: linear-gradient(${r}, ${t}, ${i}) !important; }`}}};h("[UC] 1. Start loading");h("[UC] 2. Constants loaded");h("[UC] 3. UniversalCard loaded");h("[UC] 4. Editor loaded");h("[UC] 5. Config loaded");h("[UC] 6. Performance utils loaded");h("[UC] 7. Helpers loaded");h("[UC] 8. HA helpers loaded");h("[UC] 9. Modes loaded");h("[UC] 10. Features loaded");h("[UC] 11. UI loaded");h("[UC] 12. Advanced loaded");h("[UC] 13. Complex loaded");h("[UC] 14. Themes loaded");h("[UC] 15. Widgets loaded");h("[UC] 16. Editor components loaded");h("[UC] 17. Devtools loaded");h("[UC] 18. Extensibility loaded");h("[UC] 19. Styles loaded");h("[UC] 20. Starting registration...");customElements.get("universal-card")||(h("[UC] 21. Defining universal-card..."),customElements.define("universal-card",Ue),h("[UC] 22. universal-card defined"));customElements.get("universal-card-editor")||(h("[UC] 23. Defining universal-card-editor..."),customElements.define("universal-card-editor",Pe),h("[UC] 24. universal-card-editor defined"));window.customCards=window.customCards||[];window.customCards.some(n=>n.type==="universal-card")||window.customCards.push({type:"universal-card",name:gi,description:bi,preview:!0,documentationURL:"https://github.com/Mesteriis/universal-card"});window.UniversalCard={version:Zt,UniversalCard:Ue,UniversalCardEditor:Pe,ConfigManager:ve,createMode:Je,getAllModeStyles:Ze,modes:{BaseMode:M,ExpandMode:ce,ModalMode:le,FullscreenMode:de,TabsMode:Q,CarouselMode:ee},features:{VisibilityConditions:Qe,StateStyles:et,SwipeGestures:tt,ResponsiveBreakpoints:rt},ui:{Header:Oe,Footer:Le,Badges:Ke,ContextMenu:st,RadialMenu:ot},advanced:{EntityPreview:at,Alerts:nt,QuickActions:ct,Timer:lt,IconMapping:dt,AnimationPresets:ut,WebSocketOptimizer:ze,getWebSocketOptimizer:Ii,createThrottledCallback:Ni,createDebouncedCallback:Ri},complex:{CardLinking:ht,AutoGrouping:pt,CompactMode:mt},themes:{Glassmorphism:_t,Neumorphism:bt,BackgroundPatterns:yt,BorderAnimations:xt,HoverEffects:kt,ColorSchemes:Et,LoadingVariants:St,MicroInteractions:Ct},widgets:{RestApiWidget:Tt,ImageEntity:$t,MediaPlayerMini:At,NotificationCenter:Ot},editor:{ConfigValidator:Lt,DragDrop:It,ResizableCards:Nt,LockMode:Rt,TextInput:Mt,NumberInput:Dt,Checkbox:Ut,Select:Pt,EntityPicker:zt,IconPicker:Ht,ColorPicker:Ft,Section:Bt,ActionEditor:jt,getEditorStyles:Fi,MultiLanguage:Gt},devtools:{EventLogger:je,StateInspector:Vt,PerformanceProfiler:Ge},PluginSystem:Yt,CustomCSS:qt,utils:{debounce:Z,throttle:Ae,raf:vi,rafDouble:xi,batchUpdates:Qt,createBatchUpdater:wi,whenIdle:ki,measureTime:Ei,deepMerge:Jt,deepClone:W,generateId:Ve,isObject:q,isNonEmptyString:Kt,fireEvent:f,nextFrame:mi,getNestedValue:hi,ensureArray:pi,formatNumber:fi,formatDateTime:_i,isValidEntityId:Ye,getCardHelpers:De,createCardElement:ei,createCardElements:ne,createErrorCard:ti,getEntityState:We,getStateValue:I,getAttributeValue:ie,isState:Si,executeAction:X,hapticFeedback:Ci,getThemeVariables:Ti,getCurrentUser:Xe,isUserAdmin:$i},constants:{BODY_MODES:k,THEMES:$,DEFAULTS:E,EVENTS:ye,ACTION_TYPES:F,CONDITION_TYPES:A,CSS_VARS:yi,LIMITS:R,ALERT_TYPES:ue,ALERT_CONDITIONS:K,TIMER_MODES:D,DISPLAY_FORMATS:we,ANIMATION_CATEGORIES:y,PRESETS:he,PRESET_MAPPINGS:Ie,UPDATE_STRATEGIES:pe,UPDATE_PRIORITY:re},config:{ConfigManager:ve,ConfigValidationError:x}};console.info("%c \u{1F3B4} UNIVERSAL-CARD %c v"+Zt+" %c","color: white; background: #3498db; font-weight: bold; padding: 2px 8px; border-radius: 4px 0 0 4px;","color: #3498db; background: #ecf0f1; font-weight: bold; padding: 2px 8px; border-radius: 0 4px 4px 0;","");var ci=null,li=null;function Bi(n,e){e=e||document;for(var t=[],i=e.querySelectorAll(n),r=0;r<i.length;r++)t.push(i[r]);for(var s=e.querySelectorAll("*"),o=0;o<s.length;o++){var a=s[o];if(a.shadowRoot)for(var c=Bi(n,a.shadowRoot),l=0;l<c.length;l++)t.push(c[l])}return t}window.__UC_DEVTOOLS__={get logger(){return ci||(ci=new je({enabled:!0})),ci},get profiler(){return li||(li=new Ge({enabled:!0})),li},findCards:function(){return Bi("universal-card")},showLogger:function(){return this.logger.showPanel(),"Logger panel opened"},showProfiler:function(){return this.profiler.showPanel(),"Profiler panel opened"},showInspector:function(){console.log("%c\u{1F4CA} State Inspector","color: #9b59b6; font-weight: bold;"),console.log("All universal-card elements (including Shadow DOM):");var n=this.findCards();return n.forEach(function(e,t){console.log("Card "+t+":",{title:e._config?e._config.title:"unknown",config:e._config,expanded:e._expanded,hass:e._hass?"connected":"not connected",bodyCards:e._bodyCards?e._bodyCards.length:0})}),"Found "+n.length+" cards"},listCards:function(){var n=this.findCards();return console.table(Array.from(n).map(function(e,t){return{index:t,title:e._config?e._config.title:"unknown",mode:e._config?e._config.body_mode:"unknown",expanded:e._expanded}})),n.length+" cards found"},toggleCard:function(n){var e=this.findCards();return e[n]?(e[n]._toggle(),"Toggled card "+n):"Card not found"},getCard:function(n){var e=this.findCards();return e[n]||null}};window.enableUniversalCardDebug=function(){return Xt(!0),console.log("%c\u{1F527} Universal Card Debug Mode Enabled","color: #03a9f4; font-weight: bold; font-size: 14px;"),console.log(""),console.log("%cAvailable commands:","font-weight: bold;"),console.log("  \u2022 __UC_DEVTOOLS__.listCards()       - List all cards"),console.log("  \u2022 __UC_DEVTOOLS__.showInspector()   - Show card states"),console.log("  \u2022 __UC_DEVTOOLS__.toggleCard(0)     - Toggle card by index"),console.log("  \u2022 __UC_DEVTOOLS__.getCard(0)        - Get card element"),console.log("  \u2022 __UC_DEVTOOLS__.showLogger()      - Show event logger"),console.log("  \u2022 __UC_DEVTOOLS__.showProfiler()    - Show profiler"),console.log("  \u2022 disableUniversalCardDebug()       - Disable debug mode"),console.log(""),console.log("%cQuick access:","font-weight: bold;"),console.log("  \u2022 window.UniversalCard - Full API"),"Debug mode enabled! Logs will now appear. Try __UC_DEVTOOLS__.listCards()"};window.disableUniversalCardDebug=function(){return Xt(!1),console.log("%c\u{1F527} Universal Card Debug Mode Disabled","color: #888; font-weight: bold;"),"Debug mode disabled. Logs will be suppressed."};h("[UC] Debug functions registered: enableUniversalCardDebug(), __UC_DEVTOOLS__");})();
