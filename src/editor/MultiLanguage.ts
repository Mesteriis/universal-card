...
type CustomTranslations = Record<string, TranslationMap>;
...
export class MultiLanguage {
   ...
   * @param {Object} hass 
   */
  initFromHass(hass: { language?: string } | null | undefined) {
    if (hass?.language) {
   ...
   */
  addTranslations(language: string, translations: TranslationMap) {
...
// Синглтон экземпляр
let instance: MultiLanguage | null = null;
