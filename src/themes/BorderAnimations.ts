...
type BorderAnimationType = typeof BORDER_TYPES[keyof typeof BORDER_TYPES];
type BorderGradientName = keyof typeof GRADIENT_PRESETS;

type BorderAnimationConfig = {
...
type ResolvedBorderAnimationConfig = {
  type: BorderAnimationType;
  width: number;
  radius: number;
  duration: number;
...
export class BorderAnimations {
  _config: ResolvedBorderAnimationConfig;
   ...
   */
  constructor(config: BorderAnimationConfig = {}) {
   ...
   * @param {string} type 
   */
  setType(type: BorderAnimationType) {
   ...
   */
  setGradientPreset(presetName: BorderGradientName) {
   ...
   * @returns {Object}
   */
  generateStyles(): BorderAnimationStyles {
   ...
   */
  _generateGradientStyles(): BorderAnimationStyles {
   ...
   */
  _generateGlowStyles(): BorderAnimationStyles {
   ...
   */
  _generatePulseStyles(): BorderAnimationStyles {
    const { width, radius, colors, duration } = this._config;
   ...
   */
  _generateRainbowStyles(): BorderAnimationStyles {
   ...
   */
  _generateDashStyles(): BorderAnimationStyles {
    const { width, radius, colors, duration } = this._config;
   ...
   */
  _generateWaveStyles(): BorderAnimationStyles {
    const { width, radius, colors, duration } = this._config;
   ...
   */
  _generateNeonStyles(): BorderAnimationStyles {
   ...
   */
  _generateShimmerStyles(): BorderAnimationStyles {
    const { width, radius, colors, duration } = this._config;
   ...
   */
  _injectKeyframes(keyframes: string) {
   ...
   * @param {HTMLElement} element 
   */
  _applySvgBorder(element: HTMLElement) {
