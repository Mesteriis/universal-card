...
export class ColorSchemes {
   ...
   * @returns {Object}
   */
  getScheme(): ColorSchemeDefinition {
   ...
   * @param {string} value 
   */
  setCustomColor(name: string, value: string) {
   ...
   * @returns {Object|null}
   */
  _hexToRgb(hex: string): RGBColor | null {
   ...
   * @returns {Object}
   */
  static getSchemesByType(type: string): Record<string, ColorSchemeDefinition> {
