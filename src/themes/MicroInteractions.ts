 ...
 */
type MicroInteractionDefinition = {
  category: string;
  name: string;
  description: string;
  trigger: string;
...
export const MICRO_INTERACTIONS: Record<string, MicroInteractionDefinition> = {
  // =====================
  // CLICK - Клик
  // =====================
...
export class MicroInteractions {
   ...
   */
  play(element: HTMLElement, interactionName: string, options: InteractionOptions = {}) {
   ...
   * @param {Object} options 
   */
  _playRipple(element: HTMLElement, options: InteractionOptions = {}) {
   ...
   * @param {Object} options 
   */
  _playConfetti(element: HTMLElement, options: InteractionOptions = {}) {
   ...
   * @param {Object} options 
   */
  _playSvgAnimation(element: HTMLElement, interaction: MicroInteractionDefinition, options: InteractionOptions = {}) {
    const container = document.createElement('div');
   ...
   * @param {Object} options 
   */
  _playKeyframeAnimation(element: HTMLElement, interaction: MicroInteractionDefinition, options: InteractionOptions = {}) {
   ...
   */
  _injectStyles(name: string, keyframes: string) {
   ...
   */
  bind(element: HTMLElement, event: string, interactionName: string, options: InteractionOptions = {}) {
