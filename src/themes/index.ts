...
type ThemeApplicationConfig = {
  glass?: ConstructorParameters<typeof Glassmorphism>[0];
  neumorphism?: ConstructorParameters<typeof Neumorphism>[0];
  pattern?: ConstructorParameters<typeof BackgroundPatterns>[0];
  border?: ConstructorParameters<typeof BorderAnimations>[0];
  hover?: ConstructorParameters<typeof HoverEffects>[1];
  colorScheme?: string;
  loading?: ConstructorParameters<typeof LoadingVariants>[0];
};
 ...
 */
export function applyTheme(element: HTMLElement, themeConfig: ThemeApplicationConfig = {}) {
  const {
    glass,
    neumorphism,
    pattern,
