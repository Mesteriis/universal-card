...
type LoadingType = typeof LOADING_TYPES[keyof typeof LOADING_TYPES];
type LoadingSize = typeof LOADING_SIZES[keyof typeof LOADING_SIZES];
...
type ResolvedLoadingVariantConfig = {
  type: LoadingType;
  size: LoadingSize;
  color: string;
  secondaryColor: string;
...
export class LoadingVariants {
  _config: ResolvedLoadingVariantConfig;

  /**
   * @param {Object} config - Конфигурация
   */
  constructor(config: LoadingVariantConfig = {}) {
    this._config = {
