 ...
 */
export function debounce<T extends AnyFn>(fn: T, wait = 100, options: PerformanceOptions = {}) {
 ...
 */
export function throttle<T extends AnyFn>(fn: T, wait = 16, options: PerformanceOptions = {}) {
 ...
 */
export function whenIdle(callback, options: IdleOptions = {}) {
