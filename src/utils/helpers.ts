 ...
 */
export function fireEvent(target, type, detail = {}, options: CustomEventOptions = {}) {
 ...
 */
export function formatDateTime(date, options: Intl.DateTimeFormatOptions = {}, locale = 'ru-RU') {
