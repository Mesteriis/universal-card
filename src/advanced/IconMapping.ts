...
type IconMappingRule = IconMappingResult & {
  min?: number;
  max?: number;
};
type IconMappingConfig = Record<string, any>;
type IconMappingProviders = ReturnType<typeof normalizeProviderContext>;
type IconMappingOptions = {
  default_icon?: string;
  size?: string | number;
  [key: string]: any;
};
type EntityIconMapping = Record<string, IconMappingResult> & {
  _ranges?: IconMappingRule[];
  default?: IconMappingResult;
  unknown?: IconMappingResult;
};

/**
 * Предустановленные маппинги для распространённых типов entity
 */
export const PRESET_MAPPINGS: Record<string, EntityIconMapping> = {
  // Освещение
  light: {
...
export class IconMapping {
  _providers: IconMappingProviders;
  _config: IconMappingConfig;
  _customMappings: Map<string, EntityIconMapping>;
  /**
   * @param {Object} providerContext - Provider context или raw hass
   * @param {Object} config - Конфигурация
   */
  constructor(providerContext: HomeAssistantLike, config: IconMappingConfig = {}) {
   ...
   */
  getIconAndColor(entityId: string, options: IconMappingOptions = {}) {
   ...
   * @returns {Object|null}
   */
  _findInRanges(ranges: IconMappingRule[], value: number) {
   ...
   * @returns {Object}
   */
  _getBatteryIcon(stateValue: string) {
   ...
   * @returns {Object}
   */
  _getDefaultIcon(state: Record<string, any>, options: IconMappingOptions) {
   ...
   * @returns {Object}
   */
  static createMappingFromConfig(config: Record<string, any>[]) {
    const mapping: EntityIconMapping = {};
   ...
   * @returns {HTMLElement}
   */
  renderIcon(entityId: string, options: IconMappingOptions = {}) {
