...
export class AnimationPresets {
   ...
   */
  apply(element: HTMLElement, presetName: string, options: Record<string, any> = {}) {
   ...
   * @param {Object} options 
   */
  stagger(elements: ArrayLike<HTMLElement>, presetName: string, options: Record<string, any> = {}) {
